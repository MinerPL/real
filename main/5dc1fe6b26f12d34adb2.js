    ...
    ["13508"], {
        ...
        123377: function(e, t, a) {
            ...
            function E(e) {
                ...
                let {
                    ...
                    disableCopy: p,
                    showCopyIcon: N
                } = e, [v, A] = i.useState(0), [g, h] = i.useState(!1), [I, O] = i.useState(!1);
                ...
                let U = [T.default.Messages.ACCOUNT_USERNAME_COPY_SUCCESS_1, T.default.Messages.ACCOUNT_USERNAME_COPY_SUCCESS_2, T.default.Messages.ACCOUNT_USERNAME_COPY_SUCCESS_3, T.default.Messages.ACCOUNT_USERNAME_COPY_SUCCESS_4, T.default.Messages.ACCOUNT_USERNAME_COPY_SUCCESS_5, T.default.Messages.ACCOUNT_USERNAME_COPY_SUCCESS_6, T.default.Messages.ACCOUNT_USERNAME_COPY_SUCCESS_7, T.default.Messages.ACCOUNT_USERNAME_COPY_SUCCESS_8, T.default.Messages.ACCOUNT_USERNAME_COPY_SUCCESS_9, T.default.Messages.ACCOUNT_USERNAME_COPY_SUCCESS_10, T.default.Messages.ACCOUNT_USERNAME_COPY_SUCCESS_11],
                    M = Math.min(Math.max(v - 1, 0), U.length - 1),
                    P = null !== (t = U[M]) && void 0 !== t ? t : U[0],
                    x = v >= U.length - 1,
                    y = x ? d.TooltipColors.RED : d.TooltipColors.GREEN,
                    j = g ? y : d.TooltipColors.PRIMARY,
                    L = () => {
                        l.stop(), O(!1)
                    },
                    R = e => {
                        (0, m.copy)(r), f.default.track(S.AnalyticEvents.TEXT_COPIED, {
                            type: E
                        }), "function" == typeof e && e(), !I && A(v + 1), O(!0), h(!0), l.start(1e3, () => O(!1)), s.start(2e3, () => A(0))
                    };
        ...
        590006: function(e, t, a) {
            ...
            function p(e) {
                ...
                N && null == g.find(e => "premium" === e.id) && g.push({
                    id: "premium",
                    icon: _,
                    src: _,
                ...
                let I = null != i && null != p && g.length > i ? p : v;
                return (0, n.jsx)("div", {
                    className: r(l, g.length > 0 ? E.containerWithContent : E.container),
                    "aria-label": C.default.Messages.PROFILE_USER_BADGES,
                    role: "group",
        ...
        789321: function(e, t, a) {
            ...
            var j = e => {
                ...
                } = (0, T.default)(S.default.COLLECTIBLES_USER_POPOUT_UPSELL), L = (0, d.default)([m.default], () => m.default.useReducedMotion), {
                ...
                }), [D]), B = (0, d.default)([p.default], () => {
                    var e;
                    let a = null === (e = t.avatarDecoration) || void 0 === e ? void 0 : e.skuId;
                    return null != a && (0, N.isPremiumCollectiblesCategory)(p.default.getCategoryForProduct(a))
                ...
                }, [r]), Y = h.default.canUseCollectibles(F), z = (0, o.match)([G, w]).with([!0, !0], () => Y ? O.default.Messages.PROFILE_EFFECTS_SOCIAL_UPSELL_AVATAR_DECORATION_COMBINED.format({
                    openShop: y
        ...
        935409: function(e, t, a) {
            ...
            function H(e) {
                let {
                    ...
                    animateOnHover: I,
                    hasProfileEffect: U
                } = e, y = (0, u.useStateFromStores)([E.default], () => E.default.getCurrentUser()), {
                    profileTheme: G
                } = s.useContext(M.UserProfileContext), H = s.useContext(N.AnalyticsContext), W = t.isNonUserBot() && !t.isClyde(), Y = v.default.isPremiumAtLeast(null == a ? void 0 : a.premiumType, R.PremiumTypes.TIER_2), z = s.useMemo(() => (0, S.shouldDisableUserPresenceInChannel)(t, C), [t, C]), Z = A || t.isClyde(), {
                ...
                }), $ = (0, r.match)(g).with(j.UserProfileTypes.POPOUT, () => {
                    ...
                    children: (0, l.jsxs)(d.Clickable, {
                        ...
                        children: [J, !Z && function() {
                            ...
                            return (0, l.jsx)(p.default, {
                                mask: null == c || c === L.StatusTypes.UNKNOWN || z ? p.default.Masks.AVATAR_DEFAULT : (0, r.match)([e, m]).with([!0, !0], () => p.default.Masks.AVATAR_DECORATION_PROFILE_STATUS_MOBILE_SQUARE_80).with([!0, !1], () => p.default.Masks.AVATAR_DECORATION_PROFILE_STATUS_SQUARE_80).with([!1, !0], () => p.default.Masks.AVATAR_STATUS_MOBILE_80).with([!1, !1], () => p.default.Masks.AVATAR_STATUS_ROUND_80).exhaustive(),
