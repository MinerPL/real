(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["53509"], {
                    ...
                    super({
                        ...
                        return () => (function(e) {
                            ...
                            let o = [],
                                c = [],
                                I = [];
                            for (let e of Object.keys(E)) o.push(e), c.push(E[e].additionalSeenTimeMillis), E[e].additionalSeenTimeMillis >= 1e3 && I.push(e);
                            s.default.track(_.AnalyticEvents.FEED_ITEM_SEEN_BATCH, {
                                guild_id: t,
                                load_id: d,
                                feed_item_ids: o,
                            ...
                            let F = I.map(e => l[e]).filter(r.isNotNullish).map(f.default).map(e => e.id);
                            return 0 === F.length ? Promise.resolve() : n.default.post({
                                url: _.Endpoints.GUILD_FEED_MARK_SEEN(t),
                                body: {
                                    item_ids: F
                                }
                            })
                        ...
                        let i = c.default.getItem(t, d);
                        if (null == i || !i.unreadMention || i.seen) return;
                        let u = (0, f.default)(i),
                            s = u.channel_id;
                        await a.default.unarchiveThreadIfNecessary(s);
                        let r = l.default.getMentionCount(s),
                            o = l.default.ackMessageId(s);
                        if (null == o) return;
                        let I = 0;
                        for (let e of (0, f.getAllMessagesFromFeedItem)(i)) e.mentioned && E.default.compare(e.id, o) > 0 && (I += 1);
                        0 !== I && n.default.post({
                            url: _.Endpoints.MESSAGE_ACK(s, o),
                            body: {
                                manual: !0,
                                mention_count: r - I
                            }
        ...
        801110: function(e, t, d) {
            ...
            }), (i = n || (n = {})).MESSAGE = "message", i.CHANNEL = "channel", i.USER = "user"
        },
        885167: function(e, t, d) {
            ...
            }), (i = n || (n = {}))[i.HIDDEN = 1] = "HIDDEN", i[i.DEMOTED = 2] = "DEMOTED"
        }
    }
]);