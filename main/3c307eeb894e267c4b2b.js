    ...
    ["12925"], {
        ...
        660478: function(e, t, n) {
            ...
            var l, i, s = n("627445"),
                ...
                eu = n("627869"),
                er = n("133335");
            let ed = new h.default("ReadStateStore");
            __OVERLAY__ && (a = n("901165").default);
            let eo = el.BasicPermissions.VIEW_CHANNEL | el.BasicPermissions.READ_MESSAGE_HISTORY,
                eE = null,
                ec = null,
                ef = null,
                e_ = !1,
            ...
            function eR(e, t) {
                ...
                return !(null == n || $.default.isBlocked(e.author.id)) && (!!((0, O.default)({
                    message: e,
                    userId: t.id,
            ...
            async function em() {
                ...
                eT = !0;
                let e = eN.splice(0, 100);
                await eU(() => E.default.post({
                    url: el.Endpoints.BULK_ACK,
                    body: {
                        read_states: e
                    },
                    oldFormErrors: !0
                })), await (0, c.timeoutPromise)(1e3), em()
            }
            async function eU(e) {
                ...
                for (let n = 0; n < 3; n++) try {
                    ...
                    if (ed.error("", e), n + 1 < 3 && (await (0, c.timeoutPromise)((n + 1) * 2e3), await w.default.awaitOnline(), t !== B.default.getId())) return Promise.reject(Error("User changed."))
                }
            }
            ...
            function ev(e) {
                ...
                if (!u && (s === el.ChannelLayouts.NO_CHAT || s === el.ChannelLayouts.FULL_SCREEN) || null == eC[e.channelId]) return !1;
                let r = Z.default.getMessages(e.channelId);
            ...
            class eL {
                ...
                deserializeForOverlay(e) {
                    ...
                    this.channelId = t, this.type = null != n ? n : er.ReadStateTypes.CHANNEL, this._guildId = a, this._isThread = null != l && l, null != i ? (this._isActiveThread = i, this._isJoinedThread = i) : (this._isActiveThread = null != s && s, this._isJoinedThread = null != u && u), this._persisted = !1 !== r, this.loadedMessages = null != d && d, this._lastMessageId = o, this._lastMessageTimestamp = E, this._ackMessageId = c, this._ackMessageTimestamp = f, this.ackPinTimestamp = _, this.isManualAck = null != N && N, this.lastPinTimestamp = T, this._oldestUnreadMessageId = g, this.oldestUnreadMessageIdStale = null != C && C, this.estimated = null != h && h, this._unreadCount = null != S ? S : 0, this._mentionCount = I, this.flags = A, this.lastViewed = p, eL._mentionChannels.delete(this.channelId), this._mentionCount > 0 && this.canHaveMentions() && eL._mentionChannels.add(this.channelId)
                }
                ...
                rebuildChannelState(e) {
                    ...
                    if (this.ackMessageId = null !== (t = null != e ? e : this._ackMessageId) && void 0 !== t ? t : this.guessAckMessageId(), this.isManualAck = null != e, this.oldestUnreadMessageId = null, this.estimated = !1, this.unreadCount = 0, a && (this.mentionCount = 0), this.hasUnread()) {
                        let e = en.default.getCurrentUser(),
                            ...
                            i = !1,
                            s = null,
                            u = Z.default.getMessages(this.channelId);
                        u.forAll(n => {
                            if (l) {
                                var u;
                ...
                handleGuildEventRemoval(e, t) {
                    ...
                    let i = null !== (n = this._ackMessageId) && void 0 !== n ? n : x.default.fromTimestamp(l),
                        ...
                        u = 0;
                    a.forEach(e => {
                        (0, S.isEventUpcoming)(e) && (x.default.compare(e.id, s) > 0 && (s = e.id), x.default.compare(e.id, i) > 0 && u++)
                ...
                canTrackUnreads() {
                    ...
                    return null != e && ("basicPermissions" in e ? Y.default.has(e.basicPermissions, el.BasicPermissions.VIEW_CHANNEL) : !g.default.isChannelGated(this.guildId, this.channelId) || J.default.can(el.Permissions.VIEW_CHANNEL, e))
                }
                canBeUnread() {
                    return !(this._isThread && !this._isJoinedThread || (0, M.isMessageRequestOrSpamRequest)(this.channelId, [p.default, R.default]) || !this._isThread && (0, L.isOptInEnabledForGuild)(this._guildId) && (this._lastMessageTimestamp < eS || !et.default.isChannelOrParentOptedIn(this._guildId, this.channelId) && !this.hasRecentlyVisitedAndRead() && !this.hasMentions())) && this.canTrackUnreads()
                }
                canHaveMentions() {
                    return !(0 === this.mentionCount || this._isThread && !this._isJoinedThread || (0, M.isMessageRequestOrSpamRequest)(this.channelId, [p.default, R.default]) || (0, L.isOptInEnabledForGuild)(this._guildId) && this._lastMessageTimestamp < eS) && this.canTrackUnreads()
                }
                getGuildChannelUnreadState(e, t, n, a, l, i) {
                    if (t && (this._lastMessageTimestamp < eS || !et.default.isChannelRecordOrParentOptedIn(e) && !this.hasRecentlyVisitedAndRead() && this.mentionCount <= 0)) return {
                        mentionCount: 0,
                        hasNotableUnread: !1
                    };
                    if ("basicPermissions" in e) {
                        if (!Y.default.has(e.basicPermissions, el.BasicPermissions.VIEW_CHANNEL)) return {
                            mentionCount: 0,
                            hasNotableUnread: !1
                        }
                    } else if (g.default.isChannelGated(this.guildId, this.channelId) && !J.default.can(el.Permissions.VIEW_CHANNEL, e)) return {
                        mentionCount: 0,
                        hasNotableUnread: !1
                    };
                    if (l || i) return {
                    ...
                    let s = (0, I.calculateUnreadSetting)({
                        ...
                        u = !1;
                    return u = s === eu.UserUnreadSettings.NULL || s === eu.UserUnreadSettings.MENTIONS_AND_HIGHLIGHTS ? this.mentionCount > 0 || (0, C.hasUnreadChannelHighlights)(this.channelId, this._ackMessageId) : this.getAckTimestamp() < this._lastMessageTimestamp, {
                        mentionCount: this.mentionCount,
                        hasNotableUnread: u
                    }
                }
                ...
                hasNotableUnread() {
                    let e = W.default.getBasicChannel(this.channelId),
                        t = null != e ? (0, I.getGuildUnreadSetting)(e) : eu.UserUnreadSettings.ALL_MESSAGES;
                    return t === eu.UserUnreadSettings.NULL || t === eu.UserUnreadSettings.MENTIONS_AND_HIGHLIGHTS ? (0, C.getUnreadChannelHighlights)(this.channelId, this._ackMessageId).length > 0 || this.hasMentions() : this.getAckTimestamp() < this._lastMessageTimestamp
                }
                ...
                ackPins() {
                    ...
                    if (null == e) {
                        ...
                        this._persisted = !0, eU(() => E.default.post({
                ...
                ack(e) {
                    ...
                    return this.estimated = !1, this.unreadCount = 0, this.mentionCount = 0, (null != t || null != (t = this.lastMessageId)) && (this.ackMessageId = t, this.isManualAck = !1, this._persisted = !0, function(e) {
                        ...
                        let a = n.parent_id,
                            l = eL.get(a);
                        y.default.hasLoaded(n.guild_id) && Object.keys(y.default.getThreadsForParent(n.guild_id, a)).every(e => eZ.hasOpenedThread(e) || 0 > x.default.compare(e, l.ackMessageId)) && l.ack({})
                ...
                _ack(e, t) {
                    ...
                    eU(() => E.default.post({
                        ...
                        if (null != n && (ef === l && a === B.default.getId() && (ef = n.body.token), _.default.dispatch({
                                type: "MESSAGE_ACKED"
                            }), t)) {
                            let t = W.default.getChannel(this.channelId);
                            (0, N.trackWithMetadata)(el.AnalyticEvents.ACK_MESSAGES, {
                ...
                shouldDeleteReadState(e) {
                    ...
                    return !!F.ALL_CHANNEL_TYPES.has(t.type) && (!(0, F.isReadableType)(t.type) || !(0, F.isPrivate)(t.type) && (!!(F.THREAD_CHANNEL_TYPES.has(t.type) && function(e, t, n) {
                        ...
                        return !l && eF(e, n)
                    }(this, t, e)) || !!(this.mentionCount > 0) && !J.default.canBasicChannel(eo, t) || !1))
                }
                getAckTimestamp() {
                    let e, t;
                    ...
                    if (this.type === er.ReadStateTypes.GUILD_EVENT || this.type === er.ReadStateTypes.GUILD_ONBOARDING_QUESTION) e = X.default.getGuild(this.channelId);
                    else if ((0, ei.isStaticChannelRoute)(this.channelId)) e = X.default.getGuild(this.guildId);
                    else {
                        let t = W.default.getChannel(this.channelId);
                        if (null != t) {
                            let n = t.getGuildId();
                    ...
                    return t = null != e ? eH(e) : x.default.extractTimestamp(this.channelId), this._ackMessageTimestamp = t, t
                }
                ...
                recordLastViewedTime() {
                    let e = Math.ceil((Date.now() - x.DISCORD_EPOCH) / V.default.Millis.DAY);
            ...
            function ey(e) {
                e.forEach(e => {
                    if ((0, F.isReadableType)(e.type)) {
                        var t;
                        let n = eL.get(e.id);
                        n.lastMessageId = e.last_message_id, n.lastPinTimestamp = eM(e.last_pin_timestamp), n._isResourceChannel = (0, k.hasFlag)(null !== (t = e.flags) && void 0 !== t ? t : 0, ei.ChannelFlags.IS_GUILD_RESOURCE_CHANNEL), F.THREAD_CHANNEL_TYPES.has(e.type) && n.syncThreadSettings()
                    }
                })
            }
            ...
            function eP(e) {
                (function(e) {
                    ...
                    null === (t = e.threads) || void 0 === t || t.forEach(t => {
                        ...
                        let n = eL.get(t.id);
                        n.lastMessageId = t.lastMessageId, n.lastPinTimestamp = eM(t.lastPinTimestamp), n._isThread = !0, n._isActiveThread = !0, n._isJoinedThread = null != t.member, null == n.ackMessageId && (n.ackMessageId = x.default.fromTimestamp(eG(e.id, t.id))), null == n.ackPinTimestamp && (n.ackPinTimestamp = eG(e.id, t.id))
                    })
                })(e),
                function(e) {
                    var t, n;
                    if ((null === (t = e.guild_scheduled_events) || void 0 === t ? void 0 : t.length) === 0 && null == eL.getIfExists(e.id, er.ReadStateTypes.GUILD_EVENT)) return;
                    let a = eL.get(e.id, er.ReadStateTypes.GUILD_EVENT);
                    a._guildId = e.id;
                    let l = 0,
                        i = null,
                ...
                function(e) {
                    let t = eL.get(e.id, er.ReadStateTypes.GUILD_HOME);
                    t.lastMessageId = x.default.fromTimestamp(d(Date.now()).subtract(24, "h").valueOf())
                }(e),
                function(e) {
                    let t = e.properties.latest_onboarding_question_id;
                    if (null == t) return;
                    let n = eL.get(e.id, er.ReadStateTypes.GUILD_ONBOARDING_QUESTION);
            ...
            function eG(e, t) {
                ...
                let i = W.default.getChannel(t),
                    ...
                    E = Math.max(r, o);
                return E <= 0 && (E = x.default.extractTimestamp(t) - 1), isNaN(u) ? E : Math.max(u, E)
            }
            ...
            function eK() {
                let e = K.default.getCurrentSidebarChannelId(eE),
                    t = !1;
            ...
            class ej extends o.default.Store {
                initialize() {
                    this.waitFor(q.default, en.default, X.default, z.default, W.default, ee.default, Z.default, J.default, T.default, y.default, P.default, K.default, S.default, Q.default, g.default, et.default, ea.default, m.default, p.default, H.default, R.default), this.syncWith([K.default], eK)
                }
                getReadStatesByChannel() {
                    var e;
                    return null !== (e = eL._readStates[er.ReadStateTypes.CHANNEL]) && void 0 !== e ? e : {}
                }
                getForDebugging(e) {
                ...
                getNotifCenterReadState(e) {
                    return eL._readStates[er.ReadStateTypes.NOTIFICATION_CENTER][e]
                }
                hasUnread(e) {
                    let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : er.ReadStateTypes.CHANNEL;
                ...
                getGuildChannelUnreadState(e, t, n, a, l, i) {
                    return eL.getValue(e.id, er.ReadStateTypes.CHANNEL, s => s.getGuildChannelUnreadState(e, t, n, a, l, i), {
                        mentionCount: 0,
                        hasNotableUnread: !1
                    })
                }
                ...
                lastPinTimestamp(e) {
                    return eL.getValue(e, er.ReadStateTypes.CHANNEL, e => e.lastPinTimestamp, null)
                }
                ...
                hasUnreadPins(e) {
                    return eL.getValue(e, er.ReadStateTypes.CHANNEL, e => e.canBeUnread() && e.lastPinTimestamp > e.ackPinTimestamp, !1)
                }
            ...
            let eZ = new ej(_.default, {
                CONNECTION_OPEN: function(e) {
                    ...
                    ep(), ef = null, !e_ && !s.partial && eL.clearAll(), e_ = !1, s.entries.forEach(e => {
                        var t, n, a;
                    ...
                    for (let e of (function(e) {
                            ...
                            let n = eL.get(t.id, er.ReadStateTypes.NOTIFICATION_CENTER);
                            e.forEach(e => {
                        ...
                        }(l), eD(i), a)) eD(null !== (n = e.channels) && void 0 !== n ? n : []), ek(e), eP(e);
                    eV(), eg = setTimeout(() => (function(e) {
                        let t = eh();
                        for (let a of e) {
                            var n;
                ...
                OVERLAY_INITIALIZE: function(e) {
                    ...
                    ep(), ef = null, eE = n, ec = K.default.getCurrentSidebarChannelId(eE), eL.clearAll(), t.forEach(e => {
                ...
                CACHE_LOADED: function(e) {
                    ...
                    e_ = !0, ep(), t.forEach(e => {
                        ...
                        e.type = n, null == eL._readStates[n] && (eL._readStates[n] = {}), eL._readStates[n][e.channelId] = (0, f.dangerouslyCast)(e, eL)
                    })
                },
                GUILD_CREATE: function(e) {
                    var t;
                    ...
                    }), eD(null !== (t = n.channels) && void 0 !== t ? t : []), ek(n), eP(n)
                },
                ...
                MESSAGE_CREATE: function(e) {
                    ...
                    } else null == o && (t = ee.default.getChannelId(), n = K.default.getCurrentSidebarChannelId(t));
                    let E = t === l || n === l;
                    if (E && ev(u) && !s || null != a && a.isInstanceFocused() && E && a.isInstanceUILocked() && a.isPinned(el.OverlayWidgets.TEXT)) return u.ack({
                        messageId: i.id
                    });
                    (null == u.oldestUnreadMessageId || u.oldestUnreadMessageIdStale) && (u.oldestUnreadMessageId = i.id), u.unreadCount++;
                    let c = null != i.author && $.default.isBlocked(i.author.id) || i.type === el.MessageTypes.RECIPIENT_REMOVE && (null == d ? void 0 : d.type) === el.ChannelTypes.GROUP_DM;
                    if (!c && (null != r && (0, O.isRawMessageMentioned)({
                        ...
                        }) || eO(W.default.getChannel(l))) && (u.mentionCount++, (0, v.isNotificationRedesignV2Enabled)() && null != r)) {
                        let e = eL.get(r.id, er.ReadStateTypes.NOTIFICATION_CENTER);
                        e.lastMessageId = i.id, m.default.tabFocused && eX(r.id, er.ReadStateTypes.NOTIFICATION_CENTER, void 0, !1)
                    }
                },
                MESSAGE_DELETE: eb,
                MESSAGE_DELETE_BULK: eb,
                MESSAGE_ACK: eQ,
                ...
                CHANNEL_SELECT: function(e) {
                    ...
                    eW(eE), eW(ec);
                    let i = !1;
                    return eE !== n && (i = eq(eE) || i, i = eq(ec) || i), (eE === n || (null == l ? void 0 : l.type) != null && el.ChannelTypesSets.GUILD_THREADS_ONLY.has(l.type)) && (i = eY(n) || i), eE === n && (i = eY(a) || i), eE = n, ec = a, i
                },
                VOICE_CHANNEL_SELECT: function(e) {
                    let {
                        channelId: t
                ...
                THREAD_CREATE: function(e) {
                    ...
                    (function(e) {
                        ...
                        let t = eL.get(e.id);
                        t.lastMessageId = e.lastMessageId, t.lastPinTimestamp = eM(e.lastPinTimestamp), t.syncThreadSettings(), e.ownerId === B.default.getId() && (t.loadedMessages = !0)
                    })(t),
                    function(e) {
                        let t = e.parent_id,
                            n = eL.get(t);
                ...
                WINDOW_FOCUS: function(e) {
                    let t = !1;
                    for (let [n, a] of Object.entries(eC)) a === e.windowId && (t = function(e, t) {
                        if (null == e) return !1;
                        let n = eL.get(e);
                ...
                BULK_ACK: function(e) {
                    ...
                    let {
                        channels: a,
                        context: l
                    } = e, i = a.filter(e => null != e.messageId && eZ.hasUnread(e.channelId, e.readStateType));
                    t = i, n = l, t.forEach(e => {
                        let {
                            channelId: t,
                            messageId: n,
                    ...
                    }), n !== el.CURRENT_APP_CONTEXT || (eN.push(...t.map(e => ({
                ...
                ENABLE_AUTOMATIC_ACK: function(e) {
                    ...
                    return eC[t] !== n && (u(void 0 === eC[t], "handleEnableAutomaticAck: channel already visible in another window"), eC[t] = n, eY(t))
                },
                DISABLE_AUTOMATIC_ACK: function(e) {
                    let {
                        channelId: t
                    } = e;
                    return eC[t] = void 0, !1
                },
                GUILD_FEATURE_ACK: ez,
                GUILD_SCHEDULED_EVENT_CREATE: function(e) {
                    let {
                        guildScheduledEvent: t
                    } = e, n = t.guild_id, a = eL.get(t.guild_id, er.ReadStateTypes.GUILD_EVENT);
                ...
                GUILD_SCHEDULED_EVENT_UPDATE: function(e) {
                    ...
                    let a = eL.get(n, er.ReadStateTypes.GUILD_EVENT);
                ...
                GUILD_SCHEDULED_EVENT_DELETE: function(e) {
                    ...
                    if (ex(t)) return !1;
                    let a = eL.get(t.guild_id, er.ReadStateTypes.GUILD_EVENT);
                    a.handleGuildEventRemoval(n, t.id)
                },
                GUILD_DELETE: function(e) {
                    let {
                    ...
                    return eL.clear(t.id, er.ReadStateTypes.GUILD_EVENT)
                },
                GUILD_UPDATE: function(e) {
                    ...
                    if (null == n) return;
                    let a = eL.get(t.id, er.ReadStateTypes.GUILD_ONBOARDING_QUESTION);
                ...
                RELATIONSHIP_ADD: function(e) {
                    let t = en.default.getCurrentUser();
                    if (!(0, U.inNotificationCenterEnabled)() || null == t || null == e.relationship.since || e.relationship.type !== el.RelationshipTypes.PENDING_INCOMING && e.relationship.type !== el.RelationshipTypes.FRIEND) return !1;
                    let n = eL.get(t.id, er.ReadStateTypes.NOTIFICATION_CENTER),
                    ...
                    i < l && (n.lastMessageId = x.default.fromTimestamp(l), !s && m.default.active || s && m.default.tabFocused ? eX(t.id, er.ReadStateTypes.NOTIFICATION_CENTER, void 0, !1) : a ? n.mentionCount-- : n.mentionCount++)
                },
                RELATIONSHIP_REMOVE: function(e) {
                    let t = en.default.getCurrentUser();
                    if (!(0, U.inNotificationCenterEnabled)() || null == t || null == e.relationship.since || e.relationship.type !== el.RelationshipTypes.PENDING_INCOMING) return !1;
                    let n = eL.get(t.id, er.ReadStateTypes.NOTIFICATION_CENTER),
                ...
                NOTIFICATION_CENTER_ITEMS_ACK: function(e) {
                    ...
                    if (null == l) return !1;
                    let i = eL.get(l, er.ReadStateTypes.NOTIFICATION_CENTER);
                    n.forEach(e => {
