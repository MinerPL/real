            ...
            e.exports = function(e) {
                ...
                m.push(e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, p("'"), p('"'), t.CSS_NUMBER_MODE, {
                    begin: "(url|data-uri)\\(",
                    starts: {
                        className: "string",
                        end: "[\\)\\n]",
                    ...
                    keywords: E,
                    relevance: 0
                }, u("variable", "@@?" + a, 10), u("variable", "@\\{" + a + "\\}"), u("built_in", "~?`[^`]*?`"), {
                    className: "attribute",
                    begin: a + "\\s*:",
                    end: ":",
                    returnBegin: !0,
                ...
                let g = m.concat({
                    ...
                    T = {
                        ...
                        illegal: "[<='$\"]",
                        relevance: 0,
                        contains: [e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, S, u("keyword", "all\\b"), u("variable", "@\\{" + a + "\\}"), {
                            begin: "\\b(" + i.join("|") + ")\\b",
                            className: "selector-tag"
                        }, t.CSS_NUMBER_MODE, u("selector-tag", _, 0), u("selector-id", "#" + _), u("selector-class", "\\." + _, 0), u("selector-tag", "&", 0), t.ATTRIBUTE_SELECTOR_MODE, {
                    ...
                    f = {
                        begin: a + ":(:)?" + "(".concat(c.join("|"), ")"),
                        returnBegin: !0,
                        contains: [T]
                    };
                return d.push(e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, {
                    className: "keyword",
