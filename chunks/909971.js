...
function u(e) {
  let {
    ...
    onClose: l,
    onDismiss: u
  } = e, [S, M] = o.useState(!1), [E, h] = o.useState(!0), [A, _] = o.useState(!0), m = (0, r.useUID)(), x = () => {
    u(), l()
  };
  return (0, a.jsxs)(d.ModalRoot, {
    ...
    children: [(0, a.jsxs)(d.ModalContent, {
      ...
      children: [(0, a.jsx)(d.ModalCloseButton, {
        ...
        children: i.default.Messages.MESSAGE_REQUESTS_SPAM_HAM_MODAL_HEADER
      }), (0, a.jsx)(d.Text, {
        variant: "text-md/normal",
        color: "header-secondary",
        className: c.modalBody,
        children: i.default.Messages.MESSAGE_REQUESTS_SPAM_HAM_MODAL_SUBHEADER
      ...
      children: [(0, a.jsx)(d.Button, {
        ...
        children: (0, a.jsx)(d.Text, {
          ...
          children: i.default.Messages.MESSAGE_REQUESTS_SPAM_HAM_OPT_OUT
        })
      })]
    })]
  })
