            ...
            var f = function(e) {
                let {
                    ...
                    expirationDate: a,
                    error: i
                } = e, [o, c] = l.useState(!1), [S, f] = l.useState(null), [m, T] = l.useState(a);
                return l.useEffect(() => {
                    t({
                        expirationDate: m
                    }, null === S)
                }, [m, t, S]), (0, n.jsx)(d.default, {
                    className: s,
                    form: E,
                    values: {
                        expirationDate: m
                    ...
                    formError: i,
                    onFieldChange: e => {
                        !o && "" !== e && c(!0), o && "" === e || !(0, r.validateExpiry)(e) ? f(u.default.Messages.CREDIT_CARD_ERROR_EXPIRATION) : f(null), T(e)
                    }
                })
            }