...
function en(e) {
  return T.default.findActivity(e, e => null != e.party && null != e.party.id && (0, P.isSpotifyParty)(e.party.id))
}
...
function ed(e, t, n) {
  ...
  n && (g = "started", D.default.track(k.AnalyticEvents.SPOTIFY_LISTEN_ALONG_STARTED, {
    party_id: d.id,
    other_user_id: e
...
function eu() {
  D.default.track(k.AnalyticEvents.SPOTIFY_LISTEN_ALONG_ENDED, {
...
function el() {
  let e = Object.keys(X),
    t = y.default.getAccounts().filter(e => {
      ...
      return t === k.PlatformTypes.SPOTIFY
    });
  if (null == t) return !1;
  let n = t.map(e => {
    let {
...
function ef() {
  ...
  J = !0, (0, b.pause)(t.accountId, t.accessToken), D.default.track(k.AnalyticEvents.SPOTIFY_AUTO_PAUSED), Y.info("Playback auto paused")
}
...
class em extends f.default.Store {
  initialize() {
    this.waitFor(y.default, I.default), this.syncWith([T.default], () => (function() {
      if (null == i) return !1;
      let e = ee();
      if (null == e) return !1;
      let {
  ...
  getActivity() {
    ...
    let g = {},
      m = null != a.image ? (0, N.getAssetFromImageURL)(k.PlatformTypes.SPOTIFY, a.image.url) : null;
    ...
    return !l && (v.sync_id = d, v.flags = k.ActivityFlags.PLAY | k.ActivityFlags.SYNC, v.metadata = {
      context_uri: t,
      album_id: a.id,
      artist_ids: c.map(e => {
        let {
...
let eh = new em(g.default, {
  ...
  SPOTIFY_PLAYER_STATE: function(e) {
    ...
    let c = y.default.getAccount(t, k.PlatformTypes.SPOTIFY);
    if (null == c) return f;
    let g = Z[t],
      m = null != a ? {
        account: c,
    ...
    null != a && D.default.track(k.AnalyticEvents.ACTIVITY_UPDATED, {
      party_platform: k.PlatformTypes.SPOTIFY,
      track_id: a.id,
      has_images: !0
    })
  },
