            ...
            }), s("222007"), s("511434"), s("313619"), s("654714"), s("287168"), s("956660"), s("424973"), s("70102");
            var n, r = s("748820"),
                a = s("551750"),
                l = s("739942");
            ...
            h ? c() : v(), n = class {
                get workerIndex() {
                    ...
                    if (null == e) {
                        ...
                        if (null != t) e = t;
                            ...
                            var i, s;
                            let t = null !== (s = null === (i = d[0]) || void 0 === i ? void 0 : i.numActive) && void 0 !== s ? s : 0;
                            for (let [i, s] of d.entries()) s.numActive <= t && (t = s.numActive, e = i);
                ...
                get worker() {
                    ...
                    if (null == d[e]) throw Error("No worker in pool at index ".concat(e));
                    return d[e].worker
                }
                async drop() {
                    var e, i, s, t;
                ...
                setState(e, i) {
                    var s, t;
                    this.shouldAnimate = e, this.isInitialized && (h ? null === (s = this.worker) || void 0 === s || s.postMessage({
                        canvasId: this.canvasId,
                ...
                constructor({
                    ...
                    this.isVisible = !1, this.isInitialized = !1, this.shouldAnimate = !1, this.handleVisibilityChange = e => {
                        ...
                        if (i !== this.isVisible) {
                            ...
                            h ? null === (s = this.worker) || void 0 === s || s.postMessage({
                                canvasId: this.canvasId,
                        ...
                        var i, s;
                        e.data.type === a.MessageTypes.FIRST_DRAW && (null === (i = this.onInitialDraw) || void 0 === i || i.call(this)), e.data.type === a.MessageTypes.ERROR && (null === (s = this.onError) || void 0 === s || s.call(this))
                    }, this.handleError = e => {
                        var i;
                        null === (i = this.onError) || void 0 === i || i.call(this, e)
                    }, this.canvasId = (0, r.v4)(), this.assetUrl = s, this.assetData = n, this.onInitialDraw = l, this.onError = o, this.observer = new IntersectionObserver(this.handleVisibilityChange), this.observer.observe(e), h ? this.initializationPromise = c().then(() => {
                        var t, r, l;
                        null === (t = this.worker) || void 0 === t || t.addEventListener("message", this.handleMessage), null === (r = this.worker) || void 0 === r || r.addEventListener("error", this.handleError);
