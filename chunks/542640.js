            ...
            function E(e) {
                let {
                    ...
                    emojiId: s,
                    emojiName: i
                } = t, u = (0, l.useStateFromStores)([o.default], () => null != s ? o.default.getUsableCustomEmojiById(s) : null);
            ...
            function C(e) {
                ...
                let S = e => {
                        ...
                        u.default.updateForumPostTags(t.id, a)
                    },
                    _ = null == o ? void 0 : o.map(e => {
                        let t = m.includes(e);
