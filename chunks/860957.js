            ...
            let ey = new eC(E.default, __OVERLAY__ ? {
                ...
                RPC_SERVER_READY: function(e) {
                    ...
                    l.append("build_id", "cd040926b01b523095a5b0ee05243f3a5f224765"), l.append("rpc", String(t)), l.append("rpc_auth_token", k), a = "".concat(location.protocol, "//").concat(location.host, "/overlay?").concat(l.toString())
                },
