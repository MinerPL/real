            ...
            function S(e) {
                let {
                    ...
                    username: E,
                    guild: f
                } = e, m = null != s ? s : S, T = (0, n.useStateFromStores)([r.default], () => r.default.can(d.Permissions.CHANGE_NICKNAME, f) || r.default.can(d.Permissions.MANAGE_NICKNAMES, f));
