...
e.exports = function(e) {
  let t = e.regex,
    ...
    S = e => e.map(e => e.replace(/\|\d+$/, "")),
    b = {
      variants: [{
        match: [/new/, t.concat(_, "+"), t.concat("(?!", S(E).join("\\b|"), "\\b)"), i],
        scope: {
          1: "keyword",
          4: "title.class"
        }
    ...
    R = {
      ...
      keywords: g,
      contains: [C, r, f, e.C_BLOCK_COMMENT_MODE, d, m, b]
    },
    N = {
      relevance: 0,
      match: [/\b/, t.concat("(?!fn\\b|function\\b|", S(u).join("\\b|"), "|", S(E).join("\\b|"), "\\b)"), n, t.concat(_, "*"), t.lookahead(/(?=\()/)],
      scope: {
  ...
  R.contains.push(N);
  let O = [C, f, e.C_BLOCK_COMMENT_MODE, d, m, b],
    h = {
      begin: t.concat(/#\[\s*/, i),
      beginScope: "meta",
      end: /]/,
  ...
  return {
    case_insensitive: !1,
    keywords: g,
    contains: [h, e.HASH_COMMENT_MODE, e.COMMENT("//", "$"), e.COMMENT("/\\*", "\\*/", {
      contains: [{
        scope: "doctag",
        match: "@[A-Za-z]+"
      }]
      ...
      contains: [{
        ...
        excludeEnd: !0,
        keywords: g,
        contains: ["self", r, f, e.C_BLOCK_COMMENT_MODE, d, m]
      }]
    }, {
      scope: "class",
      variants: [{
