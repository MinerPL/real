            ...
            a = class {
                ...
                init() {
                    this.rpcServer.getCurrentUser = () => A.default.getCurrentUser(), this.rpcServer.onConnect = e => {
                        ...
                        }), m.default.track(M.AnalyticEvents.AUTHORIZED_APP_CONNECTED, {
                    ...
                    let e = [d.default, c.default, C.default, p.default, h.default, T.default],
                ...
                handleSpeaking(e) {
                    ...
                    if (e.context === D.MediaEngineContextTypes.DEFAULT) {
                        ...
                        if (null != n) {
                            ...
                            if (null == a) return;
                            let s = p.default.getVoiceState(a.getGuildId(), e.userId);
                            if (null == s) return;
