...
function B(e) {
  ...
  let {
    ...
    isReady: v
  } = e, I = (0, r.useStateFromStores)([h.default], () => h.default.getRole(B), [B]), [j, p] = a.useState(""), [y, D] = a.useState({}), [N, O] = a.useState(!1);
  a.useEffect(() => {
    m.default.requestMembers(S, j.trim().toLowerCase(), C.ADD_MEMBER_QUERY_LIMIT)
  }, [S, j]);
  let w = a.useCallback(e => !e.roles.includes(B), [B]),
    U = (0, C.useGuildMembers)(S, w),
    F = a.useMemo(() => U.filter(e => (0, C.filterFullMembersByQuery)(j, e)), [j, U]);
  F = F.filter(e => e.id !== x.CLYDE_AI_USER_ID);
  let z = a.useCallback(async () => {
      let e = Object.values(y).map(e => e.row.id);
      O(!0);
      try {
        await f.default.bulkAddMemberRoles(S, B, e), (0, E.requestMembersForRole)(S, B, !1), l()
      } catch (e) {
        O(!1)
      }
    }, [S, B, y, l]),
    Y = a.useCallback(e => {
      D(t => {
        ...
        return s in l ? (delete l[s], l) : (l[s] = {
          display: {
  ...
  return (0, s.jsxs)(s.Fragment, {
    children: [(0, s.jsxs)(n.ModalHeader, {
      ...
      children: [(0, s.jsx)(n.Heading, {
        ...
        children: _.default.Messages.ROLE_CREATE_ADD_MEMBERS_SUBTITLE
      }) : (0, s.jsxs)("div", {
        className: g.roleContainer,
        children: [(0, s.jsx)(R.default, {
          color: null !== (t = null == I ? void 0 : I.colorString) && void 0 !== t ? t : (0, o.int2hex)(L.DEFAULT_ROLE_COLOR),
          width: 16,
          height: 16
        }), (0, s.jsx)(n.Text, {
      ...
      renderEmptyText: e => _.default.Messages.ROLE_EDIT_MEMBERS_NO_RESULTS.format({
        query: e
      }),
      focusSearchAfterReady: T,
      isReady: v
      ...
      children: [(0, s.jsxs)("div", {
        ...
        children: [k && 0 === Object.keys(y).length ? (0, s.jsx)(n.Button, {
          onClick: l,
