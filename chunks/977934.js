            ...
            (t = e || (e = {})).PREMIUM_ACTIVATED = "PREMIUM_ACTIVATED", t.PREMIUM_UPDATED = "PREMIUM_UPDATED", t.PREMIUM_UPGRADED = "PREMIUM_UPGRADED", t.GUILD_BOOST_APPLIED = "GUILD_BOOST_APPLIED", t.PREMIUM_PAYMENT_STARTED = "PREMIUM_PAYMENT_STARTED";
            class L extends r.PureComponent {
                ...
                animate() {
                    ...
                    n.default.timing(this.animation, {
                        toValue: 1,
                        delay: p.DELAY[a],
                ...
                getContainerStyle() {
                    let {
                        flashColor: a
                    } = this.props, l = p.FLASH_TIME_PERCENT, h = p.FLASH_DURATION_PERCENT, e = (0, C.hexWithOpacity)(a, 0);
                    return {
                ...
                getSvgBorderGradientId() {
                    ...
                    switch (l) {
                        ...
                        case "PREMIUM_UPDATED":
                            if (a === E.PremiumTypes.TIER_0) return M.Gradients.PREMIUM_TIER_0;
                            if (a === E.PremiumTypes.TIER_1) return M.Gradients.PREMIUM_TIER_1;
                ...
                render() {
                    ...
                    return (0, s.jsxs)("div", {
                        ...
                        children: [this.renderSvgBorder(), (0, s.jsxs)(n.default.div, {
                            className: u.animationContainer,
                            style: this.getContainerStyle(),
                            children: [(0, s.jsx)(A.Shine, {
                                className: u.shine,
            ...
            function T(a) {
                let {
                    theme: l,
                    ...h
                } = a, e = (0, m.useToken)(d.default.unsafe_rawColors.WHITE_500).hex(), t = (0, m.useToken)(d.default.unsafe_rawColors.BRAND_500).hex(), r = (0, o.isThemeDark)(l) ? e : t;
                return (0, s.jsx)(L, {
                    ...h,
                    theme: l,
                    flashColor: r
