(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["2727"], {
        ...
        402094: function(e, t, n) {
            "use strict";
            var i = n("201716").forEach;
            e.exports = function(e) {
                var t = (e = e || {}).reporter,
                    n = e.batchProcessor,
                    o = e.stateHandler.getState;
                ...
                return {
                    makeDetectable: function(e, l, u) {
                        ...
                        function z() {
                            ...
                            x.dir = "ltr", x.style.cssText = m, x.className = s, S.className = s, S.style.cssText = g, k.style.cssText = b, O.style.cssText = w, T.style.cssText = y, z.style.cssText = E, k.appendChild(O), T.appendChild(z), S.appendChild(k), S.appendChild(T), x.appendChild(S), f.appendChild(x), d(k, "scroll", A), d(T, "scroll", C), o(l).onExpandScroll = A, o(l).onShrinkScroll = C
                        }
                        ...
                        function C() {
                            ...
                            var e = o(l).style;
                            E(l, e.width, e.height), T(l, e.width, e.height)
                        }
                        ...
                        function I() {
                            ...
                            v("Installing..."), o(l).listeners = [], e = y(), o(l).startSize = {
                                width: e.width,
                                height: e.height
                            }, v("Element start size", o(l).startSize), n.add(0, w), n.add(1, z), n.add(2, A), n.add(3, C), n.add(4, _)
                        }
                        if (v("Making detectable..."), (g = (m = p = l).getRootNode && m.getRootNode().contains(m), (m === m.ownerDocument.body || m.ownerDocument.body.contains(m) || g) && null !== window.getComputedStyle(p)) ? 1 : 0) I();
                        else v("Element is detached"), D(), v("Waiting until element is attached..."), o(l).onRendered = function() {
                            v("Element is now attached"), I()
                        }
                    },
                    addListener: function(e, t) {
        ...
        583311: function(e, t, n) {
            ...
            e.exports = function(e) {
                ...
                if ("scroll" === S && (c.isLegacyOpera() ? (b.warn("Scroll strategy is not supported on legacy Opera. Changing to object strategy."), S = "object") : c.isIE(9) && (b.warn("Scroll strategy is not supported on IE9. Changing to object strategy."), S = "object")), "scroll" === S) n = h(O);
                else if ("object" === S) n = f(O);
                        ...
                        i(o, function(e) {
                            ...
                            if (f && b.log("Attaching listener to element", h, e), !x.isDetectable(e)) {
                                if (f && b.log(h, "Not detectable."), x.isBusy(e)) {
                                    f && b.log(h, "System busy making it detectable"), s(c, e, r), T[h] = T[h] || [], T[h].push(function() {
                                        ++l === o.length && d()
                                    });
                                    return
                                }
        ...
        597666: function(e, t, n) {
            e.exports = n("143739")()
        },
        891374: function(e, t, n) {
            "use strict";
