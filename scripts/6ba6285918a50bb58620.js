            ...
            class i extends n.PureComponent {
                render() {
                    let {
                        ...
                        isLoading: h,
                        value: u
                    } = this.state, c = n.Children.count(t) > 0 ? (0, a.jsx)(r.Card, {
                    ...
                    return (0, a.jsx)(r.ModalRoot, {
                        ...
                        children: (0, a.jsxs)("form", {
                            ...
                            children: [(0, a.jsx)(r.ModalHeader, {
                                ...
                                children: [c, (0, a.jsxs)(r.FormItem, {
                ...
                constructor(...s) {
                    super(...s), this.state = {
                        ...
                        this.setState({
                            isLoading: !0
                        }), t(e).then(s => a(null != s ? s : void 0), s => {
                            if (null != s.body) null == n || n(s.body), !this.shouldSkipErrorMsgRender(s.body) && (s.body.password ? this.setState({
                                error: s.body.password,
                                isLoading: !1
                            }) : s.body.message && this.setState({
