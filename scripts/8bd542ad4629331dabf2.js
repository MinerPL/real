(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["12246"], {
        ...
        718302: function(e, t, s) {
            ...
            var r, l, n = s("773670"),
                a = s("49111");
            (r = l || (l = {})).ARROW_UP = "ARROW_UP", r.ARROW_DOWN = "ARROW_DOWN", r.ARROW_LEFT = "ARROW_LEFT", r.ARROW_RIGHT = "ARROW_RIGHT";
            class i extends n.Component {
                ...
                getNext(e, t, s, r) {
                    let n, a, i, o;
                    if (null == t || null == s) a = 0, i = 0, n = {
                        column: 0,
                        row: 0
                    };
                    else switch (a = t, i = s, r) {
                        case l.ARROW_UP:
                            n = {
                                column: a,
                                row: Math.max(i - 1, 0)
                        ...
                        case l.ARROW_DOWN:
                            n = {
                                column: a,
                                row: Math.min(i + 1, e[a].length - 1)
                            };
                            break;
                        case l.ARROW_LEFT:
                            n = this.wrapPosition(e, a, i, -1);
                            break;
                        case l.ARROW_RIGHT:
                            n = this.wrapPosition(e, a, i, 1)
                    }
                    return null != n && (o = e[n.column][n.row]), (null == o || null == n) && (o = e[(n = {
                        column: a,
                        row: i
                    }).column][n.row]), {
                        column: n.column,
        ...
        873622: function(e, t, s) {
            ...
            class T extends l.PureComponent {
                ...
                constructor(...e) {
                    super(...e), this.state = {
                        ...
                        (0, d.setSearchQuery)(e), this.search(e, y.GIFPickerResultTypes.SEARCH)
                    }, this.handleSelectSuggestion = e => {
                        (0, d.setSearchQuery)(""), c.resetSearch(), this.search(e, y.GIFPickerResultTypes.SEARCH_SUGGESTION, !0)
            ...
            var C = l.forwardRef((e, t) => {
                ...
                })), o = (0, d.useExpressionPickerStore)(e => e.searchQuery), u = (0, g.useSortedFavoriteGIFs)();
                return (0, r.jsx)(T, {
                    ...e,
                    forwardedRef: t,
                    query: null != o && "" !== o ? o : s,
        ...
        762518: function(e, t, s) {
            ...
            var r = s("920040"),
                ...
                E = s("782340"),
                F = s("25125");
            let S = [d.default.unsafe_rawColors.PREMIUM_TIER_1_PURPLE.css, d.default.unsafe_rawColors.PREMIUM_TIER_1_BLUE.css, "#929AFA"],
                T = 1220,
                C = Array.from({
                    length: 16
                }).map((e, t) => ({
            ...
            class P extends l.PureComponent {
                ...
                constructor(...e) {
                    super(...e), this._masonryRef = l.createRef(), this.prevResultQuery = null, this.state = {
                        ...
                        return 1 === e ? (0, r.jsx)("div", {
                            ...
                            children: a.length > 0 ? (0, r.jsxs)(l.Fragment, {
                                children: [(0, r.jsx)("div", {
                                    ...
                                    children: a.map(e => (0, r.jsx)(h.Button, {
                        ...
                        return 0 === l.length && (n !== a || i === _.GIFPickerResultTypes.TRENDING_GIFS) ? (0, r.jsx)(h.MasonryList, {
                            fade: !0,
                            className: F.results,
                            sections: [C.length],
                            columns: e,
