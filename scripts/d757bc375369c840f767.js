    ...
    ["24046"], {
        ...
        686298: function(e, t, n) {
            ...
            let I = [p(l.RESOLUTION_720), p(l.RESOLUTION_1080), p(l.RESOLUTION_1440), p(l.RESOLUTION_SOURCE, () => c.default.Messages.SCREENSHARE_SOURCE)],
                T = [p(l.RESOLUTION_720), p(l.RESOLUTION_1080), p(l.RESOLUTION_1440)],
                h = e => "".concat(e, "p"),
                g = [p(l.RESOLUTION_480, () => h(l.RESOLUTION_480)), p(l.RESOLUTION_720, () => h(l.RESOLUTION_720)), p(l.RESOLUTION_1080, () => h(l.RESOLUTION_1080)), p(l.RESOLUTION_1440, () => h(l.RESOLUTION_1440)), p(l.RESOLUTION_SOURCE, () => c.default.Messages.SCREENSHARE_SOURCE)],
        ...
        644926: function(e, t, n) {
            ...
            function I(e) {
                ...
                let {
                    transitionState: n,
                    onClose: I
                } = e, T = (0, a.useStateFromStores)([d.default], () => d.default.getKeybindForAction(_.GlobalKeybindActions.SOUNDBOARD_HOLD)), [h, g] = r.useState(null !== (t = null == T ? void 0 : T.shortcut) && void 0 !== t ? t : []);
                return r.useEffect(() => (u.default.disable(), () => {
                    ...
                    children: [(0, i.jsxs)(l.ModalHeader, {
                        ...
                        children: [(0, i.jsx)(l.Button, {
                            onClick: function() {
                                if (0 === h.length) return null != T && o.default.deleteKeybind(T.id), I();
                                null == T ? o.default.addKeybind({
        ...
        364685: function(e, t, n) {
            ...
            function M(e) {
                null != e.stickers && (e.stickers.forEach(t => P(t, !0, e)), y(e.id, e.stickers))
            }
            ...
            var w = new F(o.default, {
                BACKGROUND_SYNC: () => {
                    m = null, O = new Map, C = new Map, h = 0
                },
                CONNECTION_OPEN: e => {
                    let {
                        guilds: t
                    } = e;
                    m = null, O = new Map, C = new Map, t.forEach(M), h = t.every(e => null != e.stickers) ? 1 : 0
                },
                GUILD_CREATE: function(e) {
                    let {
                        guild: t
                    } = e;
                    !E.default.isLurking(t.id) && (M(t), 1 === h && null == t.stickers && null != t.stickerUpdates && (h = 0))
                },
                ...
                LOGOUT: () => {
                    h = 0, N = [], O.clear(), g.clear(), m = null, C.clear(), C = new Map(C), A = !1, R = null
                },
                ...
                STICKER_PACKS_FETCH_SUCCESS: e => {
                    ...
                    t.forEach(e => L(e, !0)), R = Date.now(), A = !1
                },
                ...
                GUILD_STICKERS_CREATE_SUCCESS: e => {
                    ...
                    let {
                        guildId: i,
                        sticker: r
                    } = e, a = null !== (t = C.get(i)) && void 0 !== t ? t : [];
                    y(i, [...null !== (n = a.filter(e => e.id !== r.id)) && void 0 !== n ? n : [], r]), P(r)
                },
                ...
                GUILD_STICKERS_UPDATE: e => {
                    ...
                    }, a = null !== (t = C.get(n)) && void 0 !== t ? t : [], l = a.filter(e => null == i.find(t => t.id === e.id));
                    l.forEach(e => {
                        O.delete(e.id), null != m && m.delete(e.id)
                    });
                    let o = i.map(e => r(e));
                    o.forEach(e => P(e)), y(n, o)
                }
            })
        },
