    ...
    ["73888"], {
            ...
            async function c(e, t, n, d, c) {
                ...
                try {
                    let l = {
                        ...
                        o = {};
                    null != t && (o.country_code = t), null != n && (o.payment_source_id = n), null != d && (o.include_unpublished = d), null != c && (o.revenue_surface = c), l.query = o, !a.default.ipCountryCodeLoaded && await (0, u.fetchIpCountryCode)();
                    ...
                    saveAccountChanges(e, t) {
                        ...
                        return (0, d.default)(e => {
                            ...
                            return u.default.track(c.AnalyticEvents.USER_AVATAR_UPDATED, {
                                ...
                                user: t,
                                newPassword: I
                            }), null != T && null != I && l.default.dispatch({
                                type: "PASSWORD_UPDATED",
                                userId: t.id
            ...
            class d extends r.PureComponent {
                render() {
                    ...
                    let {
                        ...
                        errorMessage: p,
                        retrySuccess: A
                    } = this.state, O = r.Children.count(l) > 0 ? (0, i.jsx)(o.Card, {
        ...
        677315: function(e, t, n) {
            ...
            function E(e) {
                ...
                return !!(null != t && d(e, o.default, r.default)) && t.hasFeature(s.GuildFeatures.GUILD_HOME_DEPRECATION_OVERRIDE)
            }
        ...
        242757: function(e, t, n) {
            ...
            function r(e, t, n, r) {
                let l = null != n ? n : t,
                    a = null != l && e.can(i.Permissions.CREATE_INSTANT_INVITE, l);
                return a || null != t && null != t.vanityURLCode || (null == r ? void 0 : r.invite_code) != null
            }
        },
        ...
        812809: function(e, t, n) {
            ...
            function a(e) {
                let t = function() {
                        ...
                        return (0, l.amplitudeToPerceptual)(null !== (e = null == t ? void 0 : t.volume) && void 0 !== e ? e : 100) / 100
                    }(),
        ...
        244480: function(e, t, n) {
            ...
            function A(e, t) {
                let n = e.getGuildId();
                return r(null != n, "This channel cannot be guildless."), a.default.patch({
            ...
            function O(e, t) {
                ...
                let l = c.default.getVoiceStateForChannel(e.id),
                    o = (0, I.getAudienceRequestToSpeakState)(l);
            ...
            function N(e) {
                ...
                return r(null != t, "This channel cannot be guildless."), a.default.patch({
            ...
            function R(e, t, n) {
                let i = e.getGuildId();
                return r(null != i, "This channel cannot be guildless."), a.default.patch({
            ...
            function C(e, t) {
                ...
                let n = t.getGuildId();
                return r(null != n, "This channel cannot be guildless."), R(t, e.id, !0), a.default.patch({
            ...
            function m(e, t, n) {
                ...
                n ? (s.allow = l.default.add(s.allow, t), s.deny = l.default.remove(s.deny, t)) : (s.allow = l.default.remove(s.allow, t), s.deny = l.default.add(s.deny, t)), o.default.updatePermissionOverwrite(e.id, s)
            }
            async function U(e, t, n, i) {
                if ("" === t) return;
                let r = d.default.getVoiceChannelId() === e.id;
                !r && (0, _.connectToStage)(e);
        ...
        230324: function(e, t, n) {
            ...
            function c(e, t, n, i) {
                let l = t[0],
                    a = r.default.getName(e, n, l),
                    o = null != i ? i : t.length;
                return 1 === o && null != l ? a : null == l ? d.default.Messages.SPEAKING_COUNT.format({
                    count: o
            ...
            function _(e) {
                ...
                return {
                    ...
                    request_to_speak_state: l.default.canEveryoneRole(u.Permissions.REQUEST_TO_SPEAK, e) ? o.RequestToSpeakPermissionStates.EVERYONE : o.RequestToSpeakPermissionStates.NO_ONE,
        ...
        77445: function(e, t, n) {
            ...
            function o() {
                let e = (0, i.useStateFromStores)([l.default], () => l.default.getVoiceChannelId()),
        ...
        130563: function(e, t, n) {
            ...
            function a() {
                return (0, i.useStateFromStores)([l.default, r.default], () => {
        ...
        726750: function(e, t, n) {
            ...
            function S(e) {
                ...
                let n = (0, _.default)(),
                    ...
                    f = (0, r.useStateFromStores)([a.default], () => a.default.getGuild(I), [I]),
                    p = (0, r.useStateFromStores)([u.default], () => null != S ? u.default.getVoiceStateForChannel(S, e.id) : null, [S, e.id]),
                    A = (null === (t = o.default.getCurrentUser()) || void 0 === t ? void 0 : t.id) === e.id,
                    O = (0, E.default)(),
                    N = (0, r.useStateFromStores)([c.default], () => c.default.getPermissionsForUser(e.id, S), [S, e.id]),
        ...
        364685: function(e, t, n) {
            ...
            let A = 2,
                ...
                M = () => {
                    ...
                    if (null != t) {
                        for (let [e, n] of t)
                            if (T.default.isMember(e) && !g.has(e)) {
            ...
            var F = new b(o.default, {
                BACKGROUND_SYNC: () => {
                    R = null, N = new Map, g = new Map, A = 0
                },
                CONNECTION_OPEN: e => {
                    let {
                        guilds: t
                    } = e;
                    R = null, N = new Map, g = new Map, t.forEach(G), A = t.every(e => null != e.stickers) ? 1 : 0
                },
                ...
                GUILD_DELETE: function(e) {
                    ...
                    let {
                        guild: n
                    } = e, i = null !== (t = g.get(n.id)) && void 0 !== t ? t : [];
                    i.forEach(e => {
                        null != R && R.delete(e.id), N.delete(e.id)
                    }), g.delete(n.id), g = new Map(g)
                },
                LOGOUT: () => {
                    A = 0, C = [], N.clear(), O.clear(), R = null, g.clear(), g = new Map(g), U = !1, m = null
                },
                ...
                GUILD_STICKERS_CREATE_SUCCESS: e => {
                    ...
                    let {
                        guildId: i,
                        sticker: r
                    } = e, l = null !== (t = g.get(i)) && void 0 !== t ? t : [];
                    L(i, [...null !== (n = l.filter(e => e.id !== r.id)) && void 0 !== n ? n : [], r]), P(r)
                },
                ...
                GUILD_STICKERS_UPDATE: e => {
                    ...
                    }, l = null !== (t = g.get(n)) && void 0 !== t ? t : [], a = l.filter(e => null == i.find(t => t.id === e.id));
                    a.forEach(e => {
        ...
        406784: function(e, t, n) {
            ...
            var r = n("77078"),
                ...
                C = n("49111"),
                m = n("782340"),
                U = (0, o.default)((0, a.default)(function(e) {
                    let {
                        user: t,
                        showMediaItems: n = !1,
                        mediaEngineContext: a,
                        onSelect: o
                    } = e, s = (0, O.default)(t.id), C = (0, p.default)(t.id), U = (0, I.default)(t), g = (0, T.default)({
                        user: t
                    }), L = (0, _.default)(t), h = (0, R.default)(t.id), M = (0, N.default)(t.id), P = (0, A.default)(t.id, a), D = (0, f.default)(t), v = (0, u.default)(null, t), y = (0, E.default)(t), G = (0, S.default)(t), b = (0, d.default)({
                        id: t.id,
        ...
        421602: function(e, t, n) {
            ...
            function d(e, t) {
                ...
                return n === e || d ? null : (0, i.jsx)(r.MenuItem, {
                    id: "message-user",
        ...
        26092: function(e, t, n) {
            ...
            function U(e) {
                ...
                }, O = null !== (i = e.onClose) && void 0 !== i ? i : null, N = null !== (r = e.analyticsLocation) && void 0 !== r ? r : null, R = null !== (l = e.analyticsLocations) && void 0 !== l ? l : [], m = null !== (a = e.impressionSource) && void 0 !== a ? a : null
            }
            ...
            class h extends l.default.Store {
                ...
                hasChanges() {
                    return null != I && null != S && (!!this.isOpen() || A === u.DrawerTabTypes.USER_SETTINGS) && !r.isEqual(I, S)
                }
                isOpen() {
                    return f
                }
            ...
            var M = new h(a.default, {
                ...
                DRAWER_SELECT_TAB: function(e) {
                    return A = e.tab, null == c && A === u.DrawerTabTypes.USER_SETTINGS && U({
                        type: "USER_SETTINGS_MODAL_INIT",
                        section: null,
                        subsection: null,
                        scrollPosition: null,
