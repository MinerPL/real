    ...
    ["84872"], {
        ...
        817477: function(e, t, n) {
            ...
            function _(e) {
                ...
                } = e, A = (0, s.useStateFromStores)([d.default], () => d.default.getWindow(T.PopoutWindowKeys.CHANNEL_CALL_POPOUT)), C = (0, i.useMemoOne)(() => (0, r.v4)(), [t]), v = u.useRef(null), O = (0, E.default)(v, S, null == A ? window : A), M = {
                    ..._,
                    frame_id: C,
                    platform: I.ActivityPlatform.DESKTOP
                }, [R, L] = u.useState(!1), g = f.default.theme, D = {
                    ...a
                };
                return g === T.ThemeTypes.LIGHT ? D.colorScheme = "light" : D.colorScheme = "dark", u.useEffect(() => (m.ComponentDispatch.dispatch(T.ComponentActions.IFRAME_MOUNT, {
                    id: C
                }), () => {
        ...
        732523: function(e, t, n) {
            ...
            function M(e, t) {
                ...
                let {
                    ...
                    components: p,
                    channelId: I
                } = e, T = null === (n = E.default.getChannel(I)) || void 0 === n ? void 0 : n.guild_id, N = (0, d.default)(), [M, R] = l.useState(null), [g, D] = l.useState(null), b = (0, o.useStateFromStores)([h.default], () => h.default.getModalState(g), [g]), w = l.useMemo(() => (0, _.createComponents)(p, u.id, T), [p, u.id, T]), y = l.useRef(new Set), U = l.useCallback(() => {
            ...
            let L = (e, t, n) => t.map((t, l) => {
                ...
                switch (t.type) {
                    case s.ComponentType.ACTION_ROW:
                        return {
                            type: t.type, components: L(e, null !== (u = t.components) && void 0 !== u ? u : [], o)
                        };
        ...
        168984: function(e, t, n) {
            ...
            let T = (0, f.cssValueToNumber)(a.default.INTERACTION_IFRAME_MODAL_MODAL_MIN_WIDTH),
                S = (0, f.cssValueToNumber)(a.default.INTERACTION_IFRAME_MODAL_MODAL_MAX_WIDTH),
                _ = (0, f.cssValueToNumber)(a.default.INTERACTION_IFRAME_MODAL_MODAL_MARGIN),
            ...
            function N(e) {
                ...
                let {
                    ...
                    let e = Math.min((O - h - 2 * _) * 16 / 9, S);
                    return Math.max(T, Math.min(v - 2 * _, e))
                }, [v, O]);
        ...
        403809: function(e, t, n) {
            ...
            }), (u = l || (l = {})).USER = "user", u.ROLE = "role", u.CHANNEL = "channel"
        },
