        ...
        752598: function(e, t, n) {
            ...
            let S = (e, t) => {
                ...
                let i = null == t ? void 0 : t.state,
                    a = e.state === h.MessageStates.SENT && C(e.id) < Date.now();
                let u = e.state === h.MessageStates.SEND_FAILED && (null == (n = e.id) || "" === n || Number.isNaN(n) ? Date.now() : r.default.extractTimestamp(n) + 3e3) < Date.now(),
                    ...
                    c = e.isCommandType();
                if (s && i === _.InteractionState.QUEUED || c && e.state === h.MessageStates.SENDING && null != t) return l.SENDING;
                if (s && i === _.InteractionState.CREATED || e.hasFlag(h.MessageFlags.LOADING) && !a) return l.CREATED;
                if (null != e.interaction && e.hasFlag(h.MessageFlags.LOADING) && a) return l.TIMED_OUT;
                else if (null != e.interaction && !e.hasFlag(h.MessageFlags.LOADING) && u) return l.TIMED_OUT;
                else if (c && e.state === h.MessageStates.SEND_FAILED) return l.FAILED
            };
            ...
            var l = n("77078"),
                ...
                F = (0, u.default)((0, a.default)(function(e) {
                    let {
                        ...
                        user: t,
                        context: H
                    }), W = (0, v.default)(t), K = (0, x.default)(t.id), z = (0, R.default)(n.id, a), Q = (0, y.default)(t), q = (0, o.default)(null, t), X = (0, P.default)(t.id), J = (0, O.default)(t.id, n.id), $ = (0, g.default)(t), ee = (0, D.default)(t.id), et = (0, U.default)(t.id, n.id), en = (0, A.default)(t), ei = (0, I.default)(n), el = (0, h.default)({
                        id: t.id,
                        label: w.default.Messages.COPY_ID_USER
                    }), er = (0, h.default)({
                        id: n.id,
                        label: w.default.Messages.COPY_ID_CHANNEL
                    }), ea = (0, _.default)(n), eu = (0, f.default)(t.id), es = (0, d.default)(n.id), eo = (0, S.default)(t), ec = (0, E.default)(t.id), ed = (0, L.default)({
        ...
        563816: function(e, t, n) {
            ...
            var i = n("37983"),
                ...
                T = e => {
                    ...
                    }, [M, A, R]), O = l.useMemo(() => (0, d.canUseContextMenuCommands)(r, U.length, o.getCommandTypeCount(r, t, null == v ? void 0 : v.applicationCommandCounts)), [r, t, U.length, null == v ? void 0 : v.applicationCommandCounts]);
                    l.useEffect(() => {
                        if (O !== S.current) {
                            if (O) null == N || N();
                            S.current = O
