    ...
    ["21041"], {
                    ...
                    switch (e.type) {
                        ...
                        case "oscillating-random":
                            ...
                            var d = O(e.minStart),
                                ...
                                m = O(e.minDirection),
                                R = O(e.maxDirection);
                            return new p(new N(A(n.x, i.x), A(d.x, E.x), A(_.x, f.x), A(I.x, T.x), C(m.x, R.x), g(e.easingFunctions)[0]), new N(A(n.y, i.y), A(d.y, E.y), A(_.y, f.y), A(I.y, T.y), C(m.y, R.y), g(e.easingFunctions)[0]))
                    }
                }(f(f({}, e), {
                    valueType: "Vector2"
                }))
            ...
            var v = i.forwardRef(function(e, t) {
                ...
                var P = i.useCallback(function(e, t) {
                    ...
                    b = i.useCallback(function(e, t, n, i, o) {
                        var a, l, u, d, E, _, I, p, O, v, L, U, D, y, M, b = (a = null !== (M = e.id) && void 0 !== M ? M : (0, r.v4)(), l = e, u = n, d = i, E = o, p = R((I = (_ = l, f(f({
                            id: a
                        }, c), _))).size), v = (O = function(e, t) {
                            if (null != e) {
                                ...
                                switch (e.type) {
                                    ...
                                    case "oscillating-random":
                                        ...
                                        var d = m(e.minStart),
                                            ...
                                            O = m(e.minDirection),
                                            R = m(e.maxDirection);
                                        return new T(new N(A(n.x, i.x), A(d.x, E.x), A(_.x, f.x), A(I.x, p.x), C(O.x, R.x), g(e.easingFunctions)[0]), new N(A(n.y, i.y), A(d.y, E.y), A(_.y, f.y), A(I.y, p.y), C(O.y, R.y), g(e.easingFunctions)[0]), new N(A(n.z, i.z), A(d.z, E.z), A(_.z, f.z), A(I.z, p.z), C(O.z, R.z), g(e.easingFunctions)[0]))
                                }
                            }(f(f({}, D), {
                                valueType: "Vector3"
                            }))),
                            ...
                            opacity: (y = I.opacity, function(e) {
                                switch (e.type) {
                                    ...
                                    case "oscillating-random":
                                        return new N(A(e.minValue, e.maxValue), A(e.minStart, e.maxStart), A(e.minFinal, e.maxFinal), A(e.minDuration, e.maxDuration), C(e.minDirection, e.maxDirection), g(e.easingFunctions)[0])
                                }
                            }(f(f({}, y), {
                                valueType: "number"
                            }))),
                ...
                return i.useEffect(function() {
                    ...
                    return e("click", B, u), e("mousedown", V, d), e("mousemove", H, E), e("mouseup", k, _),
                        function() {
                            window.removeEventListener("click", B), window.removeEventListener("mousedown", V), window.removeEventListener("mousemove", H), window.removeEventListener("mouseup", H)
                        }
                }, [B, V, H, k, u, d, E, _]), i.useEffect(function() {
                    var e = v.current,
            ...
            var r = function() {
                ...
                return r.prototype = {
                    ...
                    quantize: function(a, l) {
                        ...
                        var u, s, c, d, E, _, f, I, p, T, h, S, N, A, g, C, O = (u = a, E = Array(32768), u.forEach(function(n) {
                        ...
                        var R = (_ = a, f = O, h = 1e6, S = 0, N = 1e6, A = 0, g = 1e6, C = 0, _.forEach(function(t) {
                                I = t[0] >> e, p = t[1] >> e, T = t[2] >> e, I < h ? h = I : I > S && (S = I), p < N ? N = p : p > A && (A = p), T < g ? g = T : T > C && (C = T)
                            }), new r(h, S, N, A, g, C, f)),
        ...
        506838: function(e, t, n) {
            ...
            let g = d(T(function(e) {
                ...
                C = e => Object.assign(d(e), {
                    startsWith: t => C(I(e, T(e => N(e) && e.startsWith(t)))),
                    endsWith: t => C(I(e, T(e => N(e) && e.endsWith(t)))),
                    minLength: t => {
                        var n;
                        return C(I(e, (n = t, T(e => N(e) && e.length >= n))))
                    },
                    maxLength: t => {
                        var n;
                        return C(I(e, (n = t, T(e => N(e) && e.length <= n))))
                    },
                    includes: t => C(I(e, T(e => N(e) && e.includes(t)))),
                    regex: t => C(I(e, T(e => N(e) && !!e.match(t))))
                }),
                O = C(T(N)),
            ...
            class S extends a.Component {
                ...
                render() {
                    let {
                        ...
                        inputProps: A,
                        focusAfterReady: g
                    } = this.props, C = null != t && t.length > 0, O = !1, m = [];
                    ...
                    }, t))) : (O = !0, T.forEach((e, t) => m.push((0, o.jsxs)(s.Anchor, {
        ...
        235004: function(e, t, n) {
            ...
            var U = new L(u.default, {
                LOGOUT: function() {
                    T.clear(), h.clear(), C.clear(), O = !1, A = r.NOT_FETCHED, N = r.NOT_FETCHED
                },
                ...
                GUILD_SOUNDBOARD_SOUND_PLAY_START: function(e) {
                    ...
                    let {
                        soundId: r,
                        userId: o
                    } = e, a = (null !== (n = h.get(r)) && void 0 !== n ? n : 0) + 1, l = (null !== (i = C.get(o)) && void 0 !== i ? i : 0) + 1;
                    h.set(r, a), C.set(o, l), o !== (null === (t = d.default.getCurrentUser()) || void 0 === t ? void 0 : t.id) && (O = !0)
                },
                GUILD_SOUNDBOARD_SOUND_PLAY_END: function(e) {
                    ...
                    let {
                        soundId: i,
                        userId: r
                    } = e, o = (null !== (t = h.get(i)) && void 0 !== t ? t : 0) - 1, a = (null !== (n = C.get(r)) && void 0 !== n ? n : 0) - 1;
                    o <= 0 ? h.delete(i) : h.set(i, o), a <= 0 ? C.delete(r) : C.set(r, a)
                },
