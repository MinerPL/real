        ...
        725420: function(e, t, l) {
            ...
            function m(e) {
                let {
                    ...
                    onClose: C,
                    onSave: N
                } = e, y = (0, T.useBroadcastingStoredSelectedTags)(), [L, O] = n.useState(y), [x, b] = n.useState(""), M = c.BroadcastAllowFriends.useSetting(), [w, B] = n.useState(null == M || M), U = c.BroadcastAutoBroadcast.useSetting(), [G, j] = n.useState(U), [P, k] = n.useState(!1), [F, K] = n.useState(!1), V = (0, E.useSelfBroadcast)(), H = (0, g.default)(null == V ? void 0 : V.channelId), z = null != V, W = n.useMemo(() => M !== w || !(0, s.isEqual)(y, L) || U !== G, [M, w, y, L, U, G]), Y = null != N, X = n.useMemo(() => w || Object.keys(L[I.RowType.USER]).length > 0 || Object.keys(L[I.RowType.GUILD]).length > 0, [w, L]), q = !X && z || !X && Y || !W && !Y, Z = n.useMemo(() => "@" === x.trim().charAt(0), [x]), Q = (0, r.useStateFromStoresArray)([S.default], () => S.default.getGuildIds()), J = (0, T.useFilteredGuilds)(Q), $ = n.useMemo(() => J.map(e => e.id), [J]), [ee, et] = (0, T.useBroadcastingPrivacyAudience)(Z, function(e) {
                    var t;
        ...
        355313: function(e, t, l) {
            ...
            function m(e) {
                let {
                    ...
                    maxCount: G,
                    hideRowLabel: j = !1
                } = e, P = n.useRef(null), k = n.useRef(null), F = [C.length, N.length, y.length, L.length], [K, V] = n.useState(!1), [H, z] = n.useState(0), [W, Y] = n.useState(-1);
                n.useEffect(() => {
                    var e;
                        ...
                        renderRow: e => {
                            ...
                            switch (s) {
                                case E.AudienceSelectorSections.ROLES:
                                    c = (n = I(u = C[i])) in l || u.disabled, S = u.disabled || T, g = H === E.AudienceSelectorSections.ROLES && W === i, t = (0, a.jsxs)("div", {
                                        className: _.rowBody,
                                        children: [(0, a.jsx)("div", {
                                ...
                                case E.AudienceSelectorSections.MEMBERS:
                                    c = (n = I(u = N[i])) in l || u.disabled, S = u.disabled || T, g = H === E.AudienceSelectorSections.MEMBERS && W === i, t = (0, a.jsxs)("div", {
                                        className: _.rowBody,
                                ...
                                case E.AudienceSelectorSections.USERS:
                                    c = (n = I(u = y[i])) in l || u.disabled, S = u.disabled || T, g = H === E.AudienceSelectorSections.USERS && W === i, t = (0, a.jsxs)("div", {
                                        className: _.rowBody,
                                        children: [(0, a.jsx)(o.Avatar, {
                                            src: u.avatarURL,
                                            size: o.AvatarSizes.SIZE_24,
                                ...
                                case E.AudienceSelectorSections.GUILDS:
                                    c = (n = I(u = L[i])) in l || u.disabled, S = u.disabled || T, g = H === E.AudienceSelectorSections.GUILDS && W === i, t = (0, a.jsxs)("div", {
                                        className: _.rowBody,
