    ...
    ["44296"], {
            ...
            var i = function() {
                ...
                return i.prototype = {
                    ...
                    quantize: function(u, a) {
                        ...
                        var l, s, c, d, E, _, f, I, h, T, A, N, p, S, O, g, v = (l = u, E = Array(32768), l.forEach(function(n) {
                        ...
                        var D = (_ = u, f = v, A = 1e6, N = 0, p = 1e6, S = 0, O = 1e6, g = 0, _.forEach(function(e) {
                                I = e[0] >> t, h = e[1] >> t, T = e[2] >> t, I < A ? A = I : I > N && (N = I), h < p ? p = h : h > S && (S = h), T < O ? O = T : T > g && (g = T)
                            }), new i(A, N, p, S, O, g, f)),
        ...
        235004: function(t, e, n) {
            ...
            class L extends a.default.Store {
                ...
                hasFetchedAllSounds() {
                    return S === i.FETCHED && p === i.FETCHED
                }
            }
            L.displayName = "SoundboardStore";
            var R = new L(l.default, {
                LOGOUT: function() {
                    T.clear(), A.clear(), g.clear(), v = !1, S = i.NOT_FETCHED, p = i.NOT_FETCHED
                },
                ...
                GUILD_SOUNDBOARD_SOUND_PLAY_START: function(t) {
                    ...
                    let {
                        soundId: i,
                        userId: o
                    } = t, u = (null !== (n = A.get(i)) && void 0 !== n ? n : 0) + 1, a = (null !== (r = g.get(o)) && void 0 !== r ? r : 0) + 1;
                    A.set(i, u), g.set(o, a), o !== (null === (e = d.default.getCurrentUser()) || void 0 === e ? void 0 : e.id) && (v = !0)
                },
                GUILD_SOUNDBOARD_SOUND_PLAY_END: function(t) {
                    ...
                    let {
                        soundId: r,
                        userId: i
                    } = t, o = (null !== (e = A.get(r)) && void 0 !== e ? e : 0) - 1, u = (null !== (n = g.get(i)) && void 0 !== n ? n : 0) - 1;
                    o <= 0 ? A.delete(r) : A.set(r, o), u <= 0 ? g.delete(i) : g.set(i, u)
                },
                ...
                SOUNDBOARD_FETCH_DEFAULT_SOUNDS_SUCCESS: function(t) {
                    ...
                    T.set(f.DEFAULT_SOUND_GUILD_ID, e), p = i.FETCHED
                },
