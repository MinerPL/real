    ...
    ["71314"], {
        ...
        695681: function(e, t, a) {
            ...
            function d(e) {
                ...
                return s.default.patch({
                    url: n.Endpoints.EXPLICIT_MEDIA_SCAN_MULTI_CHANNEL_MESSAGES,
                    body: {
                        messages: t
                    }
                })
        ...
        723653: function(e, t, a) {
            ...
            function h(e) {
                let {
                    ...
                    transitionState: d,
                    onClose: c
                } = e, E = (0, u.useUID)(), A = (0, _.useIsEligibleForExplicitMediaRedaction)(), N = (0, I.useExplicitMediaAttachmentsForMessage)(t, a, i), h = (0, I.useExplicitMediaEmbedsForMessage)(t, a, l), m = n.useCallback(() => {
                ...
                return n.useEffect(() => {
                    ...
                    children: [(0, s.jsxs)(o.ModalContent, {
                        ...
                        }), 1 === N.length && 0 === h.length ? (0, s.jsx)(f, {
                            attachment: N[0]
                        }) : null, 1 === h.length && 0 === N.length ? (0, s.jsx)(S, {
                            embed: h[0]
                        }) : null]
                        ...
                        children: [(0, s.jsx)(o.Button, {
                            ...
                            onClick: () => {
                                O(t, a, N.map(e => e.id), h.map(e => e.id)), (0, M.trackMediaRedactionAction)({
