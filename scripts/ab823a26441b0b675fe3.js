        ...
        189613: function(e, t, l) {
            ...
            class N extends s.PureComponent {
                renderItems() {
                    let {
                        ...
                        return s.map(e => ({
                            ...
                            children: (0, n.jsxs)(_.default, {
                                ...
                                children: [(0, n.jsx)(_.default.Child, {
                    ...
                    }), l = c(t).filter(t => 0 === e.length || i(e.toLowerCase(), t.name.toLowerCase()) || i(e.toLowerCase(), t.translatedName.toLowerCase())).map(e => (0, s.createElement)(f.PopoutList.Item, {
                        ...e,
                        key: e.key,
                        onClick: () => this.onClick(e.countryData)
                    })).value();
                    return 0 === l.length ? (0, n.jsx)(f.PopoutList.Empty, {
                ...
                render() {
                    ...
                    return (0, n.jsxs)(f.PopoutList, {
                        className: u(h.phoneFieldPopout, T.elevationBorderLow, e),
                        children: [(0, n.jsx)(f.PopoutList.SearchBar, {
                            query: this.state.query,
                            placeholder: I.default.Messages.SEARCH_COUNTRY,
                            onChange: this.onChangeQuery,
                            onClear: this.onClearQuery,
                            autoComplete: "off"
                        }), (0, n.jsx)(f.PopoutList.Divider, {}), this.renderItems()]
                    })
                }
                constructor(e) {
