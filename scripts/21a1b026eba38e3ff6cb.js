        ...
        643070: function(e, t, r) {
            ...
            var S = () => {
                let e = (0, a.default)([d.default], () => d.default.getCurrentUser()),
                    ...
                    n = (0, a.default)([l.default], () => l.default.purchases),
                    [S, m] = (0, a.useStateFromStoresArray)([u.default], () => [u.default.categories, u.default.categorySkuIdsByProductSkuId]);
                return (0, s.useMemo)(() => {
                    let e = (0, c.getAvatarDecorationsFromCategories)(S).reduce((e, r) => {
                            let i = n.get(r.skuId),
                            ...
                            let a = S.get(m[r.skuId]);
                            if (!t && (0, c.isPremiumCollectiblesCategory)(a)) {
                        ...
                        s = !!t || !!r || e.purchase.length > 0;
                    return [{
                        section: i.PURCHASE,
                        items: s ? [_, p, ...e.purchase] : [],
                        height: 12,
            ...
            var i = r("414456"),
                ...
                P = function(e) {
                    ...
                    let Y = O.default.Messages.APPLICATION_STORE_GET_PREMIUM,
                        X = null != z ? (0, h.getPremiumPlanItem)(z) : null,
                        q = null != X ? h.default.getPremiumType(X.planId) : null == j ? void 0 : j.premiumType,
                        Z = i === A.PremiumSubscriptionSKUs.TIER_2 && null != q && [A.PremiumTypes.TIER_0, A.PremiumTypes.TIER_1].includes(q);
