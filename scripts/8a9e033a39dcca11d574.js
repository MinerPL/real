    ...
    ["98288"], {
            ...
            class R extends r.PureComponent {
                renderSMSSection() {
                    ...
                    return t ? (0, i.jsxs)(O, {
                        ...
                        children: [(0, i.jsxs)(s.Text, {
                            ...
                            children: r ? A.default.Messages.MFA_SMS_DISABLED_PARTNER : n ? A.default.Messages.MFA_SMS_ALREADY_ENABLED : A.default.Messages.MFA_SMS_ENABLE
                        })]
                    }) : (0, i.jsx)(O, {
                        label: A.default.Messages.MFA_SMS_ENABLE,
                        text: A.default.Messages.MFA_SMS_AUTH_SALES_PITCH,
                        children: (0, i.jsx)(s.Button, {
                            ...
                            size: s.Button.Sizes.SMALL,
                            disabled: r,
                            children: r ? A.default.Messages.MFA_SMS_DISABLED_PARTNER : A.default.Messages.MFA_SMS_ADD_PHONE
                        })
                    })
                }
                ...
                renderTotp() {
                    ...
                    return (0, i.jsxs)(s.ModalRoot, {
                        transitionState: e,
                        className: p.modal,
                        children: [this.renderHeader(A.default.Messages.MFA_SMS_ENABLE_SHOULD_DO.format()), (0, i.jsxs)(s.ModalContent, {
                ...
                renderWebAuthn() {
                    ...
                    return (0, i.jsxs)(s.ModalRoot, {
                        transitionState: e,
                        className: p.modal,
                        children: [this.renderHeader(A.default.Messages.TWO_FA_WEBAUTHN_SHOULD_DO.format()), (0, i.jsx)(s.ModalContent, {
                            className: p.modalInner,
                ...
                (0, l.openModalLazy)(async () => {
                    ...
                    onCloseCallback: () => {
                        !P && u.default.track(c.AnalyticEvents.PAYMENT_FLOW_CANCELED, {
                            ...
                            application_id: g,
                            location_stack: S
                        }), (0, o.clearError)(), (0, a.clearPurchaseTokenAuthState)(), null == I || I(P), P && (!A && d.ComponentDispatch.dispatch(c.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED), null == f || f())
                    },
        ...
        235004: function(e, t, n) {
            ...
            var M = new U(s.default, {
                ...
                OVERLAY_INITIALIZE: function(e) {
                    ...
                    S = new Map(Object.entries(t.soundboardSounds)), p = new Set(t.favoritedSoundIds), h = new Set(t.localSoundboardMutes)
                },
        ...
        364685: function(e, t, n) {
            ...
            var F = new b(a.default, {
                BACKGROUND_SYNC: () => {
                    p = null, A = new Map, m = new Map, h = 0
                },
                CONNECTION_OPEN: e => {
                    let {
                        guilds: t
                    } = e;
                    p = null, A = new Map, m = new Map, t.forEach(y), h = t.every(e => null != e.stickers) ? 1 : 0
                },
                ...
                LOGOUT: () => {
                    h = 0, O = [], A.clear(), C.clear(), p = null, m.clear(), m = new Map(m), L = !1, R = null
                },
            ...
            var i = n("37983"),
                ...
                I = r.forwardRef(function(e, t) {
                    let {
                        ...
                        transitionState: T,
                        reason: f
                    } = e, S = (0, l.useStateFromStores)([d.default], () => d.default.getCurrentUser()), N = (0, l.useStateFromStores)([u.default], () => u.default.getAction()), [h, C] = r.useState(null), [A, p] = r.useState(null), [O, R] = r.useState(null), [L, m] = r.useState(!1), g = r.useCallback(async e => {
                        m(!0);
                        try {
                        ...
                        null != A && (E.default.isPhoneReverification(S, N) ? await s.default.reverifyPhone(A, e, f) : await s.default.addPhone(A, e, f), null == n || n(), I())
                    }, [n, I, A, f, S, N]);
                    return null != A ? (0, i.jsx)(o.default, {
                        onClose: I,
                        transitionState: T,
        ...
        26092: function(e, t, n) {
            ...
            function L(e) {
                ...
                }, C = null !== (i = e.onClose) && void 0 !== i ? i : null, A = null !== (r = e.analyticsLocation) && void 0 !== r ? r : null, p = null !== (l = e.analyticsLocations) && void 0 !== l ? l : [], R = null !== (o = e.impressionSource) && void 0 !== o ? o : null
            }

            function m() {
                u = s.FormStates.CLOSED, S = !1, T = null, O = null, f = null, d = null, c = null, E = {}, _ = {}, C = null, A = null, p = [], R = null
            }
            ...
            var M = new U(o.default, {
                ...
                USER_SETTINGS_MODAL_SET_SECTION: function(e) {
                    var t;
                    d = c, c = e.section, A = null, p = null !== (t = e.analyticsLocations) && void 0 !== t ? t : [], null != e.subsection && (E[c] = e.subsection)
                },
        ...
        181114: function(e, t, n) {
            ...
            let S = e => {
                let {
                    ...
                    onlyShineOnHover: S,
                    ...N
                } = e, h = o.createRef(), C = (0, c.default)(h), A = !i && !a && !0 !== u && (!S || C);
