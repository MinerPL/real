        ...
        846883: function(e, t, a) {
            ...
            function J(e, t) {
                ...
                let ei = (a, i) => {
                    ...
                    el = async e => {
                        ...
                        await u.default.join({
                            ...
                            embedded: (0, F.default)(e, Y.ActivityFlags.EMBEDDED)
                        }), (0, D.default)({
                ...
                return null == K || K.forEach(a => {
                    ...
                    e.type === Y.ActivityTypes.PLAYING && (0, F.default)(e, Y.ActivityFlags.JOIN) ? eu.push((0, i.jsx)(l.MenuItem, {
                        id: "invite-to-join",
                        label: B.default.Messages.USER_ACTIVITY_ACTION_INVITE_TO_JOIN,
                        subtext: e.name,
                        action: () => ei(Y.ActivityActionTypes.JOIN, e)
                    }, "self".concat(t))) : e.type === Y.ActivityTypes.LISTENING && (0, F.default)(e, Y.ActivityFlags.SYNC) && eu.push((0, i.jsx)(l.MenuItem, {
                        id: "invite-to-listen",
                    ...
                    if (a.type === Y.ActivityTypes.PLAYING && (0, F.default)(a, Y.ActivityFlags.JOIN) && null != a.session_id && null != a.application_id) {
                        if (ee[n]) {
                            let e = Q[n];
                    ...
                    } else if (a.type === Y.ActivityTypes.LISTENING && (0, F.default)(a, Y.ActivityFlags.SYNC) && null != et[n]) {
                        let d = et[n],
                            {
                                notPlayable: u,
                                playingSameTrack: s,
