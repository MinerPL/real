    ...
    ["44592"], {
        ...
        776863: function(e, t, s) {
            ...
            function i(e) {
                ...
                return (0, a.useStateFromStoresArray)([l.default, n.default], () => {
                    let e = l.default.getChannels(s)[l.GUILD_VOCAL_CHANNELS_KEY];
                    return e.reduce((e, t) => {
                        let s = t.channel;
                        return s.isGuildStageVoice() ? (function(e) {
                            let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : n.default;
                            return !!e.isGuildStageVoice() && t.can(r.MODERATE_STAGE_CHANNEL_PERMISSIONS, e)
        ...
        844808: function(e, t, s) {
            ...
            function d(e) {
                ...
                } = e, o = r.useMemo(() => (0, n.recurrenceRuleToOption)(t, s), [s, t]), c = function(e) {
                    let t = e.toDate(),
        ...
        953143: function(e, t, s) {
            ...
            function A(e) {
                ...
                let S = null,
                    L = p.startDate,
                    O = l(),
                    j = l().add(E.MAX_DAYS_AHEAD_AN_EVENT_CAN_START, "days"),
                    R = l().add(E.MAX_DAYS_AHEAD_AN_EVENT_CAN_END, "days"),
                    M = e => {
                        r({
                            ...p,
                            endDate: e
            ...
            class d extends a.default.PersistedStore {
                ...
                hasHotspot(e) {
                    let t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                        s = !t && u[e];
                    return !(n.CONFERENCE_MODE_ENABLED || l.ProcessArgs.isDisallowPopupsSet()) && (s || !i.has(e))
                }
                hasHiddenHotspot(e) {
                    return i.has(e)
                }
            ...
            let g = e => {
                ...
                x = e => {
                    let {
                        ...
                        speaker: l,
                        channelId: i
                    } = e, u = (0, r.useStateFromStores)([h.default], () => h.default.isModerator(t.id, i)), f = null;
                    return s && (f = l ? _.default.Messages.STAGE_SPEAKER : u ? _.default.Messages.STAGE_MODERATOR_TOOLTIP : _.default.Messages.STAGE_AUDIENCE), (0, a.jsxs)("div", {
                        className: A.user,
        ...
        823050: function(e, t, s) {
            ...
            var a, r, l = s("37983"),
                ...
                E = s("587974"),
                h = s("989769");
            (a = r || (r = {}))[a.OUTGOING = 0] = "OUTGOING", a[a.INCOMING = 1] = "INCOMING";
            class f extends n.PureComponent {
                ...
                renderVoiceCallAvatar() {
                    let {
                        ...
                        size: c,
                        renderIcon: f
                    } = this.props, _ = (0, d.getAvatarSize)(c), A = (0, l.jsx)("img", {
                        src: e,
                        alt: " ",
                        className: u(h.voiceAvatar, n, {
                            [h.ringingOutgoing]: s && a === r.OUTGOING
                        })
                    });
                    if (t) return A;
                    let g = E.MaskIDs.AVATAR_DEFAULT;
                    return null != f ? g = c === d.AvatarSizes.SIZE_32 ? E.MaskIDs.AVATAR_CALL_ICON_32 : E.MaskIDs.AVATAR_CALL_ICON : (i || o) && (g = E.MaskIDs.AVATAR_VOICE_CALL_80), (0, l.jsxs)("div", {
                ...
                render() {
                    let {
                        ...
                        [h.clickable]: null != t,
                        [h.ringingOutgoing]: o && i === r.OUTGOING,
                        [h.ringingIncoming]: o && i === r.INCOMING
                    }, n), E = (0, d.getAvatarSize)(e), f = {
                        height: E,
                        width: E,
                        ...s
                    };
