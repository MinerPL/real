        ...
        610903: function(e, t, s) {
            ...
            var _ = e => {
                let {
                    ...
                    onPrevPressed: T,
                    onComplete: I,
                    sequencerClassName: A,
                    initialStep: f = 0,
                    forceStep: m,
                    submitting: O = !1,
                    autoCloseOnComplete: L = !0
                } = e, [C, R] = n.useState([]), [g, p] = n.useState(f), D = (0, o.useUID)();
                n.useEffect(() => {
                    ...
                    children: [(0, i.jsxs)("div", {
                        ...
                        children: [(0, i.jsxs)(r.ModalContent, {
                            ...
                            children: [(0, i.jsx)(r.Button, {
                                ...
                                children: h ? v : E.default.Messages.NEXT
        ...
        79536: function(e, t, s) {
            ...
            let V = e => {
                    let {
                        ...
                        headerId: r,
                        theme: E
                    } = e, _ = (0, o.useStateFromStores)([O.default], () => O.default.getGuild(t.id), [t.id]), c = null != _ && _.verificationLevel > h.VerificationLevels.NONE, S = (null == _ ? void 0 : _.explicitContentFilter) === h.GuildExplicitContentFilterTypes.ALL_MEMBERS, N = (0, u.isThemeDark)(E) ? y : Y;
                    return (0, i.jsxs)("div", {
                        ...
                        children: [(0, i.jsxs)("div", {
                            ...
                            children: [(0, i.jsx)(d.FormTitle, {
                                ...
                                disabled: l,
                                value: t.verificationLevel > h.VerificationLevels.NONE,
                                onChange: s,
                            ...
                            children: [(0, i.jsx)(d.FormTitle, {
                                ...
                                type: d.Checkbox.Types.ROW,
                                disabled: a,
                                value: t.explicitContentFilter === h.GuildExplicitContentFilterTypes.ALL_MEMBERS,
                                onChange: n,
                                children: (0, i.jsx)(d.Text, {
                                    variant: "text-sm/normal",
                ...
                w = e => {
                    ...
                    let I = (0, S.default)(null == t ? void 0 : t.id);
                    return (0, i.jsxs)("div", {
                        className: G.container,
                        children: [(0, i.jsxs)("div", {
                            className: G.content,
                            ...
                            children: (0, i.jsx)(d.Tooltip, {
                                ...
                                children: e => (0, i.jsx)("div", {
                                    ...
                                    children: (0, i.jsx)(d.Checkbox, {
                                        type: d.Checkbox.Types.ROW,
                                        disabled: _,
                                        value: t.defaultMessageNotifications === h.UserNotificationSettings.ONLY_MENTIONS,
                                        onChange: o,
                                        className: l({
                                            [G.disabled]: _
                                        }),
            ...
            let Q = e => {
                let {
                    ...
                    headerId: l,
                    theme: r
                } = e, o = (0, u.isThemeDark)(r) ? j : F, _ = (0, S.default)(null == t ? void 0 : t.id);
                n.useEffect(() => {
                    (0, U.trackEnableCommunityFlow)({
                        fromStep: x.EnableCommunityModalSteps.BASICS,
                        toStep: x.EnableCommunityModalSteps.FINISH,
            ...
            var z = e => {
                ...
                let {
                    guild: l
                } = (0, o.useStateFromStoresObject)([T.default], () => T.default.getProps()), E = (0, o.useStateFromStores)([f.default], () => f.default.theme), [u, d] = n.useState(!1), [S, A] = n.useState(!x.MODERATOR_PERMISSIONS.some(e => P.default.canEveryone(e, l))), [O, g] = n.useState(x.CREATE_NEW_CHANNEL_VALUE), [p, U] = n.useState(x.CREATE_NEW_CHANNEL_VALUE), [B] = n.useState(null == l ? void 0 : l.defaultMessageNotifications), [b] = n.useState(null == l ? void 0 : l.verificationLevel), [j] = n.useState(null == l ? void 0 : l.explicitContentFilter), [F] = n.useState(S), y = null == l ? void 0 : l.getRole(null == l ? void 0 : l.id), Y = (0, o.useStateFromStores)([m.default], () => null != l ? m.default.getChannels(l.id) : null, [l]), K = (0, R.useUID)(), {
                    enabled: W
                ...
                Y[0, m.GUILD_SELECTABLE_CHANNELS_KEY].forEach(e => {
                    ...
                    t.type === h.ChannelTypes.GUILD_TEXT && X.push({
                        value: t.id,
                        label: (0, c.computeChannelName)(t, C.default, L.default, !0)
                    })
                });
                let q = b !== h.VerificationLevels.NONE,
                    z = j === h.GuildExplicitContentFilterTypes.ALL_MEMBERS,
                    J = B === h.UserNotificationSettings.ONLY_MENTIONS,
                    Z = async () => {
                        if (null == y || !u) return;
                        let e = new Set(l.features);
                        e.add(h.GuildFeatures.COMMUNITY);
                        let t = S ? r.default.remove(y.permissions, x.MODERATOR_PERMISSIONS_FLAG) : y.permissions,
                            s = {
                                ...y,
                                permissions: t
                            };
                        t !== y.permissions && await (0, M.saveRoleSettings)(l.id, [s]), N.default.updateGuild({
                            features: e,
                            rulesChannelId: O,
                        ...
                        onAcceptVerificationLevel: (e, t) => {
                            ...
                            t && N.default.updateGuild({
                                verificationLevel: h.VerificationLevels.LOW
                            })
                        },
                        onAcceptContentFilter: (e, t) => {
                            ...
                            N.default.updateGuild({
                                explicitContentFilter: h.GuildExplicitContentFilterTypes.ALL_MEMBERS
                            })
                        },
                        headerId: K,
                        theme: E
                        ...
                        onAcceptPolicy: (e, t) => {
                            if (t) {
                                d(!0), !J && N.default.updateGuild({
                                    defaultMessageNotifications: h.UserNotificationSettings.ONLY_MENTIONS
                                }), !S && null != y && A(!0);
                                return
                            }
                            d(!1), J && N.default.updateGuild({
                        ...
                        modalContent: $,
                        disableNextStep: l.explicitContentFilter !== h.GuildExplicitContentFilterTypes.ALL_MEMBERS || l.verificationLevel === h.VerificationLevels.NONE,
                ...
                return (0, i.jsx)(I.default, {
                    ...
                    transitionState: s,
                    onClose: () => {
                        a(), D.default.track(h.AnalyticEvents.MODAL_DISMISSED, {
                            type: x.ENABLE_COMMUNITY_FLOW_MODAL_KEY
                        })
                    },
