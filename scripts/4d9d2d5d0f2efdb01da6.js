    ...
    ["23256"], {
        ...
        752598: function(e, t, n) {
            ...
            let h = (e, t) => {
                ...
                let u = e.state === T.MessageStates.SEND_FAILED && (null == (n = e.id) || "" === n || Number.isNaN(n) ? Date.now() : a.default.extractTimestamp(n) + 3e3) < Date.now(),
                    ...
                    c = e.isCommandType();
                if (s && r === E.InteractionState.QUEUED || c && e.state === T.MessageStates.SENDING && null != t) return i.SENDING;
                if (s && r === E.InteractionState.CREATED || e.hasFlag(T.MessageFlags.LOADING) && !l) return i.CREATED;
                if (null != e.interaction && e.hasFlag(T.MessageFlags.LOADING) && l) return i.TIMED_OUT;
                else if (null != e.interaction && !e.hasFlag(T.MessageFlags.LOADING) && u) return i.TIMED_OUT;
                else if (c && e.state === T.MessageStates.SEND_FAILED) return i.FAILED
            };
        ...
        671672: function(e, t, n) {
            ...
            function h(e) {
                ...
                if (a) {
                    if (M) t = (0, r.jsx)(f.BenefitsConfirmationLite, {
                    ...
                    else t = (0, r.jsx)(d.BenefitsConfirmation, {
                        listing: m,
                        application: h,
                ...
                } else t = M ? (0, r.jsx)(f.PurchaseConfirmationLite, {
                    listing: m,
                    onConfirm: U,
                    subscription: R
        ...
        252438: function(e, t, n) {
            ...
            }), (i = r || (r = {}))[i.INTANGIBLE = 1] = "INTANGIBLE", i[i.APPLICATION_PREMIUM_COMMAND = 2] = "APPLICATION_PREMIUM_COMMAND"
        }
    }
]);