        ...
        998730: function(e, t, n) {
            ...
            let _ = e => {
                ...
                return (0, l.jsx)(o.FormItem, {
                    ...
                    children: (0, l.jsx)(o.SearchableSelect, {
                        ...
                        options: s.map(e => ({
                            value: e.id,
                            label: (0, a.computeChannelName)(e, d.default, c.default, !0)
                        })),
                        onChange: e => {
            ...
            function N(e) {
                let {
                    ...
                    onClose: d,
                    transitionState: N
                } = e, T = (0, A.useUID)(), [I, O] = r.useState(t.metadata.channelId), [h, E] = r.useState(null), M = (0, u.useStateFromStores)([s.default], () => s.default.getChannel(I), [I]), S = (0, L.getActionInfo)(t.type, t, n);
