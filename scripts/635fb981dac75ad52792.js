    ...
    ["81141"], {
        ...
        686298: function(e, t, n) {
            ...
            let N = [T(a.RESOLUTION_720), T(a.RESOLUTION_1080), T(a.RESOLUTION_1440), T(a.RESOLUTION_SOURCE, () => _.default.Messages.SCREENSHARE_SOURCE)],
                ...
                f = [T(s.FPS_15), T(s.FPS_30), T(s.FPS_60)],
                R = [T(s.FPS_15, () => _.default.Messages.STREAM_FPS_OPTION.format({
                    value: s.FPS_15
                })), T(s.FPS_30, () => _.default.Messages.STREAM_FPS_OPTION.format({
                    value: s.FPS_30
                })), T(s.FPS_60, () => _.default.Messages.STREAM_FPS_OPTION.format({
                    value: s.FPS_60
                }))]
        },
            ...
            function R(e) {
                ...
                return (0, i.jsxs)(l.Elements, {
                    ...
                    children: [U, (0, i.jsxs)("div", {
                        className: s("paymentModalContent", L.content),
            ...
            var v = new g(u.default, {
                ...
                GUILD_SOUNDBOARD_SOUND_PLAY_START: function(e) {
                    ...
                    let {
                        soundId: r,
                        userId: l
                    } = e, a = (null !== (n = O.get(r)) && void 0 !== n ? n : 0) + 1, s = (null !== (i = U.get(l)) && void 0 !== i ? i : 0) + 1;
                    O.set(r, a), U.set(l, s), l !== (null === (t = _.default.getCurrentUser()) || void 0 === t ? void 0 : t.id) && (D = !0)
                },
