        ...
        359113: function(e, t, s) {
            ...
            function C(e) {
                let {
                    onClose: t,
                    transitionState: s
                } = e, [n, c] = r.useState(""), [I, C] = r.useState(""), [R, p] = r.useState(null), [O, v] = r.useState(!1), [M, g] = r.useState(l.DOMAIN), T = () => {
                    v(!0), p(null), a.default.post({
                        ...
                        var t, s, n, o, r, a, i;
                        (null === (t = e.body) || void 0 === t ? void 0 : t.proof) && M === l.DOMAIN ? (C(e.body.proof), g(l.PROOF_DNS)) : p((null === (a = e.body) || void 0 === a ? void 0 : null === (r = a.errors) || void 0 === r ? void 0 : null === (o = r.domain) || void 0 === o ? void 0 : null === (n = o._errors) || void 0 === n ? void 0 : null === (s = n[0]) || void 0 === s ? void 0 : s.message) || (null === (i = e.body) || void 0 === i ? void 0 : i.message) || e.message)
                    }).finally(() => {
                        v(!1)
                    })
                };
