    ...
    ["21675"], {
        ...
        578411: function(e, t, n) {
            ...
            let O = e => {
                ...
                }), v = (0, N.useUID)(), b = (0, i.default)([M.default], () => null != M.default.getPackByPackId({
                    packId: t.id,
                    allowDuplicateGuildPack: !0
                })), R = x && !b, [D, y] = s.useState(!1), j = async () => {
        ...
        374705: function(e, t, n) {
            ...
            function v(e) {
                let {
                    ...
                    onSelect: s,
                    hideSettings: r
                } = e, o = t.id, v = S.default.getDefaultChannel(o), b = (0, E.useExpressionSourceGuildDataForGuildLeaveModal)(t), R = (0, u.useStateFromStores)([g.default], () => {
                    ...
                    channel: v
                }), y = (0, O.default)(o), j = (0, p.default)(t), U = (0, L.default)(t), P = (0, T.default)(t), H = (0, N.default)({
                    guildId: t.id,
                ...
                }), F = (0, h.default)(t), k = (0, f.default)(t.id), V = (0, c.default)({
                    id: t.id,
                    label: G.default.Messages.COPY_ID_GUILD
                }), B = (0, m.default)(t, {
                    section: x.AnalyticsSections.GUILD_LIST
                }), w = (0, _.default)(t.id), Y = (0, A.default)(t), K = t.hasFeature(x.GuildFeatures.HUB);
                ...
                return K ? (0, a.jsxs)(i.Menu, {
                    ...
                    children: [(0, a.jsx)(i.MenuGroup, {
                        ...
                        children: [j, __OVERLAY__ ? null : U, y, w]
                    }), (0, a.jsxs)(i.MenuGroup, {
        ...
        230947: function(e, t, n) {
            ...
            function I(e) {
                ...
                let x = A === M.AppContext.POPOUT,
                    G = (0, d.default)({
                        guild: p,
                        analyticsLocation: N
                    });
                if (null == p || x) return null;
                let v = L === I && (E.default.can(M.Permissions.CHANGE_NICKNAME, p) || E.default.can(M.Permissions.MANAGE_NICKNAMES, p)),
                    b = L === I,
                    R = E.default.canManageUser(M.Permissions.MANAGE_NICKNAMES, I, p);
                if (!(v || R || b) || null == T || O) return null;
                let D = p.hasFeature(M.GuildFeatures.HUB),
                    y = D ? S.default.Messages.HUB_EDIT_PROFILE : S.default.Messages.CHANGE_IDENTITY,
                    j = b ? y : S.default.Messages.CHANGE_NICKNAME;
        ...
        527660: function(e, t, n) {
            ...
            function g(e) {
                ...
                let I = function(e) {
                        ...
                        }), [e.id]), A = N === E.HighlightSettings.DISABLED, m = (0, d.default)(e.id), p = (0, o.useGuildUnreadsExperiment)();
                        ...
                        return (0, a.jsxs)(a.Fragment, {
                            children: [(0, a.jsx)(u.MenuGroup, {
                                ...
                                children: [p && (0, a.jsx)(u.MenuCheckboxItem, {
                                    ...
                                    action: () => {
                                        (0, r.setGuildUnreadSetting)(e.id, !h)
                                    },
                                    checked: h
                    ...
                    N = (0, s.useStateFromStores)([c.default], () => c.default.getMessageNotifications(e.id), [e.id]),
                    h = null === (g = S()) || void 0 === g ? void 0 : null === (t = g.find(e => {
                        let {
                            setting: t
                        } = e;
                        return t === N
