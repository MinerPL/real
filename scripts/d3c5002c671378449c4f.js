    ...
    ["16849"], {
        ...
        490080: function(e, t, l) {
            ...
            function D(e) {
                ...
                let {
                    ...
                    guildId: o,
                    large: u = !1
                } = e, h = null !== (t = null == n ? void 0 : n.connections) && void 0 !== t ? t : [], p = (0, r.useStateFromStoresArray)([f.default], () => Array.from(h).map(e => {
                    let [t] = e;
                    return f.default.getUser(t)
                }).filter(m.isNotNullish)), T = I.default.getName(o, null == d ? void 0 : d.id, null == p ? void 0 : p[0]);
                if (T = (0, E.truncateText)(T, 15), null == n || 0 === p.length) {
                ...
                return (0, a.jsxs)("div", {
                    ...
                    children: [(0, a.jsx)(c.Text, {
                        ...
                        variant: "text-xs/normal",
                        children: p.length > 1 ? A.default.Messages.EMBEDDED_ACTIVITIES_USERNAME_AND_OTHERS.format({
                            username: T,
                            count: p.length - 1
            ...
            function y(e) {
                ...
                return (0, a.jsxs)(c.Clickable, {
                    onClick: M === p.ActivityAction.START ? V : void 0,
                    onContextMenu: G ? e => {
                    ...
                    className: s(_.activityItem, {
                        [_.large]: !0 === E,
                        [_.disabled]: M !== p.ActivityAction.START
                    }),
                    children: [(0, a.jsxs)("div", {
                        ...
                        }), null != y && k && M === p.ActivityAction.START ? (0, a.jsx)("div", {
                        ...
                        }) : null, M !== p.ActivityAction.START ? (0, a.jsx)(T.ActivityActionOverlayButton, {
                            action: M,
                            onClick: V
                        }) : null, (0, a.jsx)("div", {
        ...
        62276: function(e, t, l) {
            ...
            function b(e) {
                ...
                }).map(e => f.default.getUser(e)).filter(x.isNotNullish), [t.application.id]), Z = null != z[0] ? (0, T.truncateText)(p.default.getName(null, null, z[0]), 25) : null, K = null;
        ...
        605455: function(e, t, l) {
            ...
            function U(e) {
                let {
                    ...
                    width: z
                } = (0, E.useScreenDimensions)(), Z = i.useMemo(() => W ? Math.max(k, Math.min(z - 2 * F, P)) : w, [z, W]), K = (0, c.useStateFromStores)([_.default], () => _.default.getIsEnabled(), []), {
                    AnalyticsLocationProvider: X
                } = (0, m.default)(Y), [q, J] = i.useState(p), Q = (0, u.default)(q), [$, ee] = i.useState(null), [et, el] = i.useState(f), [ea, ei] = i.useState(void 0), [en] = (0, I.default)(null == et ? [] : [et]), es = i.useRef(null), er = i.useMemo(() => ({
                    application_id: et,
            ...
            let G = e => {
                let {
                    children: t,
                    slide: l
                } = e, n = (0, c.useStateFromStores)([_.default], () => _.default.getIsEnabled(), []), r = i.useContext(f.default), d = (0, c.useStateFromStores)([p.default], () => p.default.windowSize(r.windowId).height, [r.windowId]);
                return (0, a.jsx)("div", {
        ...
        623611: function(e, t, l) {
            ...
            function M(e) {
                ...
                let C = null != p.activity.activity_preview_video_asset_id ? (0, T.default)(l, p.activity.activity_preview_video_asset_id) : null,
            ...
            function L(e) {
                ...
                } = (0, c.default)(), E = (0, C.default)(), [T, j] = i.useState(null !== (t = (0, x.getActivityGuildSuggestion)({
                    allowGdmActivityChannelSuggestion: !0
                })) && void 0 !== t ? t : void 0), [M, L] = i.useState(null !== (r = (0, p.getActivityVoiceChannelSuggestion)({
                    guildId: T,
                    allowGdmActivityChannelSuggestion: !0
                })) && void 0 !== r ? r : void 0), V = (0, n.default)([d.default], () => d.default.getChannel(M), [M]), b = (0, x.useSelectGuildOptions)(), R = (0, p.useSelectVoiceChannelOptions)(T), O = i.useCallback(() => {
                    null != M && (0, I.default)({
                        activityItem: o,
                        currentActivity: E,
                        channelId: M,
