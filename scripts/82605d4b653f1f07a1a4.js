    ...
    ["86514"], {
                        ...
                        children: (0, a.jsxs)("div", {
                            ...
                            children: [(0, a.jsxs)("div", {
                                ...
                                children: [(0, a.jsxs)(i.Heading, {
                                    ...
                                    color: "always-white",
                                    children: [A && !v ? (0, a.jsx)(c.default, {
                                        className: S.premiumIcon
                                    }) : null, v ? (0, a.jsxs)(i.Text, {
                                        color: "always-white",
                                        variant: "eyebrow",
                                ...
                                children: null != h ? (0, a.jsxs)(a.Fragment, {
                                    children: [(0, a.jsx)(i.Button, {
                                        ...
                                        size: j,
                                        onClick: e => {
                                            null == g || g(e), h(e), G(f.ContentDismissActionType.PRIMARY)
                                        },
                                        color: A || v ? i.Button.Colors.BRAND : i.Button.Colors.WHITE,
                                        look: A || v ? i.Button.Looks.INVERTED : i.Button.Looks.FILLED,
                                        ...
                                        color: A || v ? i.Button.Colors.WHITE : i.Button.Colors.BRAND,
                                        look: A || v ? i.Button.Looks.LINK : i.Button.Looks.FILLED,
        ...
        75974: function(e, t, l) {
            ...
            function _(e) {
                ...
                } = e, _ = (0, f.default)(), N = (0, u.useStateFromStores)([d.default], () => d.default.getInputDevices()), [h, g] = n.useState(function(e, t, l) {
                    if (null != t && null != l) {
                ...
                return null != h && r(h), (0, a.jsx)(n.Fragment, {
        ...
        359812: function(e, t, l) {
            ...
            function C(e) {
                ...
                } = e, _ = (0, n.useStateFromStores)([o.default], () => o.default.getCurrentUser()), N = (0, n.useStateFromStores)([i.default, r.default, u.default], () => (0, c.getStreamEligibleChannels)(r.default.getChannels(l), i.default, u.default)), h = (0, n.useStateFromStores)([d.default], () => d.default.getVoiceStates(l)), g = N.map(e => {
                    var l;
                    return {
        ...
        636909: function(e, t, l) {
            ...
            function Y(e) {
                ...
                let m = (0, w.default)(r, t, d),
                    ...
                    E = null != t && t.id.startsWith("screen") ? O.default : v.default;
            ...
            function Z(e) {
                let {
                    ...
                    onChangeGuild: v,
                    isAnimationDone: M
                } = e, j = (0, i.useStateFromStores)([I.default, E.default], () => E.default.getChannel(I.default.getVoiceChannelId())), D = (0, i.useStateFromStores)([P.default], () => P.default.GPUDriversOutdated), b = (0, i.useStateFromStores)([h.default], () => h.default.getSoundshareEnabled()), y = (0, i.useStateFromStores)([p.default], () => p.default.getCurrentUser()), w = (0, c.useEnableClips)(), V = (0, c.useShouldSeeClipsPremiumEarlyAccessGoLiveRoadblock)({
                    autoTrackExposure: !w
                }), z = (0, U.default)();
                null != t && t.id.startsWith("screen") ? z = W.default.Messages.GO_LIVE_SCREENSHARE_NO_SOUND : null == z && h.default.supportsEnableSoundshare() && b !== H.SoundshareEnableState.ENABLED && (z = W.default.Messages.GO_LIVE_SCREENSHARE_ENABLE_FOR_SOUNDSHARE.format({
        ...
        451863: function(e, t, l) {
            ...
            function H(e) {
                ...
                let {
                    ...
                    resolution: Z,
                    fps: q
                } = (0, d.useStateFromStoresObject)([_.default], () => _.default.getState()), $ = (0, d.useStateFromStores)([A.default, N.default], () => N.default.getChannel(A.default.getVoiceChannelId())), ee = (0, d.useStateFromStores)([p.default, R.default], () => (0, v.isWindows)() ? (0, P.default)(p.default, R.default) : null), et = (0, d.useStateFromStores)([x.default], () => {
                ...
                let es = (0, O.useUID)();
                let [er, ei] = r.useState((i = W, H = z, i ? n.GUILD : H ? n.SOURCE : n.CONFIRM)), [eu, eo] = r.useState(null), [ed, ec] = r.useState(!1), [ef, em] = r.useState(null), [eS, eE] = r.useState(null), [eC, e_] = r.useState(null), [eN, eh] = r.useState(Q), [eg, eI] = r.useState(Z), [ep, eA] = r.useState(q), [ex, eR] = r.useState(null != K ? K : null), eT = null !== (a = null == $ ? void 0 : $.id) && void 0 !== a ? a : ef;
                r.useEffect(() => {
                    let e = (0, v.isWindows)() ? (0, P.default)(p.default, R.default) : null,
                        t = (null == e ? void 0 : e.id) != null ? h.default.getGame(e.id) : null;
                ...
                function eO() {
                    ! function() {
                        ...
                        let o = (0, F.default)(ee, eS, p.default.getRunningGames()),
                            d = !(0, v.isWindows)() || null == o || (null == eS ? void 0 : eS.id.startsWith("camera:")),
                ...
                let eL = r.useCallback((e, t, l) => {
                    ...
                    l !== ep && eA(l), t !== eg && eI(t), n !== t || s !== l ? eh(k.ApplicationStreamPresets.PRESET_CUSTOM) : e !== eN && eh(e)
                }, [et, el, ep, eg, eN]);
                async function ev(e) {
                        ...
                        children: [(0, s.jsx)(c.Slide, {
                            ...
                            children: (0, s.jsx)("div", {
                                ...
                                children: (0, s.jsx)(b.default, {
                                    ...
                                    sourceChanged: ed,
                                    selectSource: z,
                                    onChangeSelectedFPS: e => eL(eN, eg, e),
                                    onChangeSelectedResolution: e => eL(eN, e, ep),
                                    onChangeSelectedPreset: e => eL(e, eg, ep),
        ...
        23922: function(e, t, l) {
                ...
                let e = m.default.getVideoDevices(),
                    ...
                    r = function(e, t) {
                        ...
                        return t.forEach(e => {
                            ...
                            l[e.id] = e
                        }), Object.values(l).sort((e, t) => v(t) - v(e))
            ...
            function M(e) {
                ...
                }), i = m.default.supports(x.Features.GO_LIVE_HARDWARE), [o, f] = n.useState(null), [S, E] = n.useState(null), [N, g] = n.useState(null), I = null != N && N.length > 0, [L, v] = n.useState(u.DesktopSources.WINDOW), [M, j] = n.useState(!1), D = n.useRef(null), P = n.useRef(new d.Interval);
                n.useEffect(() => {
                    let e = P.current;
                    return O().then(e => {
                        let {
        ...
        985997: function(e, t, l) {
            ...
            function D(e) {
                ...
                }), U = h.default.isPremiumExactly(b, x.PremiumTypes.TIER_0), G = h.default.isPremium(b), F = (0, u.useStateFromStores)([S.default], () => {
                    var e;
