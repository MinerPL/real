        ...
        572579: function(e, t, n) {
            ...
            function W(e) {
                let {
                    platformType: t,
                    className: n
                } = e, l = (0, A.default)(), a = m.default.get(t);
                return (0, o.jsx)("img", {
            ...
            function J(e) {
                ...
                if (null != c) switch (a) {
                    ...
                    if (null == (r = (0, w.getConnectionsCheckText)({
                            connectionType: n,
                            connectionMetadataField: l,
                            operator: a,
                            operatorText: e,
            ...
            function $(e) {
                ...
                } = e, [a, i] = s.useState({}), [r, d] = s.useState(0), [N, _] = s.useState(null), [O, f] = s.useState(null), h = s.useMemo(() => C.flatten(t), [t]), A = s.useMemo(() => C.groupBy(h, e => "".concat(e.connection_type).concat(null != e.application_id ? ":".concat(e.application_id) : "")), [h]);
                s.useEffect(() => d(Date.now()), [h]), s.useEffect(() => {
                    if (null == N) return;
                    let e = A["".concat(N).concat(null != O ? ":".concat(O.id) : "")];
                    if (null == e) return;
                ...
                return (0, o.jsx)(o.Fragment, {
                    children: Object.keys(A).sort((e, t) => {
                        let n = A[e].every(e => e.result),
                            l = A[t].every(e => e.result);
                        ...
                        let O = A[e],
                            ...
                            U = (null == v ? void 0 : v.bot) != null ? new L.default(v.bot) : null,
                            D = w.officialApplicationIds.includes(null !== (t = null == v ? void 0 : v.id) && void 0 !== t ? t : "");
                        D ? C = (0, o.jsx)(H.default, {
                            className: X.botTag,
                            color: p,
                            size: 16
                        ...
                        let g = a[null !== (l = null == R ? void 0 : R.type) && void 0 !== l ? l : Q.GUILD_ROLE_CONNECTION_APPLICATION_CONNECTION_TYPE],
                            y = !M && null != g && g <= r;
                        return N = M ? (0, o.jsx)(b.default, {
                        ...
                        }), (null == R ? void 0 : R.type) === z.PlatformTypes.STEAM && (E = q.default.Messages.CONNECTIONS_STEAM_TOOLTIP), (0, o.jsxs)(T.Clickable, {
                            ...
                            })(null !== (s = null == R ? void 0 : R.type) && void 0 !== s ? s : Q.GUILD_ROLE_CONNECTION_APPLICATION_CONNECTION_TYPE, v),
                            children: [!M && y ? (0, o.jsx)("div", {
                                ...
                                children: [(0, o.jsxs)("div", {
                                    ...
                                    children: [(0, o.jsx)(T.Text, {
                                        ...
                                        children: null !== (d = null == R ? void 0 : R.name) && void 0 !== d ? d : null == v ? void 0 : v.name
            ...
            function et(e) {
                let {
                    ...
                    guildId: l,
                    role: i
                } = e, [c, r] = s.useState(a.CHECKS_REQUIRED), [d, C] = s.useState(null), [E, _] = s.useState(!1), [O, S] = s.useState(!0), [M, L] = s.useState(!1), [j, G] = s.useState(!0), [b, P] = s.useState(!1), w = (0, N.useStateFromStores)([D.default], () => D.default.getAccounts()), H = (0, N.useStateFromStores)([v.default], () => v.default.getId()), [Y, Q] = s.useState(null), [W, J] = s.useState(null), [et, en] = s.useState(null), el = (0, A.default)(), ea = (0, N.useStateFromStores)([R.default], () => R.default.locale), eo = (0, N.useStateFromStores)([g.default], () => g.default.getMember(l, H)), es = (0, N.useStateFromStores)([U.default], () => U.default.getMutableGuildChannelsForGuild(l)), ei = Object.values(es).filter(e => y.default.can(z.Permissions.VIEW_CHANNEL, e) && y.default.can(z.Permissions.SEND_MESSAGES, e) && (0, I.default)(e).includes(i));
                ...
                async function ed() {
                    L(!0), await f.default.assignGuildRoleConnection(l, i.id)
                }
                ...
                function eN(e) {
                    ...
                    Q(e), J(t), r(a.ACCOUNT_CONNECTED), null != t && (0, B.fetchUserApplicationRoleConnections)().then(e => {
                        en(e)
                    }).catch(() => {})
                }
                return s.useEffect(() => {
                    ...
                    if (M && null != eo && eo.roles.includes(i.id)) {
                        if (L(!1), ei.length > 0) r(a.ROLE_GRANTED);
                        else null == n || n();
                    ...
                    children: [function() {
                        switch (c) {
                            ...
                            case a.ACCOUNT_CONNECTED: {
                                ...
                                let n = null !== (t = null == W ? void 0 : W.name) && void 0 !== t ? t : null === (e = m.default.get(Y)) || void 0 === e ? void 0 : e.name;
                                return (0, o.jsxs)(T.ModalHeader, {
                                    className: X.header,
                                    separator: !1,
                                    children: [(0, o.jsx)(T.Heading, {
                                ...
                                case a.ACCOUNT_CONNECTED: {
                                    ...
                                    let e = w.find(e => {
                                        ...
                                        t = null == et ? void 0 : et.find(e => {
                                            ...
                                            return t.id === (null == W ? void 0 : W.id)
                                        });
