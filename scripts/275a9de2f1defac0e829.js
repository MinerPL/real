    ...
    ["64431"], {
            ...
            class P extends i.PureComponent {
                ...
                render() {
                    ...
                    if (i) {
                        ...
                        return this.getMode() === a.LOGIN ? (0, l.jsx)(R.default, {
                            giftCodeSKU: t,
                            giftCode: s,
                            transitionTo: u,
                            location: o
                    ...
                    switch (e.state) {
                        ...
                        case R.GuildTemplateStates.RESOLVED:
                            ...
                            if (this.props.login) return (0, s.jsx)(S.default, {
                                ...
                                location: l,
                                onRegister: () => {
                                    (0, p.setNewUser)(O.NewUserTypes.ORGANIC_REGISTERED_GUILD_TEMPLATE), N.default.flowStart(L.FlowType.ORGANIC_GUILD_TEMPLATES, L.RegistrationSteps.NUF_STARTED)
                                }
                            });
                ...
                render() {
                    ...
                    switch (e.state) {
                        ...
                        case G.InviteStates.RESOLVED:
                            var i;
                            if (n && (0, O.hasFlag)(null !== (i = e.flags) && void 0 !== i ? i : 0, r.GuildInviteFlags.IS_GUEST_INVITE)) return c.default.openApp(e.code), d.default.set(N.GUEST_INVITE_KEY, e.code), this.renderAppOpened(() => a(G.Routes.APP));
        ...
        759315: function(e, t, n) {
            ...
            var s = n("37983"),
                ...
                h = n("926622"),
                N = () => {
                    let [e, t] = a.useState(""), [l, N] = a.useState(""), [T, m] = a.useState(!1), [g, A] = a.useState(!1), [S, C] = a.useState(null), [v, x] = a.useState(null), R = (0, r.useStateFromStores)([d.default], () => d.default.getCountryCode()), O = R.code.split(" ")[0], L = async () => {
                        try {
        ...
        701662: function(e, t, n) {
            ...
            function j(e) {
                let {
                    ...
                    [a.DETAILS]: R.inviteCardInner,
                    [a.ERROR]: R.inviteCardInnerError,
                    [a.LOADING]: R.inviteCardInnerLoading
                };
                return (0, l.jsx)(D, {
        ...
        954419: function(e, t, n) {
            ...
            class _ extends i.Component {
                ...
                render() {
                    ...
                    null != i && (R.Option = e => (0, l.jsx)(o.components.Option, {
                        ...e,
                        children: i(e.data)
                    })), null != a && (R.SingleValue = e => (0, l.jsx)(o.components.SingleValue, {
                        ...e,
                        children: a(e.data)
