            ...
            var i = n("37983"),
                ...
                p = e => {
                    ...
                    l.useEffect(() => {
                        ...
                        j && h && _.default.track(T.AnalyticEvents.OPEN_MODAL, {
                    ...
                    let Y = () => {
                        ...
                        X = l.useCallback(() => {
                            ...
                            y({
                                width: n,
                                height: i
                            }), S(l), U((0, c.calculateDragBoundaries)(n, i, l))
                        }, [L, v]),
                        Z = l.useCallback(e => {
                            let {
                                x: t,
                                    ...
                                    children: [(0, i.jsx)(E.default, {
                                        ...
                                        asValueChanges: e => {
                                            ...
                                            let {
                                                width: t,
                                                height: n
                                            } = H, i = (0, c.calculateDragBoundaries)(t * e, n * e, M), {
                                                x: l,
                                                y: a
                                            } = F.current;
            ...
            var l = n("414456"),
                ...
                f = function(e) {
                    let {
                        ...
                        if (null == f || f(e), (null == j ? void 0 : j.status) === O.SubscriptionStatusTypes.ACCOUNT_HOLD) {
                            ...
                            null != s ? A = O.AnalyticsObjectTypes.TRIAL : r && (A = O.AnalyticsObjectTypes.GIFT), (0, _.default)({
                                isGift: r,
                                initialPlanId: null,
                                subscriptionTier: a,
                                analyticsLocations: c,
                    ...
                    let X = L.default.Messages.APPLICATION_STORE_GET_PREMIUM,
                        Z = null != j ? (0, C.getPremiumPlanItem)(j) : null,
                    ...
                    let q = null != j && j.status !== O.SubscriptionStatusTypes.ACCOUNT_HOLD && !(0, d.isNoneSubscription)(j.planId) && !J,
        ...
        181114: function(e, t, n) {
            ...
            let R = e => {
                let {
                    ...
                    onlyShineOnHover: R,
                    ...N
                } = e, p = a.createRef(), C = (0, _.default)(p), m = !i && !o && !0 !== u && (!R || C);
