        ...
        364685: function(e, t, n) {
            ...
            class F extends s.default.Store {
                ...
                get hasLoadedStickerPacks() {
                    return null != A && A + D > Date.now()
                }
                get isFetchingStickerPacks() {
                    return O
                }
                getStickerById(e) {
                    return !C.has(e) && L(), C.get(e)
                }
                getStickerPack(e) {
                    return g.get(e)
                }
        ...
        504439: function(e, t, n) {
            ...
            function l(e) {
                let {
                    ...
                    return l
                }, O = A(I, h, (o >> 18 & 31) / 31 / 2), v = A(3, 3, S * n), U = A(3, 3, p * n), D = _ ? A(5, 5, C) : [], L = (0, i.thumbHashToApproximateAspectRatio)(e), R = a(L > 1 ? 32 : 32 * L), P = a(L > 1 ? 32 / L : 32), y = new Uint8Array(R * P * 4), M = [], b = [];
                    ...
                    for (let i = 0; i < R; i++, n += 4) {
                        ...
                        if (_)
                            for (let e = 0, t = 0; e < 5; e++)
                                for (let n = e ? 0 : 1, i = 2 * b[e]; n < 5 - e; n++, t++) S += D[t] * M[n] * i;
                        let p = a - 2 / 3 * o,
                            T = (3 * a - p + d) / 2,
                            C = T - d;
