    ...
    ["3050"], {
        ...
        743506: function(e, t, _) {
            ...
            function R(e) {
                let {
                    ...
                    onClose: C,
                    canBulkBan: m = !1
                } = e, [d, U] = n.useState(N), [p, P] = n.useState(""), [g, D] = n.useState(i.INITIAL), [G, f] = n.useState(!1), h = (0, r.useTrackModerationAction)(t, {
                    location: R,
                    ...
                    if (null != M) {
                        ...
                        if (null == E) return;
                        I.default.banUser(t, null == E ? void 0 : E.id, d, p)
                    }
                    h(r.ModerationActionType.BAN), C()
                }, [M, h, C, L, m, G, p, t, d, E]), H = n.useCallback(e => {
                    U(e)
                }, []), b = n.useCallback(e => {
                    let {
                        value: t
                    ...
                    return null == E ? "" : A.default.Messages.BAN_CONFIRM_TITLE.format({
                        username: "@".concat(u.default.getName(t, null, E))
                    })
                })();
                return (0, a.jsxs)(l.ModalRoot, {
                    ...
                    children: [(0, a.jsx)(l.ModalHeader, {
                        ...
                        children: [(0, a.jsxs)(T.default, {
                            ...
                            className: c.spacing,
                            children: [G && (0, a.jsx)(l.FormErrorBlock, {
                                className: c.error,
        ...
        130037: function(e, t, _) {
            ...
            function s(e, t, _) {
                ...
                let i = {
                    ...t,
                    ...(0, r.collectGuildAnalyticsMetadata)(null !== (E = t.guild_id) && void 0 !== E ? E : _)
                };
                T.default.track(e, i)
            }
            ...
            function A(e) {
                let t = l.useCallback(t => {
                    ! function(e) {
                        ...
                        s(u.AnalyticEvents.MOD_DASH_SEARCH_MEMBERS, t)
                    }(e)
                }, [e]);
                return t
            }
            ...
            function c(e) {
                let t = l.useCallback(t => {
                    ! function(e, t) {
                        ...
                        s(u.AnalyticEvents.MOD_DASH_FILTER_ROLES, _)
                    }(e, t)
                }, [e]);
                return t
            ...
            function O(e) {
                let t = l.useCallback(t => {
                    ! function(e, t) {
                        ...
                        s(u.AnalyticEvents.MOD_DASH_FILTER_SAFETY_FLAGS, _)
                    }(e, t)
                }, [e]);
                return t
            }
            ...
            function N(e, t) {
                let {
                    ...
                    s(u.AnalyticEvents.MODERATION_ACTION, a)
                }, [e, _, E, i]);
                return a
        ...
        58608: function(e, t, _) {
            ...
            let r = e => {
                let {
                    ...
                    mediaLayoutType: T,
                    ...u
                } = e, s = (0, n.useStateFromStores)([l.default], () => l.default.useReducedMotion), A = i.useRef(null);

                function c() {
                    var e;
                    r && (null == A || null === (e = A.current) || void 0 === e || e.play())
                }

                function O() {
                    var e;
                    r && (null == A || null === (e = A.current) || void 0 === e || e.pause())
                }
                return i.useLayoutEffect(() => () => {
                    ...
                    onFocus: c,
                    onBlur: O,
                    style: T === I.MediaLayoutType.MOSAIC ? {
                        width: "100%",
                        height: "100%",
                        maxHeight: "inherit",
                        objectFit: "cover"
            ...
            var o = i.forwardRef((e, t) => (0, E.jsx)(r, {
                ...e,
                externalRef: t
            }))
        },
        387111: function(e, t, _) {
            ...
            function o(e, t, _) {
                var E;
                return null == _ ? I.default.Messages.UNKNOWN_USER : null !== (E = r(e, t, _)) && void 0 !== E ? E : l.default.getName(_)
            }
            var T = {
                getNickname: r,
                getName: o,
                useName: function(e, t, _) {
                    return (0, E.useStateFromStores)([a.default, i.default, n.default], () => o(e, t, _))
                }
            }
        }
    }
