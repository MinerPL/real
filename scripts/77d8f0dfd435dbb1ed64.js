                    ...
                    switch (e.type) {
                        ...
                        case "oscillating-random":
                            ...
                            var d = R(e.minStart),
                                ...
                                k = R(e.minDirection),
                                O = R(e.maxDirection);
                            return new y(new x(b(n.x, i.x), b(d.x, f.x), b(h.x, p.x), b(v.x, m.x), z(k.x, O.x), C(e.easingFunctions)[0]), new x(b(n.y, i.y), b(d.y, f.y), b(h.y, p.y), b(v.y, m.y), z(k.y, O.y), C(e.easingFunctions)[0]))
                    }
                }(p(p({}, e), {
                    valueType: "Vector2"
                }))
            ...
            var P = i.forwardRef(function(e, t) {
                ...
                var D = i.useCallback(function(e, t) {
                    ...
                    M = i.useCallback(function(e, t, n, i, a) {
                        var o, u, l, d, f, h, v, y, R, P, S, _, V, E, F, M = (o = null !== (F = e.id) && void 0 !== F ? F : (0, r.v4)(), u = e, l = n, d = i, f = a, y = O((v = (h = u, p(p({
                            id: o
                        }, c), h))).size), P = (R = function(e, t) {
                            if (null != e) {
                                ...
                                switch (e.type) {
                                    ...
                                    case "oscillating-random":
                                        ...
                                        var d = k(e.minStart),
                                            ...
                                            R = k(e.minDirection),
                                            O = k(e.maxDirection);
                                        return new m(new x(b(n.x, i.x), b(d.x, f.x), b(h.x, p.x), b(v.x, y.x), z(R.x, O.x), C(e.easingFunctions)[0]), new x(b(n.y, i.y), b(d.y, f.y), b(h.y, p.y), b(v.y, y.y), z(R.y, O.y), C(e.easingFunctions)[0]), new x(b(n.z, i.z), b(d.z, f.z), b(h.z, p.z), b(v.z, y.z), z(R.z, O.z), C(e.easingFunctions)[0]))
                                }
                            }(p(p({}, V), {
                                valueType: "Vector3"
                            }))),
