    ...
    ["13350"], {
        ...
        57155: function(e, t, n) {
            ...
            function Q(e) {
                ...
                let f = (0, b.useIsActiveChannelOrUnarchivableThread)(s),
                    R = (0, m.useStateFromStores)([D.default], () => D.default.can(z.Permissions.MANAGE_MESSAGES, s) && f),
                    p = R || c.id === n.id,
                    _ = (0, m.useStateFromStores)([U.default, x.default, B.default], () => H.default.getName(o, s.id, n));
            ...
            function et(e) {
                ...
                let {
                    ...
                    onClose: l,
                    transitionState: r
                } = e, u = (0, m.useStateFromStores)([x.default], () => x.default.getChannel(s.getChannelId())), c = null == u ? void 0 : u.getGuildId(), d = (0, m.useStateFromStores)([L.default, g.default, I.default], () => {
                    var e, t, n;
                ...
                let h = (t = d, n = R, a.useMemo(() => {
                    ...
                    b = (0, m.useStateFromStores)([_.default], () => _.default.saturation),
                        ...
                        children: [(0, i.jsx)(T.Scroller, {
                            ...
                            children: h.map(e => {
                                ...
                                return (0, i.jsx)(Z, {
                                    ...
                                    colors: null != e.burst_colors ? (0, A.buildBurstReactionColors)(e.burst_colors, b, U) : void 0
        ...
        58533: function(e, t, n) {
            ...
            function E(e) {
                ...
                }, [n.name, n.id]), M = p.x - p.width / 2 * .5, j = p.y - p.height / 2 * .5, b = (0, o.useSpring)({
                    from: {
                        y: E.y
                    },
                    to: {
            ...
            var f = new m(o.default, {
                ...
                BURST_REACTION_EFFECT_PLAY: e => {
                    ...
                    let T = null !== (t = r[s]) && void 0 !== t ? t : {},
                        ...
                        E = T[f];
                    if (m !== a.HOVER || null == E) {
                        E === a.HOVER && m === a.EXTERNAL && null != h && ("function" == typeof h.destroy && h.destroy(), null === (i = u[s]) || void 0 === i || delete i[f], E = void 0);
        ...
        331011: function(e, t, n) {
            ...
            function m(e, t) {
                ...
                let _ = {
                    ...
                    g = null !== (n = E ? null == h ? void 0 : h.burst_count : null == h ? void 0 : h.count) && void 0 !== n ? n : 0,
        ...
        350134: function(e, t, n) {
            ...
            function ef(e, t, n) {
                (0, T.openModal)(e => (0, i.jsx)(h.default, {
                    ...e,
                    message: t,
                    selectedReaction: n
                }))
            ...
            class eR extends a.PureComponent {
                ...
                constructor(...e) {
                    super(...e), this.isReactionEventActive = !1, this.isKeyboardNavigation = !1, this.scale = new r.default.Value(1), this.opacity = new r.default.Value(1), this.timeout = new m.Timeout, this.hideTimeout = new m.Timeout, this.ctaRef = a.createRef(), this.type = Z.ReactionTypes.NORMAL, this.colors = {
                        ...
                        let h = i.getChannelId(),
                            E = c ? U.ReactionLocations.FORUM_TOOLBAR : U.ReactionLocations.MESSAGE;
                        if (o && !s && this.isMe()) f ? (0, U.removeReaction)(h, i.id, a, void 0, E, {
                            burst: o
                            ...
                            if (o && !this.userCanBurstReact()) {
                                ...
                                return
                            } else l ? this.handleShowVerificationGate() : !s && (this.isMe() ? (0, U.removeReaction)(h, i.id, a, void 0, E) : (0, U.addReaction)(h, i.id, a, E, {
                                burst: o
                            }))
                        } else {
                        ...
                        o && !this.isReactionEventActive && !a && s && (0, U.playBurstReaction)({
                        ...
                        }, h = "string" == typeof d ? "" === d.trim() : null == d, E = () => h || null == d ? null : (0, i.jsx)(T.Text, {
                            variant: "text-sm/normal",
            ...
            let eh = a.memo(e => {
                ...
                ep = e => {
                    ...
                    }), [d, m] = a.useState(void 0), [f, R] = a.useState(!1), [h, E] = a.useState(!1), p = null != u, _ = (0, O.usePackCollectionData)({
                    ...
                    return (0, i.jsxs)("div", {
                        ...
                        })(), h ? (0, i.jsx)(en.PopoutLoadingAnimation, {
        ...
        512306: function(e, t, n) {
            ...
            let h = async e => {
                ...
                let {
                    effect: n
                } = e, i = await (0, f.getBurstAnimation)(n.channelId, null !== (t = n.messageId) && void 0 !== t ? t : "", n.emoji.name), a = await (0, T.getResizedAnimation)("".concat(n.channelId, ":").concat(n.messageId, ":").concat(n.emoji.name), n.url, i, n.color);
            ...
            function E(e) {
                ...
                } = e, u = o.useRef(null), f = l * T.ANIMATION_TO_EMOJI_RATIO, E = (f + l) / 2;
                return o.useEffect(() => {
                    let e;
        ...
        81924: function(e, t, n) {
            ...
            var i = n("37983"),
                ...
                E = a.memo(function(e) {
                    ...
                    } = (0, l.useBurstReactionsExperiment)(null, !1), C = (0, s.useStateFromStores)([d.default], () => d.default.getEffectForEmojiId(t, n, E)), I = p ? h : R, N = a.useMemo(() => (0, T.buildEffect)(E, _, t, {
                        key: C,
                        messageId: n
                    }), [_, C, E, t, n]), [A, O] = a.useState(!1), v = (0, s.useStateFromStores)([r.default], () => r.default.useReducedMotion), M = c.AnimateEmoji.useSetting(), j = a.useCallback(() => {
                        o.default.dispatch({
                    ...
                    }, [M, t, S, E, E.name, g, A, n, v]), null == C) ? null : (0, i.jsx)(f.default, {
                        className: I.effect,
                        effect: N,
                        onComplete: j
                    })
            ...
            var a = n("414456"),
                ...
                p = () => {
                    ...
                    return (0, i.jsx)(l.Dialog, {
                        children: (0, i.jsxs)("div", {
                            className: h.burstReactionTooltipCoachmark,
                            children: [(0, i.jsx)("img", {
                                src: E,
                                alt: ""
                            }), (0, i.jsx)(l.Text, {
                                ...
                                className: h.burstReactionTooltipCoachmarkButtons,
                                children: [(0, i.jsx)(l.Button, {
                                    className: s(h.burstReactionTooltipCoachmarkButton, h.burstReactionTooltipCoachmarkDismiss),
                                    ...
                                    autoFocus: !0,
                                    className: s(h.burstReactionTooltipCoachmarkButton, h.burstReactionTooltipCoachmarkCTA),
                                    color: l.Button.Colors.CUSTOM,
        ...
        85589: function(e, t, n) {
            ...
            function R(e) {
                ...
                let {
                    ...
                    hasUnlimited: E
                } = (0, o.useBurstReactionsExperiment)(null, !1), p = E ? m.default.Messages.SUPER_REACTIONS_UPSELL_UNLIMITED_BODY : m.default.Messages.SUPER_REACTIONS_UPSELL_BODY_LAUNCH, _ = p.format({
                    onClick: () => {
        ...
        166257: function(e, t, n) {
            ...
            function A(e, t, n, i, a) {
                ...
                r.default.dispatch({
                    ...
                    channelId: t,
                    messageId: n,
                    userId: null !== (s = null == a ? void 0 : a.userId) && void 0 !== s ? s : h.default.getId(),
                    emoji: i,
                    optimistic: !0,
            ...
            async function M(e, t, n) {
                ...
                if (r && !f.default.hasAvailableBurstCurrency && !h) return;
                ...
                A("MESSAGE_REACTION_ADD", e, t, n, {
                    ...
                    r ? (l.AccessibilityAnnouncer.announce(h ? I.default.Messages.BURST_REACTION_ADD_UNLIMITED_SUCCESS_A11Y.format({
                        name: n.name
                    ...
                    N(a, () => M(e, t, n, i, {
                        ...
                        burst: r
                    }), r ? l.AccessibilityAnnouncer.announce(h ? I.default.Messages.BURST_REACTION_ADD_UNLIMITED_ERROR_A11Y.format({
                        name: n.name
