    ...
    ["75232"], {
        ...
        404515: function(e, t, s) {
                        ...
                        children: e => {
                            ...
                            return (0, a.jsx)(C.default, {
                                ...
                                children: (0, a.jsx)(c.AdvancedScroller, {
                                    ...
                                    ref: u,
                                    children: _.map((e, t) => (0, a.jsx)(T.default, {
            ...
            function D(e) {
                ...
                return !(null == s || null == a || Object.values(A.PremiumSubscriptionSKUs).includes(s) || (0, R.isPremiumSubscriptionPlan)(a))
            }
        ...
        942456: function(e, t, s) {
            ...
            function eE(e) {
                ...
                }), n = (0, A.useProductType)(a), l = (0, m.useStateFromStores)([U.default], () => U.default.getGuild(t)), u = (null == a ? void 0 : a.role_id) != null && (null == a ? void 0 : a.attachments_count) === 0 ? en.default.Messages.GUILD_PRODUCT_BILLING_TYPE_PREMIUM_ROLE : n, o = r.useCallback(async () => {
            ...
            function ep(e) {
                ...
                let {
                    ...
                    requireCurrentGuild: !1
                }), l = (0, m.useStateFromStores)([T.default], () => T.default.getGuildProductFetchState(n) === T.FetchState.FETCHING), u = null == r ? void 0 : r.role_id, o = (0, m.useStateFromStores)([U.default], () => {
                    var e;
                ...
                renderDescription() {
                    ...
                    if (null != p && 0 !== p.items.length) {
                        ...
                        if (p.type === et.SubscriptionTypes.PREMIUM) p.items.forEach(t => {
                            ...
                            (0, X.isPremiumBaseSubscriptionPlan)(s) ? (e.push(X.default.getDisplayName(s, !1, m)), a = es.SubscriptionPlanInfo[s].skuId) : (e.push("".concat(n > 1 ? "".concat(n, "x ") : "").concat(X.default.getDisplayName(s, !1, m))), null == a && (a = es.SubscriptionPlanInfo[s].skuId))
                        });
                        else if (p.type === et.SubscriptionTypes.GUILD) {
                            let t = j.default.get(p.items[0].planId);
                ...
                constructor(...e) {
                    super(...e), this.state = {
                        ...
                        canRefund: () => {
                            ...
                            return null == e.sku || !(0, q.hasFlag)(e.sku.flags, p.SKUFlags.GUILD_PRODUCT)
                        }
            ...
            function eI(e) {
                ...
                let {
                    ...
                    gameApplication: I,
                    paymentSources: _
                } = (0, m.useStateFromStoresObject)([b.default, v.default, O.default], () => {
                    var e;
                    return {
                        applicationStatistics: null != c ? b.default.getCurrentUserStatisticsForApplication(c) : null,
                        gameApplication: null !== (a = v.default.getGame(null != c ? c : "")) && void 0 !== a ? a : null === (e = n.sku) || void 0 === e ? void 0 : e.application,
                ...
                let C = (0, m.useStateFromStores)([U.default], () => U.default.getGuild(null == I ? void 0 : I.guildId)),
                    R = d ? I : void 0;
                return (0, i.jsx)(em, {
                    applicationStatistics: p,
                    application: E ? N : R,
        ...
        58820: function(e, t, s) {
            ...
            function b(e) {
                ...
                return t = f ? j.guildBoostingSubscriptionRowCanceled : (0, h.isSubscriptionStatusFailedPayment)(d) ? j.guildBoostingSubscriptionRowFailedPayment : j.guildBoostingSubscriptionRowActive, (0, a.jsxs)(a.Fragment, {
                    children: [(0, a.jsxs)("div", {
                        ...
                        children: [(0, a.jsx)("div", {
                            ...
                            onClick: () => p.default.open(U.UserSettingsSections.GUILD_BOOSTING),
            ...
            function B() {
                return n.useEffect(() => {
                    A.default.track(U.AnalyticEvents.TOOLTIP_VIEWED, {
            ...
            function k(e) {
                ...
                return (0, a.jsxs)("div", {
                    className: r(j.billingInformation, n),
            ...
            function Y(e) {
                ...
                let s, {
                    ...
                    [_] = (0, g.useSubscriptionInvoicePreview)({
                        subscriptionId: n.id,
                        renewal: !0,
                        applyEntitlements: !0,
                        analyticsLocations: (0, I.default)(m.default.SUBSCRIPTION_DETAILS),
                    ...
                    C = d(n.currentPeriodEnd),
                    R = null != n.paymentSourceId,
                    T = null !== (t = null == _ ? void 0 : _.total) && void 0 !== t ? t : 0,
                    A = null == i ? void 0 : i.invalid,
                    h = !R && T > 0 && (7 >= C.diff(d(), "days") || n.status === U.SubscriptionStatusTypes.PAST_DUE) && !N && !n.isPurchasedExternally,
                    y = A && n.status === U.SubscriptionStatusTypes.PAST_DUE && !N && !n.isPurchasedExternally,
                    w = (0, M.useIsPrepaidPaymentPastDue)(),
                    Y = !N && w,
                    H = (null == n ? void 0 : n.status) === U.SubscriptionStatusTypes.PAST_DUE ? d().diff(d(n.currentPeriodStart), "days") : 0,
                    [V] = (0, g.useGetSubscriptionInvoice)({
                        subscriptionId: n.id,
                        preventFetch: !Y
                    });
                return null == p || null == _ ? (0, a.jsx)(E.Spinner, {}) : (null != n.renewalMutations && (n.renewalMutations.planId !== n.planId && !(0, P.isNoneSubscription)(n.renewalMutations.planId) || n.hasExternalPlanChange) && (s = (0, a.jsx)(v.default, {
                    subscription: n,
                                    ...
                                    children: [(0, a.jsx)(k, {
                                        ...
                                        children: [(0, a.jsx)(E.FormTitle, {
                                            ...
                                            children: n.isPurchasedExternally && null != n.paymentGateway ? O.default.Messages.BILLING_MANAGED_BY_PAYMENT_GATEWAY.format({
                                                paymentGatewayName: U.PaymentGatewayToFriendlyName[n.paymentGateway]
        ...
        541554: function(e, t, s) {
            ...
            let h = new f.default("SubscriptionHeader.tsx"),
                L = {
                    ...
                    section: R.AnalyticsSections.SETTINGS_PREMIUM,
                    object: R.AnalyticsObjects.CARD
                };
            ...
            function M() {
                return (0, a.jsxs)(a.Fragment, {
                    children: [(0, a.jsx)(_.default, {
                        ...
                        "aria-label": T.default.Messages.PREMIUM_TIER_1
                    }), (0, a.jsx)("div", {
            ...
            function y() {
                ...
                return (0, a.jsx)(g, {
                    ...
                    subscriptionInfo: (0, a.jsx)("div", {
                        ...
                        children: T.default.Messages.PREMIUM_TIER_1_ACCOUNT_CREDIT_BANNER_DESCRIPTION
                    }),
                    buttons: (0, a.jsx)(S.default, {
                        className: A.toolsButton,
                        onClick: () => (0, E.default)({
                            subscriptionTier: C.PremiumSubscriptionSKUs.TIER_1,
                            analyticsLocations: e,
                            analyticsObject: L
                        }),
                        children: T.default.Messages.PREMIUM_TIER_1_ACCOUNT_CREDIT_BANNER_CTA
                    }),
                    statusClasses: {
                        [A.tier1]: !0
                    }
            ...
            var x = function(e) {
                ...
                } = (0, c.default)(d.default.SUBSCRIPTION_HEADER), v = () => {
                    (n.status === R.SubscriptionStatusTypes.ACTIVE || n.status === R.SubscriptionStatusTypes.PAST_DUE) && U()
                }, U = () => {
                ...
                let b = N.default.getStatusFromInvoice(n, r),
                    B = N.default.getPremiumType(j),
                    G = {
                        [A.tier0]: B === C.PremiumTypes.TIER_0,
                        [A.tier1]: B === C.PremiumTypes.TIER_1,
                        [A.tier2]: B === C.PremiumTypes.TIER_2,
                        [A.canceled]: b === R.SubscriptionStatusTypes.CANCELED,
                        [A.failedPayment]: (0, N.isSubscriptionStatusFailedPayment)(b)
                    },
                    F = null;
                switch (B) {
                    case C.PremiumTypes.TIER_0:
                        F = (0, a.jsxs)(a.Fragment, {
                            children: [(0, a.jsx)(_.default, {
                                className: A.discordWordmark,
                                "aria-label": T.default.Messages.PREMIUM_TIER_0
                            }), (0, a.jsx)("div", {
                    ...
                    case C.PremiumTypes.TIER_2:
                        F = (0, a.jsx)(I.default, {
                            ...
                            "aria-label": T.default.Messages.PREMIUM_TITLE
                        })
                }
                return (0, a.jsx)(g, {
                    wordMark: F,
                    ...
                    buttons: (() => {
                        ...
                        if (n.isPurchasedExternally) {
                            ...
                            return (0, a.jsx)(u.Anchor, {
                                ...
                                children: (0, a.jsx)(u.Button, {
                                    ...
                                    submitting: y,
                                    children: T.default.Messages.BILLING_MANAGE_SUBSCRIPTION
                                })
                            })
                        }
                        if (N.default.isBaseSubscriptionCanceled(n)) return (0, a.jsx)(u.Button, {
                            ...
                            submitting: y,
                            onClick: O,
                            children: T.default.Messages.RESUBSCRIBE
                        });
                        if (e === R.SubscriptionStatusTypes.ACTIVE || e === R.SubscriptionStatusTypes.PAST_DUE) {
                            let t = !1,
                                s = null;
                            return null != n.renewalMutations && (t = !0, s = n.renewalMutations.planId !== n.planId ? T.default.Messages.PREMIUM_SWITCH_PLAN_DISABLED_PENDING_MUTATION_PLAN : T.default.Messages.PREMIUM_SWITCH_PLAN_DISABLED_PENDING_MUTATION_PREMIUM_GUILD_SUBSCRIPTION), null != n.trialEndsAt && (t = !0, s = T.default.Messages.PREMIUM_SWITCH_PLAN_DISABLED_IN_TRIAL), e === R.SubscriptionStatusTypes.PAST_DUE && (t = !0), (0, a.jsxs)("div", {
                                ...
                                children: [(0, a.jsx)(u.Button, {
                                    ...
                                    children: e => (0, a.jsx)(S.default, {
                                        ...
                                        children: T.default.Messages.PREMIUM_SWITCH_PLANS
                                    })
                                })]
                            })
                        }
        ...
        690679: function(e, t, s) {
            ...
            function M(e) {
                let {
                ...
                } = e, v = (0, o.useStateFromStores)([_.default], () => _.default.hidePersonalInformation), [U, O] = (0, o.useStateFromStoresArray)([N.default], () => [N.default.paymentSources, N.default.hasFetchedPaymentSources]), j = (0, I.useSubscriptionPlansLoaded)((0, R.getSubscriptionSKUs)(t)), {
                    analyticsLocations: b
                } = (0, m.default)(), B = n.useMemo(() => Object.values(U).filter(e => !e.invalid), [U]), [G, F] = n.useState(!1), [k, w] = n.useState(t.currency), Y = async (e, s) => {
                    if (null == t) throw Error("missing subscription and paymentSource");
                    null == e ? await f.changeSubscriptionCurrency(t, s, b, x) : await f.changePaymentSource(t, e, s, b, x), F(!1), w(s)
                }, H = async (e, s, a) => {
                    F(!0);
                    let n = await (0, T.updateSubscriptionInvoicePreview)({
                        subscriptionId: t.id,
                    ...
                    (0, C.fetchSubscriptionPlansOnNewPaymentSource)(e.id, (0, R.getSubscriptionSKUs)(t)).then(() => {
                        H(e, V(e), Y)
                ...
                if (!O || !j) return (0, a.jsx)(d.Spinner, {});
        ...
        95637: function(e, t, s) {
            ...
            function A(e) {
                ...
                let L = (0, S.getPrice)(t.planId, !1, !1, {
                    ...
                    g = (0, C.formatRate)((0, C.formatPrice)(L.amount, L.currency), h.interval, h.intervalCount);
                return (0, a.jsxs)(c.ModalRoot, {
                    transitionState: n,
                    "aria-label": R.default.Messages.PREMIUM_PENDING_PLAN_CHANGE_CANCEL_HEADER,
                    children: [(0, a.jsxs)(c.ModalHeader, {
                        justify: N.default.Justify.BETWEEN,
                        separator: !1,
                        children: [(0, a.jsx)(c.FormTitle, {
                            tag: c.FormTitleTags.H4,
                            children: R.default.Messages.PREMIUM_PENDING_PLAN_CHANGE_CANCEL_HEADER
                        }), (0, a.jsx)(c.ModalCloseButton, {
                            onClick: i
                        })]
                    }), (0, a.jsx)(c.ModalContent, {
                        className: T.modalBody,
                        children: (0, I.isNoneSubscription)(t.planId) ? R.default.Messages.PREMIUM_PENDING_PLAN_CHANGE_CANCEL_BODY_NO_EXISTING_PLAN.format({
                            downgradedPlan: S.default.getDisplayName(s.planId),
                            existingRate: g
                        }) : R.default.Messages.PREMIUM_PENDING_PLAN_CHANGE_CANCEL_BODY.format({
                        ...
                        children: [(0, a.jsx)(c.Button, {
                            onClick: A,
                            children: R.default.Messages.PREMIUM_PENDING_PLAN_CHANGE_CANCEL_BUTTON
                        }), (0, a.jsx)(c.Button, {
                            look: c.Button.Looks.LINK,
                            color: (0, d.isThemeLight)(l) ? c.Button.Colors.PRIMARY : c.Button.Colors.WHITE,
                            onClick: i,
                            children: R.default.Messages.NEVERMIND
                        })]
                    })]
                })
            }
            ...
            function h(e) {
                ...
                return (0, a.jsxs)("div", {
                    className: r(T.root, i),
                    children: [(0, a.jsx)(P.default, {
                        className: T.infoIcon
                    }), (0, a.jsx)("div", {
                        className: T.text,
                        children: R.default.Messages.PREMIUM_PENDING_PLAN_CHANGE_NOTICE.format({
