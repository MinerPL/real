    ...
    ["86612"], {
        ...
        552022: function(e, t, l) {
            ...
            var y = function(e) {
                ...
                let {
                    ...
                    onEdit: g,
                    onShare: N
                } = e, E = (0, d.useStateFromStoresArray)([h.default], () => s.users.map(e => h.default.getUser(e)).filter(_.isNotNullish)), {
                    AnalyticsLocationProvider: j
                } = (0, p.default)(f.default.CLIPS_GALLERY_ITEM), M = i.useRef(null), y = (0, C.default)(null !== (a = null === (t = s.editMetadata) || void 0 === t ? void 0 : t.start) && void 0 !== a ? a : 0), b = i.useRef(new c.DelayedCall(500, () => {
                    var e;
                    let t = M.current;
                ...
                }, [null === (l = s.editMetadata) || void 0 === l ? void 0 : l.start]), k = !s.name, V = new Date(I.default.extractTimestamp(s.id)), B = V.toLocaleDateString(), O = V.toLocaleTimeString([], {
                    hour: "2-digit",
                    minute: "2-digit"
                }), z = "".concat(B, " • ").concat(O);
                return (0, n.jsx)(j, {
                    children: (0, n.jsxs)(u.Clickable, {
                        ...
                        onClick: () => {
                            g(s), S.default.track(T.AnalyticEvents.CLIP_GALLERY_CARD_CLICKED)
                        },
            ...
            function H(e) {
                let {
                    ...
                    isNew: l,
                    videoRef: a
                } = e, s = (0, M.useClipProtocolURL)(t), [o, d] = i.useMemo(() => {
                    let e = t.length,
                        l = !1,
                        a = null != t.editMetadata ? t.editMetadata.end - t.editMetadata.start : null;
                    return null != a && 1e3 * a < t.length && (e = 1e3 * a, l = !0), [l, r.duration(e)]
                }, [t.length, t.editMetadata]), c = "".concat(d.seconds()).padStart(2, "0");
                return (0, n.jsxs)(v.default, {
                    aspectRatio: 16 / 9,
                    className: R.clipThumbContainer,
                    children: [null != s ? (0, n.jsx)(E.default, {
                        preload: "metadata",
                        muted: !0,
                        poster: t.thumbnail,
                        src: s,
                        ...
                        children: [l ? (0, n.jsxs)(u.Text, {
                            ...
                            children: [o ? (0, n.jsx)(N.default, {
                                ...
                                variant: "text-md/medium",
                                color: "always-white",
                                children: "".concat(d.minutes(), ":").concat(c)
                            })]
                        })]
                    })]
                })
            ...
            function P(e) {
                ...
                return (0, n.jsxs)("div", {
                    ...
                    children: [null != i && (0, n.jsx)(u.Tooltip, {
                        ...
                        children: e => (0, n.jsx)(u.Button, {
                            ...
                            onClick: e => {
                                e.stopPropagation(), e.shiftKey ? (0, j.deleteClip)(t.filepath) : i(t), S.default.track(T.AnalyticEvents.CLIP_GALLERY_CARD_BUTTON_CLICKED, {
                                    type: "delete"
                                })
                            },
                            className: R.button,
                        ...
                        children: e => (0, n.jsx)(u.Button, {
                            ...
                            color: u.Button.Colors.PRIMARY,
                            onClick: e => {
                                e.stopPropagation(), o(t), S.default.track(T.AnalyticEvents.CLIP_GALLERY_CARD_BUTTON_CLICKED, {
                                    type: "edit"
                                })
                            },
                            className: R.button,
                        ...
                        text: s ? A.default.Messages.SHARE : A.default.Messages.CLIPS_CANNOT_ATTACH_FILE_TO_CHANNEL,
                        children: e => (0, n.jsx)(u.Button, {
                            ...e,
                            disabled: a && !l || !s,
                            submitting: l,
                            ...
                            onClick: e => {
                                e.stopPropagation(), r(t), S.default.track(T.AnalyticEvents.CLIP_GALLERY_CARD_BUTTON_CLICKED, {
                                    type: "share"
                                })
                            },
                            className: R.button,
        ...
        548405: function(e, t, l) {
            ...
            function v(e) {
                let {
                    ...
                    closePopout: l
                } = e, n = (0, o.default)([c.default], () => c.default.getKeybindForAction(p.GlobalKeybindActions.SAVE_CLIP)), v = (0, o.default)([f.default], () => f.default.getSettings().clipsEnabled), C = t ? h.noSearchResultsImage : h.noClipsImage, L = s.useCallback(() => {
                    l(), d.default.open(p.UserSettingsSections.CLIPS)
                }, [l]), x = (() => {
                    if (!v) return m.default.Messages.CLIPS_GALLERY_NO_CLIPS_CLIPS_NOT_ENABLED.format({
                        onClick: L
                    });
        ...
        167573: function(e, t, l) {
            ...
            function I(e) {
                let {
                    ...
                    onClose: n,
                    transitionState: o
                } = e, [I, j] = s.useState(""), [M, T] = s.useState("descending"), [A, R] = s.useState(!0), [y, H] = s.useState(null), P = s.useDeferredValue(I), b = (0, c.useStateFromStores)([C.default], () => C.default.getClips()), D = (0, c.useStateFromStores)([C.default], () => C.default.getSettings().storageLocation), w = (0, c.useStateFromStores)([C.default], () => C.default.getState().newClipIds), {
                ...
                let V = s.useMemo(() => r(b).filter(e => {
                    if ("" === P.trim()) return !0;
                    let t = P.toLowerCase();
                    return null != e.name && "" !== e.name && i(t, e.name.toLowerCase()) || i(t, e.applicationName.toLowerCase())
                }).sort((e, t) => "ascending" === M ? v.default.compare(e.id, t.id) : "descending" === M ? v.default.compare(t.id, e.id) : 0).chunk(3).value(), [b, P, M]);
                s.useEffect(() => {
                    (async function e() {
                        R(!0);
                        try {
                            await L.loadClipsDirectory(D)
                        } finally {
                            R(!1)
                        }
                    })()
        ...
        16002: function(e, t, l) {
            ...
            async function m(e, t) {
                ...
                } = t, C = n.default.getChannel(m);
                if (null != C) try {
                    var L;
                    let t = await (0, u.exportClip)(e, h),
                        l = null !== (L = e.name) && void 0 !== L ? L : (0, f.CLIP_NAME_TEMPLATE)(r.default.extractTimestamp(e.id)),
                        a = (0, c.default)(l);
        ...
        142485: function(e, t, l) {
            ...
            var a = l("884691"),
                ...
                c = e => {
                    let {
                    ...
                    } = (0, n.default)(), u = (0, s.default)([i.default], () => i.default.getChannel(t)), f = null == u ? void 0 : u.isPrivate(), p = (0, s.default)([o.default], () => null == t || f || o.default.can(d.Permissions.ATTACH_FILES, u) && o.default.can(d.Permissions.SEND_MESSAGES, u)), m = a.useCallback(async e => {
                        let {
                            clip: a,
                            cropData: s,
                        ...
                        l(a.id);
                        try {
                            var d, u, f, p, m, h, v, C, L, x;
                            await (0, r.shareClip)(a, {
                                channelId: t,
                                analyticsLocations: c,
                                editMetadata: {
                                    start: null !== (h = null !== (m = null == s ? void 0 : s.start) && void 0 !== m ? m : null === (d = a.editMetadata) || void 0 === d ? void 0 : d.start) && void 0 !== h ? h : 0,
                                    end: null !== (C = null !== (v = null == s ? void 0 : s.end) && void 0 !== v ? v : null === (u = a.editMetadata) || void 0 === u ? void 0 : u.end) && void 0 !== C ? C : a.length / 1e3,
