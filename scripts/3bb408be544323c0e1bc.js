        ...
        981125: function(e, t, a) {
            ...
            function R(e) {
                let {
                    ...
                    onClose: a
                } = t, R = (0, n.useStateFromStores)([u.default], () => u.default.locale), y = R.split("-")[0], S = "en" === y ? "0" : "1", v = "zh-CN" === R ? "zh-Hans" : "zh-TW" === R ? "zh-Hant" : y, L = {
                    url: "".concat((0, A.YOUTUBE_EMBED_URL)(x), "?vq=large&rel=0&controls=0&showinfo=0&cc_load_policy=").concat(S, "&cc_lang_pref=").concat(v),
                    width: 498,
                    height: 280
                }, {
                    location: G
                ...
                } = (0, c.default)(d.default.PREMIUM_MARKETING_ANNOUNCEMENT_MODAL), H = (0, n.useStateFromStores)([_.default], () => _.default.getCurrentUser()), j = (0, f.isPremiumExactly)(H, h.PremiumTypes.TIER_2), U = (0, f.isPremium)(H) && !j;
