    ...
    ["67095"], {
            ...
            class d extends l.PureComponent {
                render() {
                    ...
                    let {
                        ...
                        errorMessage: A,
                        retrySuccess: p
                    } = this.state, N = l.Children.count(r) > 0 ? (0, i.jsx)(u.Card, {
        ...
        364685: function(e, t, n) {
            ...
            let p = 2,
                ...
                M = () => {
                    ...
                    if (null != t) {
                        for (let [e, n] of t)
                            if (T.default.isMember(e) && !h.has(e)) {
            ...
            var k = new b(u.default, {
                BACKGROUND_SYNC: () => {
                    m = null, C = new Map, h = new Map, p = 0
                },
                CONNECTION_OPEN: e => {
                    let {
                        guilds: t
                    } = e;
                    m = null, C = new Map, h = new Map, t.forEach(y), p = t.every(e => null != e.stickers) ? 1 : 0
                },
                ...
                LOGOUT: () => {
                    p = 0, O = [], C.clear(), N.clear(), m = null, h.clear(), h = new Map(h), g = !1, R = null
                },
                ...
                GUILD_STICKERS_UPDATE: e => {
                    ...
                    }, r = null !== (t = h.get(n)) && void 0 !== t ? t : [], a = r.filter(e => null == i.find(t => t.id === e.id));
                    a.forEach(e => {
        ...
        467940: function(e, t, n) {
            ...
            var i = n("37983"),
                ...
                L = (0, s.default)((0, o.default)(function(e) {
                    ...
                    }, [k]), w = (0, r.useStateFromStores)([S.default], () => S.default.isMember(o, n.id), [o, n.id]), H = (0, R.default)(n.id, o), V = (0, N.default)(n.id, h), x = (0, T.default)({
                        guildId: o,
                        userId: n.id,
                        analyticsLocation: null != D ? D : y.location,
                        analyticsLocations: [b],
                        context: h
                    }), Y = (0, p.default)(n, b), K = (0, A.default)(n, o, null != s ? s : B, b), W = (0, m.default)(s, M), j = (0, O.default)(n, o), q = (0, g.default)(n.id, o, !1, b), X = (0, _.default)({
                        id: n.id,
                        label: U.default.Messages.COPY_ID_USER,
                        onSuccess: F
                    }), Z = (0, C.default)(n, o), J = !!(null == n ? void 0 : n.isNonUserBot());
        ...
        459870: function(e, t, n) {
            ...
            function m(e, t) {
                let n = (0, l.useStateFromStores)([c.default], () => c.default.getChannels(t)[c.GUILD_VOCAL_CHANNELS_KEY], [t]),
                    m = (0, l.useStateFromStores)([f.default, d.default], () => {
                        let n = f.default.getUserVoiceChannelId(t, e.id);
                        return d.default.getChannel(n)
                    }, [t, e.id]),
                    O = (0, l.useStateFromStores)([E.default], () => E.default.isGuestOrLurker(t, e.id), [t, e.id]);
                if (O || null == m) return null;
                let R = e.id === s.default.getId();
                if (!R && !T.default.can(N.Permissions.MOVE_MEMBERS, m)) return null;
                let g = n.filter(t => {
                    let {
                        channel: n
                    } = t;
                    return n.id !== m.id && (R ? T.default.can(N.Permissions.CONNECT, n) && !(0, A.isChannelFull)(n, f.default, _.default) : T.default.can(N.Permissions.MOVE_MEMBERS, n) && (T.default.can(N.Permissions.CONNECT, n) || p.default.can({
        ...
        26092: function(e, t, n) {
            ...
            function g(e) {
                ...
                if (null == d) return h();
                c = null !== (t = e.section) && void 0 !== t ? t : c, O = null !== (n = e.section) && void 0 !== n ? n : c, null != e.subsection && null != c && (E[c] = e.subsection), null != e.scrollPosition && null != c && (_[c] = e.scrollPosition), A = !!e.openWithoutBackstack, s = o.FormStates.OPEN, T = {}, S = {
                    ...I = {
                ...
                }, N = null !== (i = e.onClose) && void 0 !== i ? i : null, C = null !== (l = e.analyticsLocation) && void 0 !== l ? l : null, m = null !== (r = e.analyticsLocations) && void 0 !== r ? r : [], R = null !== (a = e.impressionSource) && void 0 !== a ? a : null
            }

            function h() {
                s = o.FormStates.CLOSED, f = !1, I = null, O = null, S = null, d = null, c = null, E = {}, _ = {}, N = null, C = null, m = [], R = null
            }
            ...
            var M = new L(a.default, {
                ...
                USER_SETTINGS_MODAL_SET_SECTION: function(e) {
                    var t;
                    d = c, c = e.section, C = null, m = null !== (t = e.analyticsLocations) && void 0 !== t ? t : [], null != e.subsection && (E[c] = e.subsection)
                },
                ...
                DRAWER_SELECT_TAB: function(e) {
                    return p = e.tab, null == c && p === o.DrawerTabTypes.USER_SETTINGS && g({
                        type: "USER_SETTINGS_MODAL_INIT",
                        section: null,
                        subsection: null,
                        scrollPosition: null,
