    ...
    ["94548"], {
        ...
        530474: function(e, t, a) {
            ...
            let eg = n.memo(function(e) {
                    ...
                    }, [m, t.id, t.guild_id, l]), _ = n.useMemo(() => a && !r ? (0, s.jsx)(ev, {}) : a || r || 0 !== o.textValue.trim().length && o.textValue.trim() !== x ? !r && (i.trim().length > 0 || o.textValue.trim().length > 0 && o.textValue.trim() !== x || D.default.getUploads(t.id, L.DraftType.FirstThreadMessage).length > 0) && d ? (0, s.jsx)(z.default, {
        ...
        193695: function(e, t, a) {
            ...
            let eU = n.memo(function(e) {
                ...
                let {
                    ...
                    mostRecentMessage: l,
                    hasUnreads: i
                } = e, o = (0, R.useNullableMessageAuthor)(l), u = (0, f.useStateFromStores)([W.default], () => null != l && W.default.isBlocked(l.author.id)), d = (0, f.useStateFromStores)([V.default], () => V.default.can(eS.Permissions.MANAGE_MESSAGES, a)), c = H.RenderSpoilers.useSetting(), m = (0, ed.useIsRecentMessageDeleted)(a), {
                    content: h
            ...
            function eB(e) {
                let {
                    ...
                    isNew: n,
                    containsTags: l
                } = e, r = t.hasFlag(eT.ChannelFlags.PINNED), i = (0, f.useStateFromStores)([W.default], () => null != a && W.default.isBlocked(a.author.id));
                return (0, s.jsxs)("div", {
                    className: eM.header,
