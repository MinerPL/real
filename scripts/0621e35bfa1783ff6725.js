    ...
    ["16959"], {
        ...
        557585: function(e, t, n) {
            ...
            function S(e) {
                ...
                } = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : {}, n = arguments.length > 2 && void 0 !== arguments[2] && arguments[2], i = (0, r.useStateFromStores)([u.default], () => u.default.getCurrentUser()), [S, g, T] = (0, r.useStateFromStoresArray)([c.default], () => [c.default.getSounds(), c.default.getFavorites(), c.default.isFetching()]), v = (0, p.useSortedGuildIdsForSoundboard)(e, !1), C = (0, r.useStateFromStoresArray)([s.default], () => {
                    let e = [];
                    return v.forEach(t => {
                        let n = s.default.getGuild(t);
                        null != n && e.push(n)
                    }), e
                }), y = d.default.canUseSoundboardEverywhere(i), I = (0, r.useStateFromStores)([s.default], () => s.default.getGuild(null == e ? void 0 : e.guild_id)), N = (0, r.useStateFromStores)([a.default], () => {
                    let {
