    ...
    ["85740"], {
            ...
            var r = t("920040"),
                ...
                l = a.memo(function(e) {
                    ...
                    return (0, r.jsx)(s.Avatar, {
                        src: (n = c, t = (0, s.getAvatarSize)(o), l = d, u = v, n.getAvatarURL(u, t, l)),
                        size: o,
        ...
        817963: function(e, n, t) {
            ...
            let f = {
                ...
                E = (e, n, t, r) => {
                    ...
                    if ("user" in e) {
                        var a;
                        return r && null != n && (null === (a = e.user) || void 0 === a ? void 0 : a.id) === n.id
                    }
                    return !1
                },
                v = e => {
                    ...
                    return e.isGuildStageVoice() ? n = o.CREATE_GUILD_EVENT_STAGE_CHANNEL_PERMISSIONS : e.isGuildVoice() && (n = o.CREATE_GUILD_EVENT_VOICE_CHANNEL_PERMISSIONS), [a.default.combine(n, d.Permissions.CREATE_EVENTS), a.default.combine(n, d.Permissions.MANAGE_EVENTS)]
                },
                h = e => {
                    let [n, t] = e instanceof l.default ? [d.Permissions.CREATE_EVENTS, d.Permissions.MANAGE_EVENTS] : v(e), [a, i, o, h] = (0, s.useStateFromStoresArray)([u.default], () => [u.default.can(d.Permissions.CREATE_GUILD_EXPRESSIONS, e), u.default.can(d.Permissions.MANAGE_GUILD_EXPRESSIONS, e), u.default.can(n, e), u.default.can(t, e)]), m = (0, s.useStateFromStores)([c.default], () => c.default.getCurrentUser()), N = r.useCallback(e => E(e, m, i, a), [a, i, m]), S = r.useCallback(e => E(e, m, h, o), [h, o, m]);
                    return null == e ? f : {
                ...
                m = function(e) {
                    let n = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : u.default,
                        ...
                        s = n.can(d.Permissions.CREATE_GUILD_EXPRESSIONS, e),
                ...
                N = e => {
                    let n = (0, s.useStateFromStores)([u.default], () => u.default.can(d.Permissions.MANAGE_GUILD, e)),
                        {
        ...
        41170: function(e, n, t) {
            ...
            function M(e) {
                ...
                return A.default.Messages.STICKER_A11Y_LABEL.format({
                    stickerName: n
                })
            }
            let T = e => {
                    ...
                    return (0, r.jsxs)("div", {
                        ...
                        children: [t ? (0, r.jsxs)("div", {
                            ...
                            children: [(0, r.jsx)(h.default, {
                                ...
                                children: A.default.Messages.STICKER_ASSET_LOAD_ERROR
                            })]
                        }) : n, u && a && (0, r.jsx)("div", {
                ...
                L = e => {
                    let {
                        ...
                        onError: m
                    } = e, N = a.useRef(null), S = a.useRef(null), [C, p] = a.useState(!0), [x, R] = a.useState(!1), L = a.useRef(!1);
                    L.current = n && o;
                    ...
                    return (u(null != V, "Unable to determine sticker asset URL. Sticker ID: ".concat(i.id)), a.useEffect(() => {
                        ...
                        let n = !1,
                            r = async () => {
                                let {
                                    default: e
                                } = await t.el("330559").then(t.bind(t, "330559"));
                        ...
                        return r(), () => {
                            var e;
                            null === (e = S.current) || void 0 === e || e.drop(), S.current = null, n = !0
                        }
                    }, [V, s, i.id, c, m]), a.useEffect(() => {
                        var e;
                        let t;
                        !n && (t = 0), null === (e = S.current) || void 0 === e || e.setState(n && o, t)
                    }, [i, n, o]), null == V) ? null : (0, r.jsx)("div", {
                        role: "img",
                        className: d,
                        "aria-label": x ? A.default.Messages.ERROR_LOADING_STICKER : M(i),
                        ref: E,
                        children: (0, r.jsx)(T, {
                            hasError: x,
                            isLoading: C,
                ...
                V = e => {
                    let {
                        ...
                        fileUri: E
                    } = e, [v, h] = a.useState(!1), [m, N] = a.useState(!0), [S, C] = a.useState(!1), A = a.useRef(null), x = a.useRef(null), R = null != E ? E : (0, g.getStickerAssetUrl)(t, {
                        isPreview: !n || !v || !s,
                        size: l
                    }), L = a.useCallback(() => {
                        N(!1)
                ...
                j = e => {
                    let {
                        ...
                        transform: "scale(".concat(v ? 1 : 1 / t, ")"),
                        opacity: 0
                ...
                w = e => {
                    let {
                        ...
                        fileUri: v,
                        onError: h
                    } = e, m = (0, N.useIsWindowFocused)(), g = (0, S.useShouldAnimateSticker)(n) && !t, A = a.useRef(null);
                    if (null == o) return null;
                    let I = o.format_type === C.StickerFormat.LOTTIE ? L : V;
