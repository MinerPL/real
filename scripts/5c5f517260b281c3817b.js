        ...
        364685: function(e, t, n) {
            ...
            let O = 2,
                ...
                h = () => {
                    ...
                    if (null != t) {
                        for (let [e, n] of t)
                            if (S.default.isMember(e) && !g.has(e)) {
            ...
            var F = new b(o.default, {
                BACKGROUND_SYNC: () => {
                    R = null, N = new Map, g = new Map, O = 0
                },
                CONNECTION_OPEN: e => {
                    let {
                        guilds: t
                    } = e;
                    R = null, N = new Map, g = new Map, t.forEach(G), O = t.every(e => null != e.stickers) ? 1 : 0
                },
                ...
                LOGOUT: () => {
                    O = 0, C = [], N.clear(), p.clear(), R = null, g.clear(), g = new Map(g), U = !1, m = null
                },
                ...
                GUILD_STICKERS_UPDATE: e => {
                    ...
                    }, a = null !== (t = g.get(n)) && void 0 !== t ? t : [], r = a.filter(e => null == i.find(t => t.id === e.id));
                    r.forEach(e => {
        ...
        692986: function(e, t, n) {
            ...
            function O(e) {
                let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : I.MediaEngineContextTypes.DEFAULT,
                    ...
                    U = n ? null : (0, i.jsx)(a.MenuCheckboxItem, {
