            ...
            var a = n("37983"),
                ...
                f = e => {
                    let {
                        ...
                        success_node_id: N,
                        fail_node_id: p
                    } = n, [T, I] = l.useState(g), [S, j] = l.useState(void 0), [M, C] = l.useState(void 0), [b, y] = l.useState([]), [L, D] = l.useState(void 0), A = e => {
                        var n;
                        let {
                            destination: a
                        } = e, [, l] = a, r = R[l];
                        ...
                        if (y([...b, e]), null != r.key && (null == E || E(r.key)), j(void 0), C(void 0), t.name === d.ReportNames.MESSAGE || t.name === d.ReportNames.FIRST_DM) {
                            let e = t.record.id;
                        ...
                        j(null == l ? void 0 : null === (e = l.multiSelect) || void 0 === e ? void 0 : e.state), C(null == l ? void 0 : l.textInput), I(r), y(a), null == E || E("..")
                    }, k = [];
                    for (let e in R) {
                        var B, G;
                        let t = R[e];
                        if (t.id !== N && t.id !== p && t.id !== g && (k.push(t), (null === (B = t.button) || void 0 === B ? void 0 : B.type) === "next")) {
                    ...
                    return (0, a.jsx)(r.ModalRoot, {
                        ...
                        children: (0, a.jsx)(r.Slides, {
                            ...
                            activeSlide: T,
                            centered: !1,
                            children: P.map(e => (0, a.jsx)(r.Slide, {
                                id: e.id,
