        ...
        125667: function(e, t, s) {
            ...
            class z extends a.PureComponent {
                ...
                render() {
                    ...
                    let {
                        ...
                        rateLimitPerUser: T
                    } = m, N = O.default.getCurrentUser(), E = I.default.getGuild(t), _ = T > 0, M = p ? [] : u(r).keys().filter(e => e !== (null == N ? void 0 : N.id)).reject(A.default.isBlocked).map(e => O.default.getUser(e)).filter(b.isNotNullish).map(e => D.default.getName(t, this.props.channel.id, e)).value();
            ...
            function W(e) {
                let {
                    ...
                    ...a
                } = e, l = (0, f.useStateFromStores)([M.default], () => M.default.findActivity(e => null != e.application_id)), i = (0, f.useStateFromStores)([x.default, N.default], () => x.default.getUserCombo(N.default.getId(), t.id)), r = (0, f.useStateFromStores)([T.default, E.default], () => (0, S.default)(t, l, T.default, E.default)), u = (0, f.useStateFromStores)([j.default], () => j.default.getSlowmodeCooldownGuess(t.id, s ? j.SlowmodeType.CreateThread : j.SlowmodeType.SendMessage)), o = (0, f.useStateFromStores)([_.default], () => s ? _.default.can(P.Permissions.MANAGE_THREADS, t) : _.default.can(P.Permissions.MANAGE_CHANNELS, t) || _.default.can(P.Permissions.MANAGE_MESSAGES, t)), d = {
                    ...a,
        ...
        152637: function(e, t, s) {
            ...
            let eu = a.memo(function(e) {
                let {
                    ...
                    hasMediaAttachment: l,
                    hasUnreads: r
                } = e, u = (0, h.useStateFromStores)([O.default], () => null != t && O.default.isBlocked(t.author.id)), o = (0, h.useStateFromStores)([z.default], () => z.default.isLoading(s.id)), d = (0, h.useStateFromStores)([F.default], () => F.default.can(J.Permissions.MANAGE_MESSAGES, s)), c = A.RenderSpoilers.useSetting(), f = null;
