    ...
    ["78995"], {
        ...
        888503: function(e, t, l) {
            ...
            var L = function(e) {
                let {
                    ...
                    tabIndex: X,
                    itemProps: Q
                } = e, $ = S.default.useName(_), [ee, et] = r.useState(!1), [el, ea] = r.useState(null), {
                    ...
                    let e = (null == _ ? void 0 : _.isClyde()) ? j.BotTagTypes.AI : j.BotTagTypes.BOT;
                    return null != _ && _.bot ? (0, a.jsx)(m.default, {
                        className: C.botTag,
                        type: e,
                ...
                return null == _ ? (0, a.jsx)(p.default, {
                    ...
                    subText: (() => {
                        let e = null != P ? P.find(e => e.type === g.ActivityTypes.CUSTOM_STATUS) : null,
                            t = null != e && null != _ && (0, d.default)(e, _, k);
        ...
        643306: function(e, t, l) {
            ...
            function _(e) {
                ...
                return !w || P || null == s || null == _ || null == r && "@everyone" !== p ? U() : (0, a.jsx)(d.Popout, {
                    preload: async () => {
                        null != r && await (0, h.requestMembersForRole)(_, r)
                    },
                    renderPopout: e => {
                        let t = I.default.getChannel(s),
                            n = E.default.getGuild(_),
        ...
        470648: function(e, t, l) {
            ...
            function j(e) {
                let {
                    ...
                    channelId: j,
                    inlinePreview: T = !1
                } = e, N = (0, i.useStateFromStores)([x.default], () => x.default.getUser(r)), C = (0, i.useStateFromStores)([m.default], () => m.default.getChannel(j)), A = null != C ? C.getGuildId() : null, L = T || null == N || null == A || null == j ? void 0 : e => {
                ...
                }, R = E.default.useName(N), _ = (0, i.useStateFromStores)([m.default, p.default, v.default], () => S.default.getNickname(A, j, N)), M = h.default.getGuild(A), P = (0, d.useClydeEnabled)(M, C), y = P && r === g.CLYDE_AI_USER_ID ? g.CLYDE_AI_MENTION_COLOR : null, b = e => (0, a.jsx)(I.default, {
                    className: t,
                    onContextMenu: L,
                    color: y,
                    ...e,
                    children: "@".concat(null != _ ? _ : R)
                });
