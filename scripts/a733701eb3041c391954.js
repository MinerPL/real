    ...
    ["15763"], {
        ...
        298843: function(e, t, n) {
            ...
            function v(e) {
                ...
                } = (0, o.useManageResourcePermissions)(null != R ? R : y), M = m(a), G = (0, u.useStateFromStores)([d.default], () => d.default.isLurking(L), [L]), U = a.entity_type === p.GuildScheduledEventEntityTypes.STAGE_INSTANCE, [w, x] = i.useState(U), [D, {
                    loading: P,
                    error: k
                }] = (0, C.default)();
                if (!M) return null;
