        ...
        641900: function(e, t, n) {
                    ...
                    switch (e.type) {
                        ...
                        case "oscillating-random":
                            ...
                            var d = R(e.minStart),
                                ...
                                _ = R(e.minDirection),
                                k = R(e.maxDirection);
                            return new y(new x(b(n.x, i.x), b(d.x, f.x), b(h.x, p.x), b(v.x, m.x), z(_.x, k.x), C(e.easingFunctions)[0]), new x(b(n.y, i.y), b(d.y, f.y), b(h.y, p.y), b(v.y, m.y), z(_.y, k.y), C(e.easingFunctions)[0]))
                    }
                }(p(p({}, e), {
                    valueType: "Vector2"
                }))
            ...
            var O = i.forwardRef(function(e, t) {
                var a = e.className,
                    ...
                    F = i.useCallback(function() {
                        ...
                        if (null != e) {
                            ...
                            if (null != t) {
                                t.clearRect(0, 0, e.width, e.height), null == v || v(t), E.current.forEach(function(n, i) {
                                    var r = n.confetti,
                                        a = n.spriteCanvas;
                                    r.update(o), r.draw(a, t), r.shouldDestroy(e, o) && E.current.delete(i)
                                }), null == y || y(t), E.current.size > 0 ? P.current = window.requestAnimationFrame(F) : (t.clearRect(0, 0, e.width, e.height), P.current = null);
                                var n = Date.now();
                ...
                i.useEffect(function() {
                    null != P.current && (window.cancelAnimationFrame(P.current), P.current = window.requestAnimationFrame(F))
                }, [F]);
                var D = i.useCallback(function(e, t) {
                    ...
                    M = i.useCallback(function(e, t, n, i, a) {
                        var o, u, l, d, f, h, v, y, R, O, E, P, S, V, F, M = (o = null !== (F = e.id) && void 0 !== F ? F : (0, r.v4)(), u = e, l = n, d = i, f = a, y = k((v = (h = u, p(p({
                            id: o
                        }, c), h))).size), O = (R = function(e, t) {
                            if (null != e) {
                        ...
                        }(null != d ? d : O, f, l), new s({
                            id: o,
                            position: k(v.position),
                            velocity: k(v.velocity),
                            rotation: (S = v.rotation, function(e) {
                                switch (e.type) {
                                    case "static":
                                        var t = _(e.value);
                                    ...
                                    case "oscillating-random":
                                        ...
                                        var d = _(e.minStart),
                                            ...
                                            R = _(e.minDirection),
                                            k = _(e.maxDirection);
                                        return new m(new x(b(n.x, i.x), b(d.x, f.x), b(h.x, p.x), b(v.x, y.x), z(R.x, k.x), C(e.easingFunctions)[0]), new x(b(n.y, i.y), b(d.y, f.y), b(h.y, p.y), b(v.y, y.y), z(R.y, k.y), C(e.easingFunctions)[0]), new x(b(n.z, i.z), b(d.z, f.z), b(h.z, p.z), b(v.z, y.z), z(R.z, k.z), C(e.easingFunctions)[0]))
                                }
                            }(p(p({}, S), {
                                valueType: "Vector3"
                            }))),
                            ...
                            size: y,
                            opacity: (V = v.opacity, function(e) {
                                switch (e.type) {
                                    case "static":
