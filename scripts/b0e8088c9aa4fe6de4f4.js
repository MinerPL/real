    ...
    ["71612"], {
        ...
        172858: function(e, t, n) {
            ...
            let r = l,
                ...
                s = [n("890450"), r, n("164654"), n("540346"), n("526094"), n("367469"), n("23933"), {
                    src: n("283397"),
                    colorize: !1
                }],
                u = 28,
        ...
        262099: function(e, t, n) {
            ...
            function b(e) {
                let {
                    ...
                    textValue: T,
                    richValue: g
                }, v] = l.useState((0, m.createState)(t.value)), [, A, O] = (0, o.useDrag)({
                    type: y,
                    item: {
                        rule: t,
                        index: r
            ...
            var U = function(e) {
                let {
                    ...
                    onSave: n,
                    onClose: r
                } = e, i = (0, _.default)(), s = (0, d.useStateFromStores)([M.default], () => M.default.getProps().guild), o = null == s ? void 0 : s.rulesChannelId, C = null == s ? void 0 : s.hasFeature(O.GuildFeatures.PREVIEW_ENABLED), m = (0, d.useStateFromStores)([I.default], () => null != o ? I.default.getChannel(o) : null), p = (0, d.useStateFromStores)([T.default], () => (null == s ? void 0 : s.id) != null ? T.default.getDefaultChannel(s.id) : null), [x, L] = l.useState((null == t ? void 0 : t.values) != null ? null == t ? void 0 : t.values.map(e => ({
                    id: u(),
                    value: e
                })) : [{
                    id: u(),
                    value: ""
                }]), [y, U] = l.useState(null), [D, B] = l.useState(null), [V, P] = l.useState(0), k = e => {
                    if (x.length !== N.MAX_NUM_RULES) {
                        if (null != e && "" === x[x.length - 1].value) {
                            let t = [...x];
                            t[x.length - 1].value = e, L(t), P(t.length - 1)
                        } else L([...x, {
                            id: u(),
                            value: null != e ? e : ""
                        }]), P(x.length)
                    ...
                    if (null != t && t !== a) {
                        let n = [...x];
                        n.splice(a, 1), n.splice(t, 0, e), L(n)
                    }
                    n ? null !== D && B(null) : t !== D && B(t)
                }, [D, x]), G = async () => {
                    null != y && U(null);
                    let e = x.map(e => e.value.trim()).filter(e => "" !== e);
                    if (0 === e.length) {
                        U(S.default.Messages.MEMBER_VERIFICATION_RULES_REQUIRED_ERROR);
                        return
                    }
                    let t = {
                    ...
                    try {
                        ...
                        U(e.getAnyErrorMessage())
                    }
                };
                if (null == s) return null;
                let X = x.length === N.MAX_NUM_RULES;
                return (0, a.jsx)(E.default, {
                    page: O.AnalyticsPages.GUILD_RULES_CREATE_MODAL,
                    children: (0, a.jsxs)(A.default, {
                        ...
                        children: [x.map((e, t) => (0, a.jsx)(b, {
                            ...
                            children: [(0, a.jsx)(g.default, {
                                height: 17,
                                width: 17,
                                color: (0, R.getColor)((0, c.isThemeDark)(i) ? O.Color.BLUE_345 : O.Color.BLUE_430)
                            }), (0, a.jsx)(f.Clickable, {
