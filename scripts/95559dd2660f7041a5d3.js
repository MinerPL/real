        ...
        747593: function(e, t, s) {
            ...
            class Z extends a.PureComponent {
                ...
                renderMute() {
                    ...
                    let {
                        ...
                        muteConfig: s,
                        guild: i
                    } = this.props, a = null !== (e = null == s ? void 0 : s.selected_time_window) && void 0 !== e ? e : P.MuteUntilSeconds.ALWAYS;
                        ...
                        children: [(0, l.jsx)(S.FormItem, {
                            ...
                            children: (0, l.jsx)(S.RadioGroup, {
                                ...
                                options: (e = i, [{
                                    ...
                                    value: V.UserNotificationSettings.ALL_MESSAGES,
                                    desc: null != e && e >= V.MAX_MEMBERS_NOTIFY_ALL_MESSAGES ? k.default.Messages.LARGE_GUILD_NOTIFY_ALL_MESSAGES_DESCRIPTION : null
                                }, {
                                    name: k.default.Messages.FORM_LABEL_ONLY_MENTIONS.format(),
                                    value: V.UserNotificationSettings.ONLY_MENTIONS
                                }, {
                                    name: k.default.Messages.FORM_LABEL_NOTHING,
                                    value: V.UserNotificationSettings.NO_MESSAGES
                                }])
                            })
                        ...
                        children: [(0, l.jsx)(S.FormSwitch, {
                            ...
                            onChange: e => {
                                N.default.updateGuildNotificationSettings(o, {
                                    [n.NOTIFY_HIGHLIGHTS]: e ? V.HighlightSettings.DISABLED : V.HighlightSettings.ENABLED
                                })
                            },
                            value: i || r === V.HighlightSettings.DISABLED,
                            disabled: i,
                            note: (0, l.jsxs)(l.Fragment, {
                                children: [(0, l.jsx)(S.Text, {
                                    ...
                                    children: (0, l.jsx)(S.Anchor, {
                                        href: B.default.getArticleURL(V.HelpdeskArticles.HIGHLIGHTS),
                ...
                renderOverrideSelect() {
                    let {
                        ...
                        return s.type !== V.ChannelTypes.GUILD_CATEGORY || null != t[s.id] && t[s.id].length > 0
                    }).map(e => {
                        let {
                            channel: t
                        } = e;
                        return {
                            value: t.id,
                            label: (0, p.computeChannelName)(t, w.default, b.default)
                        }
                    }).value();
                    return (0, l.jsxs)(S.FormItem, {
            ...
            function K(e) {
                let {
                    guildId: t,
                    ...s
                } = e, i = (0, _.useGuildUnreadsExperiment)(), n = (0, M.useIsNotificationRedesignEnabled)(), a = (0, f.useStateFromStoresObject)([A.default, j.default, U.default, H.default], () => {
                    ...
                    return {
                        ...
                        channels: (0, m.default)(e._categories, e, e => {
                            ...
                            return (0, L.isGuildSelectableChannelType)(t) || t === V.ChannelTypes.GUILD_CATEGORY
                        }),
            ...
            let a = e => {
                ...
                return (0, i.jsx)("svg", {
                    ...
                    children: (0, i.jsx)("path", {
                        fill: "string" == typeof a ? a : a.css,
                        fillRule: "evenodd",
                        d: "M1.293 21.293a1 1 0 1 0 1.414 1.414l20-20a1 1 0 0 0-1.414-1.414l-20 20Zm1.839-5.164c.108.271.453.286.66.08l11.94-11.94a.47.47 0 0 0-.072-.737 6.967 6.967 0 0 0-1.353-.643.623.623 0 0 1-.381-.43 2 2 0 0 0-3.852 0 .623.623 0 0 1-.38.43A7.003 7.003 0 0 0 5 9.5v2.086a.5.5 0 0 1-.128.334L3.77 13.144A3 3 0 0 0 3 15.151v.279c0 .244.045.482.132.7Zm15.51-6.77c.133-.134.358-.048.358.141v2.086a.5.5 0 0 0 .128.334l1.102 1.224a3 3 0 0 1 .77 2.007v.279c0 .668-.336 1.29-.946 1.564-1.315.593-4 1.506-8.054 1.506-.461 0-.905-.012-1.33-.034a.481.481 0 0 1-.309-.828l8.28-8.28ZM9.18 19.844A.16.16 0 0 0 9 20a3 3 0 1 0 6 0 .16.16 0 0 0-.18-.156c-.852.097-1.792.156-2.82.156a24.86 24.86 0 0 1-2.82-.156Z",
                        clipRule: "evenodd",
                        className: r
                    })
                })
        ...
        819666: function(e, t, s) {
            ...
            function x(e) {
                let {
                    ...
                    categories: h
                } = e, [N, x] = n.useState(new Set((0, m.filterOverrides)(t))), O = e => {
                    let t = new Set(N);
                    t.delete(e), x(t)
                    ...
                    let l = t[n.id];
                    return (0, i.jsx)(p.ChannelNotificationSettings, {
                        channel: n,
                        guildMuted: s,
                ...
                return (0 === N.size || 0 === L.length) && L.push((0, i.jsx)("div", {
                    className: _.overridePlaceholder,
                    children: (0, i.jsx)(o.Text, {
                        className: _.overrideHeader,
                        variant: "text-sm/semibold",
                        children: v.default.Messages.ADD_CHANNEL_TO_OVERRIDE
                    })
                }, "placeholder")), (0, i.jsxs)("div", {
                    className: _.container,
                    children: [(0, i.jsxs)(o.FormItem, {
                        title: v.default.Messages.NOTIFICATION_OVERRIDES,
                        className: _.largeSpacing,
                        children: [(0, i.jsx)(o.FormText, {
                            type: o.FormText.Types.DESCRIPTION,
                            className: _.smallSpacing,
                            children: v.default.Messages.ADD_CHANNEL_TO_OVERRIDE
                        }), (0, i.jsx)(o.SearchableSelect, {
                            value: "",
                            placeholder: v.default.Messages.SELECT_CHANNEL_OR_CATEGORY,
                            renderOptionLabel: M,
                            options: I,
                            onChange: e => {
                                if (null == e) return;
                        ...
                        className: _.overrideList,
                        children: [(0, i.jsxs)(S.default, {
                            children: [(0, i.jsx)(o.Heading, {
                                variant: "eyebrow",
                                className: _.headerName,
                                children: v.default.Messages.CHANNEL_OR_CATEGORY
                            }), (0, i.jsx)(o.Heading, {
                                variant: "eyebrow",
                                className: _.headerOption,
                                children: v.default.Messages.FORM_LABEL_ALL
                            }), (0, i.jsx)(o.Heading, {
                                variant: "eyebrow",
                                className: _.headerOption,
                                children: v.default.Messages.FORM_LABEL_MENTIONS
                            }), (0, i.jsx)(o.Heading, {
                                variant: "eyebrow",
                                className: _.headerOption,
                                children: v.default.Messages.FORM_LABEL_NOTHING
                            }), (0, i.jsx)(o.Heading, {
                                variant: "eyebrow",
                                className: _.headerOption,
                                children: (0, i.jsx)(o.Tooltip, {
                                    text: v.default.Messages.FORM_LABEL_MUTE_SERVER_DESCRIPTION,
                                    position: "bottom",
                                    children: e => (0, i.jsx)("span", {
                                        ...e,
                                        children: v.default.Messages.SOUND_MUTE
                                    })
                                })
                            })]
                        }), L]
        ...
        184488: function(e, t, s) {
            ...
            let v = e => {
                ...
                return (0, i.jsxs)(a.ModalRoot, {
                    className: C.modal,
                    "aria-label": p.default.Messages.NOTIFICATION_SETTINGS,
                    ...
                    children: [(0, i.jsxs)(a.ModalHeader, {
                        children: [(0, i.jsxs)(g.default.Child, {
                            children: [(0, i.jsx)(a.Heading, {
                                variant: "heading-lg/semibold",
                                children: p.default.Messages.NOTIFICATION_SETTINGS
                            }), (0, i.jsx)(a.Text, {
                        ...
                        children: [(0, i.jsxs)(a.TabBar, {
                            ...
                            children: [(0, i.jsx)(a.TabBar.Item, {
                                ...
                                children: p.default.Messages.SERVER_NOTIFICATIONS_TAB
                            }, "SERVER_NOTIFICATIONS"), (0, i.jsx)(a.TabBar.Item, {
                                className: C.tabBarItem,
                                id: "CHANNEL_OVERRIDES",
                                children: p.default.Messages.CHANNEL_OVERRIDES_TAB
                            }, "CHANNEL_OVERRIDES")]
                        }), t]
                    })]
                })
                ...
                let {
                    ...
                    return {
                        ...
                        channels: (0, r.default)(e._categories, e, e => {
                            ...
                            return (0, d.isGuildSelectableChannelType)(t) || t === m.ChannelTypes.GUILD_CATEGORY
                        }),
        ...
        954419: function(e, t, s) {
            ...
            class S extends a.Component {
                ...
                render() {
                    ...
                    null != N && (T.autoFocus = N), null != E && (T.isDisabled = E), null != m && (T.isClearable = m), null != p && (T.isSearchable = p);
                    let I = {
                    ...
                    return (0, l.jsx)(u.FocusRing, {
                        ...
                        children: (0, l.jsxs)("div", {
                            ...
                            children: [(0, l.jsx)(d.default, {
                                ...
                                placeholder: null != _ ? _ : h.default.Messages.SELECT,
