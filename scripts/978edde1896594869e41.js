(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["37427"], {
        ...
        549869: function(e, t, n) {
            ...
            var eh = u.default.connectStores([S.default, L.default, v.default, C.default, N.default], e => {
                var t, n, s;
                let {
                    match: l,
                    location: a
        ...
        679030: function(e, t, n) {
            ...
            class P extends i.PureComponent {
                ...
                render() {
                    ...
                    if (e === O.NativeAppStates.OPEN && !c) return this.renderAppOpened();
                    ...
                    switch (e.state) {
                        ...
                        case x.GuildTemplateStates.RESOLVED:
                            ...
                            if (this.props.login) return (0, s.jsx)(S.default, {
                                ...
                                location: a,
                                onRegister: () => {
                                    (0, p.setNewUser)(R.NewUserTypes.ORGANIC_REGISTERED_GUILD_TEMPLATE), N.default.flowStart(O.FlowType.ORGANIC_GUILD_TEMPLATES, O.RegistrationSteps.NUF_STARTED)
                                }
                            });
                ...
                render() {
                    ...
                    switch (e.state) {
                        ...
                        case G.InviteStates.RESOLVED:
                            var i;
                            if (n && (0, R.hasFlag)(null !== (i = e.flags) && void 0 !== i ? i : 0, r.GuildInviteFlags.IS_GUEST_INVITE)) return c.default.openApp(e.code), d.default.set(N.GUEST_INVITE_KEY, e.code), this.renderAppOpened(() => l(G.Routes.APP));
        ...
        759315: function(e, t, n) {
            ...
            var s = n("37983"),
                ...
                h = n("926622"),
                N = () => {
                    let [e, t] = l.useState(""), [a, N] = l.useState(""), [T, m] = l.useState(!1), [g, A] = l.useState(!1), [S, C] = l.useState(null), [v, L] = l.useState(null), x = (0, r.useStateFromStores)([d.default], () => d.default.getCountryCode()), R = x.code.split(" ")[0], O = async () => {
                        try {
                        ...
                        try {
                            let {
                                token: t
                            } = await u.default.verifyPhone(R + e, a);
                            C(null), L(null), A(!0), u.default.validatePhoneForSupport(t)
                        } catch (e) {
                            e.body.message ? (C(null), L(e.body.message)) : (C(e.body.phone), L(e.body.code))
                        } finally {
                            m(!1)
                        }
            ...
            let D = (e, t) => n => {
                ...
                j = (e, t) => {
                    switch (null == e ? void 0 : e.entity_type) {
                        case R.GuildScheduledEventEntityTypes.STAGE_INSTANCE:
                            return P(e, t);
                        case R.GuildScheduledEventEntityTypes.VOICE:
                            return D(e, t)
                    }
                    return () => {}
                },
                U = (e, t) => t && [R.GuildScheduledEventEntityTypes.STAGE_INSTANCE, R.GuildScheduledEventEntityTypes.VOICE].includes(null == e ? void 0 : e.entity_type),
                G = l.memo(function(e) {
                    var t;
                    let {
                        guild: n,
                ...
                B = l.memo(function(e) {
                    ...
                    return i ? l ? (0, s.jsx)(u.Button, {
                        ...
                        children: o ? O.default.Messages.GUILD_SCHEDULED_EVENT_VIEW_DETAIL : O.default.Messages.JOIN_GUILD
                    }) : a ? (0, s.jsx)(u.Button, {
                        className: M.button,
                        size: u.Button.Sizes.SMALL,
                        disabled: !0,
                        ...
                        children: O.default.Messages.GUILD_EVENT_INVITE_COMPLETED
                    }) : (0, s.jsxs)(u.Button, {
                        className: M.button,
                        ...
                        children: [f ? (0, s.jsx)(N.default, {
                            ...
                            height: 16,
                            className: M.buttonIcon
                        }), O.default.Messages.INDICATE_RSVP]
                    }) : (0, s.jsx)(u.Button, {
                        className: M.button,
                        size: u.Button.Sizes.SMALL,
                        onClick: E,
                        color: u.Button.Colors.GREEN,
                        children: O.default.Messages.JOIN_GUILD
                    })
                }),
                y = l.memo(function(e) {
                    var t;
                    ...
                    } = e, E = (0, S.default)(n), I = l.useCallback(() => {
                    ...
                    let _ = (0, m.isGuildScheduledEventActive)(n),
                        ...
                        N = n.entity_type === R.GuildScheduledEventEntityTypes.EXTERNAL;
        ...
        800118: function(e, t, n) {
            ...
            let T = 100,
                ...
                x = e => !L(e) && (!!S(e) || null != e.inviter && !v(e) && !C(e)),
                R = e => {
                    let {
                        guild: t,
                        user: n,
        ...
        701662: function(e, t, n) {
            ...
            function P(e) {
                ...
                let n = e => {
                    if (null == t) return null;
                    if (e === l.DETAILS) return (0, a.jsx)(C.GuildInfoCard, {
                        invite: t
                    });
                    return null
                };
