(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["23862"], {
        ...
        944305: function(e, t, l) {
            ...
            function A() {
                return [L(), v(E.BoostedGuildTiers.TIER_2), O(), w()]
            }

            function B() {
                return [v(E.BoostedGuildTiers.TIER_3, s.default.unsafe_rawColors.PREMIUM_PERK_GREEN.css), N(), h(), w()]
            }

            function G() {
                return [h(), C(), v(E.BoostedGuildTiers.TIER_3), w()]
            }
        ...
        379532: function(e, t, l) {
            ...
            function i(e, t) {
                let i = null != t ? t : "".concat(c.AnalyticsSections.PREMIUM_GUILD_UPSELL_MODAL);
                null != e.targetBoostedGuildTier && (i += " - Tier ".concat(e.targetBoostedGuildTier));
                o.default.track(c.AnalyticEvents.OPEN_MODAL, {
                    type: i,
                ...
                let {
                    ...
                    ...d
                } = e, f = a.default.getWindowOpen(c.PopoutWindowKeys.CHANNEL_CALL_POPOUT) && null != u && u;
                f && (0, r.default)(c.PopoutWindowKeys.CHANNEL_CALL_POPOUT);
                let _ = f ? n.POPOUT_MODAL_CONTEXT : n.DEFAULT_MODAL_CONTEXT;
                (0, n.openModalLazy)(async () => {
                    let {
                        default: e
                    } = await l.el("874642").then(l.bind(l, "874642"));
                    return t => (0, s.jsx)(e, {
                        ...d,
                        ...t
                    })
