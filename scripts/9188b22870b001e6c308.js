    ...
    ["25576"], {
        ...
        169626: function(e, t, n) {
            ...
            function O(e) {
                ...
                let y = r.useCallback(e => {
                    ...
                    w = r.useCallback(e => {
                        P(e), L(S.CreateGuildSlideTypes.CUSTOMIZE_GUILD)
                    }, []),
        ...
        110337: function(e, t, n) {
            ...
            let D = (i = window.GLOBAL_ENV.INVITE_HOST, r = "", null == i && (i = location.host, r = T.Routes.INVITE("")), "".concat(location.protocol, "//").concat(i).concat(r, "/")),
                L = [p, "".concat(D).concat(p), "".concat(D).concat("cool-people")],
                h = e => {
                    let {
                        onClick: t
                    } = e;
            ...
            function m(e) {
                let {
                    ...
                    onClose: n,
                    isSlideReady: i
                } = e, [r, u] = a.useState(""), [E, I] = a.useState(!1), [T, A] = a.useState(null), O = a.useRef(null);
                a.useEffect(() => {
                    var e;
        ...
        364685: function(e, t, n) {
            ...
            var F = new w(u.default, {
                BACKGROUND_SYNC: () => {
                    C = null, p = new Map, m = new Map, A = 0
                },
                CONNECTION_OPEN: e => {
                    let {
                        guilds: t
                    } = e;
                    C = null, p = new Map, m = new Map, t.forEach(y), A = t.every(e => null != e.stickers) ? 1 : 0
                },
                ...
                LOGOUT: () => {
                    A = 0, D = [], p.clear(), O.clear(), C = null, m.clear(), m = new Map(m), h = !1, L = null
                },
