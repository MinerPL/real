    ...
    ["56826"], {
        ...
        145079: function(e, t, n) {
            ...
            var E = e => {
                let {
                    ...
                    forcePomelo: f,
                    ...h
                } = e, E = (0, i.useStateFromStores)([u.default], () => u.default.hidePersonalInformation), _ = E || t || n.isNonUserBot(), I = n.toString(), T = c.default.getName(n), C = a ? I : null != l ? l : T, v = n.isPomelo() || f;
                if (v || C !== I) {
                    let e = C === I && v && a ? c.default.getUserTag(n, {
                            forcePomelo: f
                        }) : C,
            ...
            function y(e, t) {
                switch (e.type) {
                    ...
                    case x.ChannelTypes.GUILD_FORUM:
                        ...
                        if ((0, L.default)(e)) return y ? E.default : f.default;
        ...
        50926: function(e, t, n) {
            ...
            let f = async (e, t) => {
                let n = null != t ? t : o.default.getInviteKeyForGuildId(e),
                    ...
                    i = !u.default.isMember(e, null == a ? void 0 : a.id);
                try {
        ...
        394294: function(e, t, n) {
            ...
            let a = new Set([l.VerificationFormFieldTypes.TERMS]),
                i = new Set([l.VerificationFormFieldTypes.MULTIPLE_CHOICE, l.VerificationFormFieldTypes.TEXT_INPUT, l.VerificationFormFieldTypes.PARAGRAPH]),
                s = 5,
                u = 16,
                o = 300,
                d = 300,
        ...
        453265: function(e, t, n) {
            ...
            var l = n("551042"),
                ...
                o = n("49111");
            let d = () => {
                    a.default.track(o.AnalyticEvents.MODAL_DISMISSED, {
        ...
        650484: function(e, t, n) {
            ...
            function m(e) {
                ...
                let M = null !== (o = null == S ? void 0 : null === (t = S.options) || void 0 === t ? void 0 : t.hideSlider) && void 0 !== o && o,
                    ...
                    N = void 0 !== p && p ? h.sliderBodyLarge : null == S ? void 0 : null === (a = S.options) || void 0 === a ? void 0 : a.sliderBodyClassName;
                return (0, r.jsxs)(r.Fragment, {
                    children: [null === (d = null == S ? void 0 : null === (s = S.options) || void 0 === s ? void 0 : s.renderHeader) || void 0 === d || d ? m : null, S.renderStep(E), null == _ || M ? null : (0, r.jsxs)(r.Fragment, {
        ...
        707443: function(e, t, n) {
            ...
            function g(e, t, n) {
                let {
                    ...
                    o.default.can(I.Permissions.READ_MESSAGE_HISTORY, e) && E.default.loadArchivedThreads(e.guild_id, e.id, t, n, c)
                }, [e, t, n, c]);
                r.useEffect(() => {
                    f && h()
        ...
        442184: function(e, t, n) {
            ...
            function N(e) {
                let {
                    channel: t
                } = e, n = (0, a.useStateFromStores)([C.default], () => C.default.getMostRecentMessage(t.id));
            ...
            function L(e) {
                ...
                let f = (0, a.useStateFromStores)([p.default], () => null !== (t = p.default.getUser(o.author.id)) && void 0 !== t ? t : o.author),
                    ...
                    T = (0, a.useStateFromStores)([m.default], () => m.default.isBlocked(o.author.id)),
                    C = l.useMemo(() => {
            ...
            function x(e) {
                ...
                let {
                    channel: d
                } = e, c = (0, a.useStateFromStores)([h.default], () => h.default.lastMessageId(d.id)), m = null == c ? new Date(null !== (n = null === (t = d.threadMetadata) || void 0 === t ? void 0 : t.archiveTimestamp) && void 0 !== n ? n : Date.now()).getTime() : I.default.extractTimestamp(c);
                (0, u.useSubscribeGuildMembers)({
                    [d.guild_id]: [d.ownerId]
                });
                let _ = (0, a.useStateFromStores)([p.default], () => p.default.getUser(d.ownerId)),
                    C = (0, a.useStateFromStores)([f.default], () => f.default.getMember(d.guild_id, d.ownerId)),
                    g = null !== (l = (0, o.default)(d)) && void 0 !== l ? l : E.default;
                        ...
                        children: [(0, r.jsx)(s.default, {
                            ...
                            authorHook(e, t) {
                                ...
                                return (0, r.jsx)(i.NameWithRole, {
                                    ...
                                    name: null !== (l = null == C ? void 0 : C.nick) && void 0 !== l ? l : T.default.getName(_)
                                }, t)
                            }
                        }), (0, r.jsx)("span", {
                            className: M.bullet,
        ...
        967241: function(e, t, n) {
            ...
            function S(e, t, n) {
                l(!e.isForumLikeChannel(), "cannot open thread creation sidebar in forums"), l(!__OVERLAY__, "Cannot create threads in the overlay."), (0, d.trackWithMetadata)(C.AnalyticEvents.THREAD_CREATION_STARTED, {
                    location: n,
                    channel_id: e.id,
                    guild_id: e.guild_id
                }), o.MainWindowDispatch.dispatch(C.ComponentActions.POPOUT_CLOSE), E.default.getChannelId() !== e.id && (0, h.transitionToChannel)(e.id);
            ...
            let c = e => {
                ...
                switch (l) {
                    ...
                    case u.BotTagTypes.OFFICIAL:
                        f = !0, _ = o.default.Messages.DISCORD_SYSTEM_MESSAGE_BOT_TAG_TOOLTIP, E = o.default.Messages.SYSTEM_DM_TAG_SYSTEM;
                        break;
                    case u.BotTagTypes.SERVER:
                        E = o.default.Messages.BOT_TAG_SERVER;
                        break;
                    case u.BotTagTypes.ORIGINAL_POSTER:
                        E = o.default.Messages.BOT_TAG_FORUM_ORIGINAL_POSTER;
                        break;
                    case u.BotTagTypes.STAFF_ONLY_DM:
                        E = o.default.Messages.STAFF_BADGE_TOOLTIP;
                        break;
                    case u.BotTagTypes.AI:
                        f = !0, _ = o.default.Messages.AI_GENERATED_TOOLTIP, E = o.default.Messages.AI_TAG;
                        break;
                    case u.BotTagTypes.REMIX:
                        f = !1, E = o.default.Messages.REMIXING_TAG;
                        break;
                    case u.BotTagTypes.BOT:
                    default:
                        E = o.default.Messages.BOT_TAG_BOT
                }
                let I = l === u.BotTagTypes.ORIGINAL_POSTER,
                    T = l === u.BotTagTypes.REMIX,
                    C = null;
                ...
                let v = e => (0, r.jsxs)("span", {
                    ...e,
                    className: a(c, t, m ? d.rem : d.px, {
                        [d.botTagOP]: I,
                        [d.botTagRemix]: T
                    }),
                    children: [h ? null : C, p, (0, r.jsx)("span", {
                        className: d.botText,
                        children: E
                    })]
                });
                ...
                renderUsers() {
                    ...
                    for (; o < s && o < e.length;) {
                        ...
                        i.push(t ? (0, r.jsx)("div", {
                            ...
                            children: s
                        }, T(null !== (d = e[o]) && void 0 !== d ? d : null, o)) : (0, r.jsx)(E.default, {
