        ...
        218525: function(e, t, n) {
            ...
            function C(e) {
                let {
                    text: t = "",
                    target: n
                } = e, C = (0, u.useStateFromStores)([i.default], () => i.default.isEnabled()), L = (0, u.useStateFromStores)([i.default], () => i.default.hasLearnedWord(t), [t]), p = a.useRef({
                    ...e,
                    spellcheckEnabled: C
                });
                p.current = {
                ...
                if (a.useEffect(() => {
                        ...
                        g()
                    }, [t, C, g]), !(0, d.isSupported)()) return [null, null];
                let _ = h.map((e, t) => (0, l.jsx)(r.MenuItem, {
                    ...
                    x = (0, l.jsxs)(l.Fragment, {
                        children: [M ? (0, l.jsx)(r.MenuItem, {
                            id: "add-to-dictionary",
                            label: E.default.Messages.ADD_TO_DICTIONARY,
                            action: () => {
                                (0, c.learnWord)(t), T()
                            }
                        }) : null, L && (0, l.jsx)(r.MenuItem, {
