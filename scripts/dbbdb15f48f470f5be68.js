        ...
        3958: function(e, t, n) {
            ...
            class S extends u.PureComponent {
                ...
                componentDidUpdate(e) {
                    ...
                    t === i.DEFAULT && s.current === a && s.current.blur(), t === i.RECORDING && s.current !== a && s.current.focus()
                }
                render() {
                    let e;
                    let {
                    ...
                    e = t === i.RECORDING ? h.default.Messages.SHORTCUT_RECORDER_BUTTON_RECORDING : 0 === n.length ? h.default.Messages.SHORTCUT_RECORDER_BUTTON : h.default.Messages.SHORTCUT_RECORDER_BUTTON_EDIT;
                    let o = t === i.DEFAULT && n.length > 0;
                            ...
                            children: (0, a.jsxs)(m.default, {
                                ...
                                children: [(0, a.jsx)(m.default.Child, {
                                    ...
                                    children: (0, a.jsx)("input", {
                                        ...
                                        readOnly: !0,
                                        value: u,
                                        disabled: this.props.mode !== i.RECORDING || s
                                    })
                                }), (0, a.jsx)(m.default, {
                                    shrink: 1,
                                    grow: 0,
                ...
                constructor(...e) {
                    super(...e), this._inputId = p.uniqueId("key-recorder-"), this._unregisterNativeRecorder = null, this._mousedownMode = null, this._inputRef = u.createRef(), this._containerRef = u.createRef(), this.setInputRef = e => {
                        ...
                        (!n || this._mousedownMode !== i.RECORDING) && t()
