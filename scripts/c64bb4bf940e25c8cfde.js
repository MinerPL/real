    ...
    ["38917"], {
        483800: function(e, n, t) {
            ...
            var r = {
                ...
                a = function(e, n, t) {
                    var a, o, u = r[e];
                    a = "other" === u.type ? u.other : 1 === n ? u.one : n > 1 && n < 5 ? u.few : u.many;
                    var d = (null == t ? void 0 : t.addSuffix) === !0,
                        i = null == t ? void 0 : t.comparison;
                    return (o = d && -1 === i ? a.past : d && 1 === i ? a.future : a.regular).replace("{{count}}", String(n))
                }
        },
        572582: function(e, n, t) {
            "use strict";
            t.r(n), t.d(n, {
                default: function() {
                    return a
