            ...
            var a = r("77078"),
                ...
                i = e => {
                    let {
                        ...
                        helpCenterLink: s.default.getArticleURL(o.HelpdeskArticles.LOCALIZED_PRICING)
                    };
                    return (0, n.jsx)(a.ConfirmModal, {
                        ...
                        children: (0, n.jsx)(a.Text, {
                            ...
                            children: l.default.Messages.LOCALIZED_PRICING_ON_CHANGE_PAYMENT_METHOD.format(u)
                        })
                    })
                }
        }
