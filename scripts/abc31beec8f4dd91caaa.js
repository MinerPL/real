                    ...
                    super(...e), this.state = {
                        ...
                        return (0, a.jsxs)("div", {
                            ...
                            children: [(0, a.jsx)("img", {
                                ...
                                draggable: !1
                            }), e.type === E.CarouselMediaTypes.YOUTUBE_VIDEO || e.type === E.CarouselMediaTypes.VIDEO ? (0, a.jsx)(y, {}) : null, s ? (0, a.jsx)("div", {
        ...
        180612: function(e, t, n) {
            ...
            let x = e => {
                ...
                L = e => {
                    ...
                    if (i.type === f.CarouselMediaTypes.YOUTUBE_VIDEO) t = {
                        url: (0, f.YOUTUBE_PREVIEW_URL)(i.youtubeVideoId),
                        ...v
                    }, n = {
                        url: "".concat((0, f.YOUTUBE_EMBED_URL)(i.youtubeVideoId), "?").concat("rel=0&iv_load_policy=3&showinfo=0&modestbranding=1"),
                        ...N
            ...
            class S extends a.PureComponent {
                componentDidMount() {
                    ...
                    e.length > 0 && e[0].type === f.CarouselMediaTypes.IMG && this.setState({
                ...
                constructor(...e) {
                    super(...e), this.state = {
                        ...
                        this.setState({
                            isVideoPlaying: !1
                        }), e.type === f.CarouselMediaTypes.IMG && this.setState({
