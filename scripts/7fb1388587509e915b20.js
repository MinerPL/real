    ...
    ["59423"], {
        ...
        354023: function(e, t, n) {
            ...
            var I, s, l = n("191225"),
                ...
                N = n("91366"),
                O = n("782340");
            u = n("591205"), (I = s || (s = {})).GROUP_DM = "GROUP_DM", I.DM = "DM", I.FRIEND = "FRIEND", I.CHANNEL = "CHANNEL";
            let d = (e, t) => null != e && i.default.isMember(e, t),
                o = e => {
                    ...
                    if (null != n)
                        for (let e of n) {
                            ...
                            !(null == n || d(I, n.id)) && (l.add(n.id), a.push({
                                type: s.FRIEND,
                                item: n,
                                isSuggested: !0
                            }), i.numFriends++)
                ...
                M = e => {
                    ...
                    for (let e of T.default.getPrivateChannelIds()) {
                        if (null != n && n > 0 && l.length >= n || null != E && N >= E) break;
                        let T = a.default.getChannel(e);
                        if (null == T || !T.isPrivate()) continue;
                        if (_ && T.type === f.ChannelTypes.GROUP_DM) {
                            l.push({
                                type: s.GROUP_DM,
                                item: T,
                                isSuggested: !1
                        ...
                        let O = r.default.lastMessageId(T.id);
                        if (null == O) continue;
                ...
                P = e => {
                    ...
                    E.default.queryDMUsers({
                        ...
                        let i = a.default.getDMFromUserId(t.id);
                        if (null == i) return;
                        let _ = r.default.lastMessageId(i);
                        null != _ && (u.add(t.id), I.push({
                            type: s.DM,
                            item: t,
                            isSuggested: !1
                        }), l.numDms++)
