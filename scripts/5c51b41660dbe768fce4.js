        ...
        641900: function(t, e, n) {
                    ...
                    switch (t.type) {
                        ...
                        case "oscillating-random":
                            ...
                            var f = x(t.minStart),
                                ...
                                E = x(t.minDirection),
                                b = x(t.maxDirection);
                            return new y(new S(w(n.x, r.x), w(f.x, h.x), w(d.x, p.x), w(v.x, g.x), M(E.x, b.x), A(t.easingFunctions)[0]), new S(w(n.y, r.y), w(f.y, h.y), w(d.y, p.y), w(v.y, g.y), M(E.y, b.y), A(t.easingFunctions)[0]))
                    }
                }(p(p({}, t), {
                    valueType: "Vector2"
                }))
            ...
            var T = r.forwardRef(function(t, e) {
                    ...
                    N = r.useCallback(function() {
                        ...
                        if (null != t) {
                            ...
                            if (null != e) {
                                ...
                                }), null == y || y(e), R.current.size > 0 ? I.current = window.requestAnimationFrame(N) : (e.clearRect(0, 0, t.width, t.height), I.current = null);
                                var n = Date.now();
                                0 !== G.current && (L.current = 1e3 / (n - G.current)), G.current = n
                            }
                        }
                    }, [a, y, v]);
                r.useEffect(function() {
                    null != I.current && (window.cancelAnimationFrame(I.current), I.current = window.requestAnimationFrame(N))
                }, [N]);
                var B = r.useCallback(function(t, e) {
                        R.current.set(t.id, {
                            confetti: t,
                            spriteCanvas: e
                        }), null == I.current && N()
                    ...
                    O = r.useCallback(function(t, e, n, r, o) {
                        var a, u, c, f, h, d, v, y, x, T, R, I, G, L, N, O = (a = null !== (N = t.id) && void 0 !== N ? N : (0, i.v4)(), u = t, c = n, f = r, h = o, y = b((v = (d = u, p(p({
                            id: a
                        }, s), d))).size), T = (x = function(t, e) {
                            if (null != t) {
                        ...
                        }(null != f ? f : T, h, c), new l({
                            id: a,
                            position: b(v.position),
                            velocity: b(v.velocity),
                            rotation: (G = v.rotation, function(t) {
                                switch (t.type) {
                                    case "static":
                                        var e = E(t.value);
                                    ...
                                    case "oscillating-random":
                                        ...
                                        var f = E(t.minStart),
                                            ...
                                            x = E(t.minDirection),
                                            b = E(t.maxDirection);
                                        return new g(new S(w(n.x, r.x), w(f.x, h.x), w(d.x, p.x), w(v.x, y.x), M(x.x, b.x), A(t.easingFunctions)[0]), new S(w(n.y, r.y), w(f.y, h.y), w(d.y, p.y), w(v.y, y.y), M(x.y, b.y), A(t.easingFunctions)[0]), new S(w(n.z, r.z), w(f.z, h.z), w(d.z, p.z), w(v.z, y.z), M(x.z, b.z), A(t.easingFunctions)[0]))
                                }
                            }(p(p({}, G), {
                                valueType: "Vector3"
                            }))),
                            dragCoefficient: b(v.dragCoefficient),
                            size: y,
                ...
                return r.useEffect(function() {
                    ...
                    return t("click", K, c), t("mousedown", V, f), t("mousemove", H, h), t("mouseup", j, d),
                        function() {
                ...
                }, [K, V, H, j, c, f, h, d]), r.useEffect(function() {
                    var t = T.current,
