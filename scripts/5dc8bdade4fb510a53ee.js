                ...
                return (function e(t, n, r) {
                        ...
                        v.initialize = function(e) {
                            ...
                            var n = this,
                                i = new Promise(function(t, i) {
                                    var o, a, d, u, p = !!("payment_methods/credit_cards" === e.endpoint && n.getConfiguration().gatewayConfiguration.creditCards.collectDeviceData);
                                    ...
                                    if (a = "api" in e ? e.api : "clientApi", u = {
                                        ...
                                        }, "clientApi" === a) d = n._clientApiBaseUrl, u.data = l(n._configuration, e.data);
                                    else if ("graphQLApi" === a) d = A[n._configuration.gatewayConfiguration.environment], e.endpoint = "", u.method = "post", u.data = h({
                                        clientSdkMetadata: {
                                    ...
                                    u.url = d + e.endpoint, u.sendAnalyticsEvent = function(e) {
                                        m.sendEvent(n, e)
                                        ...
                                        d = h({
                                            _httpStatus: o
                                        }, r), p && d.creditCards && d.creditCards.length > 0 && (n._findOrCreateFraudnetJSON(d.creditCards[0].nonce), N.loadScript({
                                            src: P,
                                            forceScriptReload: !0
                                        })), t(d)
                                    })
                            ...
                            getConfiguration: i(function(e) {
                                return new Promise(function(t, n) {
                                    ...
                                    i = e.attrs, _ = e.configUrl, i._meta = m, i.braintreeLibraryVersion = s.BRAINTREE_LIBRARY_VERSION, i.configVersion = "3", E = {
                                        ...
                                        method: "GET",
                                        data: i
                                    }, i.authorizationFingerprint && e.graphQL ? (l(e.graphQL.date, p) && (E.graphQL = new d({
                                        graphQL: {
                                            url: e.graphQL.url,
                                            features: ["configuration"]
                                        }
                                    })), E.metadata = m) : i.tokenizationKey && (E.graphQL = new d({
                                        graphQL: {
                                            url: u[e.environment],
                                            features: ["configuration"]
                                        }
                                        ...
                                        var s;
                                        if (e) {
                                            s = 403 === a ? c.CLIENT_AUTHORIZATION_INSUFFICIENT : 401 === a ? c.CLIENT_AUTHORIZATION_INVALID : c.CLIENT_GATEWAY_NETWORK, n(new r({
                                                type: s.type,
                                                code: s.code,
                                                message: s.message,
                                                details: {
                        ...
                        t.exports = {
                            request: function(e, t) {
                                ! function e(t, n, l) {
                                    ...
                                    }, t.headers), A = (E = O ? new d(t) : new u(t)).getUrl(), h = E.getBody(), m = E.getMethod(), f = E.getHeaders(), "GET" === m && (A = r.queryify(A, h), h = null), c ? N.onreadystatechange = function() {
                                        if (4 === N.readyState) {
                                            if (0 === N.status && O) {
                    ...
                    89: [function(e, t, n) {
                        ...
                        t.exports = function(e) {
                            ...
                            return {
                                ...
                                variables: (i = e, o = p, s = (a = i.creditCard) && a.billingAddress, c = a && a.expirationDate, d = a && (a.expirationMonth || c && c.split("/")[0].trim()), u = a && (a.expirationYear || c && c.split("/")[1].trim()), l = {
                                    input: {
                                        creditCard: {
                                            number: a && a.number,
                                            expirationMonth: d,
                    ...
                    91: [function(e, t, n) {
                        ...
                        function p(e) {
                            ...
                            }, this._sendAnalyticsEvent = e.sendAnalyticsEvent || Function.prototype, this._generator = u[t], this._adapter = l[t], this._sendAnalyticsEvent("graphql.init")
                        }
                        ...
                        d.cipher.aes = function(e) {
                            ...
                            G: function() {
                                ...
                                for (t = n = 0; !d[t]; t ^= r || 1, n = p[n] || 1)
                                    for (o = (o = n ^ n << 1 ^ n << 2 ^ n << 3 ^ n << 4) >> 8 ^ 255 & o ^ 99, d[t] = o, u[o] = t, a = 16843009 * (i = l[e = l[r = l[t]]]) ^ 65537 * e ^ 257 * r ^ 16843008 * t, i = 257 * l[o] ^ 16843008 * o, e = 0; 4 > e; e++) s[e][t] = i = i << 24 ^ i >>> 8, c[e][o] = a = a << 24 ^ a >>> 8;
                            ...
                            createFocusChangeHandler: function(e, t) {
                                return function(n) {
                                    ...
                                    if (l) {
                                        ...
                                        i = (c = [].slice.call(c.elements)).indexOf(l), u = function(e, t) {
                                            switch (e) {
                                                case r.BACK:
                                                    return {
                    ...
                    108: [function(e, t, n) {
                        ...
                        function M(e) {
                            var t, n, f, y, O, b, S = this,
                                ...
                                k = [],
                                F = m();
                            if (this._merchantConfigurationOptions = r({}, e), e.client ? (y = (f = e.client.getConfiguration()).gatewayConfiguration.assetsUrl, O = f.isDebug) : (y = i.create(e.authorization), O = !!e.isDebug), this._clientPromise = d.create({
                                    client: e.client,
                                    authorization: e.authorization,
                                    debug: O,
                                    assetsUrl: y,
                                    name: "Hosted Fields"
                                }), b = l(y, F, O), !e.fields || 0 === Object.keys(e.fields).length) throw new u({
                            ...
                            T.call(this), this._injectedNodes = [], this._destructor = new a, this._fields = D, this._state = {
                                ...
                                var n, r, i, o, a;
                                if (!_.allowedFields.hasOwnProperty(t)) throw new u({
                                ...
                                if (i = r, P.isShadowElement(i) && (i = P.transformToSlot(i, "height: 100%")), n.maxlength && "number" != typeof n.maxlength) throw new u({
                                ...
                                if (n.minlength && "number" != typeof n.minlength) throw new u({
                                    type: E.HOSTED_FIELDS_FIELD_PROPERTY_INVALID.type,
                                    code: E.HOSTED_FIELDS_FIELD_PROPERTY_INVALID.code,
                        ...
                        T.createChild(M), M.prototype._setupLabelFocus = function(e, t) {
                            ...
                            return (r.expirationMonth ? !r.expirationMonth.select && (t = "Expiration month field must be a select element.") : t = "Expiration month field must exist to use setMonthOptions.", t) ? Promise.reject(new u({
                                type: E.HOSTED_FIELDS_FIELD_PROPERTY_INVALID.type,
                                code: E.HOSTED_FIELDS_FIELD_PROPERTY_INVALID.code,
                                message: t
                    ...
                    161: [function(e, t, n) {
                        ...
                        function i(e) {
                            ...
                            c = 0;
                            do i = u.indexOf(e.charAt(c++)), o = u.indexOf(e.charAt(c++)), a = u.indexOf(e.charAt(c++)), s = u.indexOf(e.charAt(c++)), t = (63 & i) << 2 | o >> 4 & 3, n = (15 & o) << 4 | a >> 2 & 15, r = (3 & a) << 6 | 63 & s, l += String.fromCharCode(t) + (n ? String.fromCharCode(n) : "") + (r ? String.fromCharCode(r) : ""); while (c < e.length);
                            return l
                        }
                        t.exports = {
                            atob: function(e) {
                    ...
                    163: [function(e, t, n) {
                        ...
                        l.suppressUnhandledPromiseMessage = !0, m.prototype._initialize = function() {
                            ...
                            return (t = function(e) {
                                ...
                                }), y._authorizationInProgress = !1, d.resolve()) : e.onPaymentStart({
                                    paymentId: t.paymentResource.paymentToken
                                }, function() {
                            ...
                            return ((e = e || p.parse()).queryItems && (e = e.queryItems), e.c || e.wasCanceled) ? Promise.reject(new i({
                                ...
                                return s.sendEvent(n, t._paymentType + ".local-payment.tokenization.failed"), Promise.reject(u(e, {
                    ...
                    171: [function(e, t, n) {
                        ...
                        p.createChild(A), A.prototype._constructDefaultSupportedPaymentMethods = function() {
                            ...
                            return (this._frame = c({
                                ...
                                }), t._frame.src = (i = e.gatewayConfiguration.assetsUrl, o = t._componentId, i + "/web/3.97.0/html/payment-request-frame" + u(e.isDebug) + ".html#" + o), document.body.appendChild(t._frame)
                            })
                    ...
                    177: [function(e, t, n) {
                        ...
                        s.suppressUnhandledPromiseMessage = !0, I.prototype._initialize = function(e) {
                            ...
                            return !e || this._hasMissingOption(e, p.REQUIRED_OPTIONS) ? (r.sendEvent(t._clientPromise, "paypal-checkout.updatePayment.missing-options"), Promise.reject(new d(l.PAYPAL_MISSING_REQUIRED_OPTION))) : this._verifyConsistentCurrency(e) ? (r.sendEvent(this._clientPromise, "paypal-checkout.updatePayment"), this._clientPromise.then(function(n) {
                                ...
                                }))) : (r.sendEvent(t._clientPromise, "paypal-checkout.updatePayment." + l.PAYPAL_FLOW_FAILED.code), Promise.reject(u(e, {
                                    type: l.PAYPAL_FLOW_FAILED.type,
                                    code: l.PAYPAL_FLOW_FAILED.code,
                                    message: l.PAYPAL_FLOW_FAILED.message
                                })))
                            ...
                            var t, n = this;
                            return this._vaultInitiatedCheckoutInProgress ? (r.sendEvent(this._clientPromise, "paypal-checkout.startVaultInitiatedCheckout.error.already-in-progress"), Promise.reject(new d(l.PAYPAL_START_VAULT_INITIATED_CHECKOUT_IN_PROGRESS))) : (T.forEach(function(n) {
                            ...
                            return e.hasOwnProperty("vault") && (i = e.vault), o.vault = i, r.sendEvent(this._clientPromise, "paypal-checkout.tokenization.started"), this._clientPromise.then(function(e) {
                                ...
                                return n._setupError ? Promise.reject(n._setupError) : (r.sendEvent(n._clientPromise, "paypal-checkout.tokenization.failed"), Promise.reject(u(e, {
                                ...
                                return new Promise(function(d, u) {
                                    ...
                                    o.create({
                                        ...
                                        a.sendEvent(e, "sepa.popup.initialized"), n.open({}, function(e, t) {
                                            return function(e) {
                                                return e && e.success
                                            }(t) ? (n.close(), d()) : function(e, t) {
                                                return e && e.cancel || t && "FRAME_SERVICE_FRAME_CLOSED" === t.code
                                            }(t, e) ? (n.close(), u(new r(i.SEPA_CUSTOMER_CANCELED))) : (n.close(), u(new r(i.SEPA_TOKENIZATION_FAILED)))
                    ...
                    185: [function(e, t, n) {
                        ...
                        l.prototype.tokenize = function(e) {
                            ...
                            return !e || c(e, a.REQUIRED_OPTIONS) ? (d.sendEvent(t._client, "sepa.input-validation.missing-options"), Promise.reject(new i(o.SEPA_TOKENIZE_MISSING_REQUIRED_OPTION))) : a.MANDATE_TYPE_ENUM.includes(e.mandateType) ? s.createMandate(t._client, n).then(function(n) {
                    ...
                    205: [function(e, t, n) {
                        ...
                        f.prototype.fetchCapabilities = function(e) {
                            ...
                            if (c) return c._bus ? a ? Promise.reject(new i(u.UNIONPAY_CARD_AND_HOSTED_FIELDS_INSTANCES)) : new Promise(function(e, t) {
                            ...
                            if (a && a.number) {
                                ...
                                return o.request({
                                    ...
                                    return 403 === n ? t = e : n < 500 ? (t = new i(u.UNIONPAY_ENROLLMENT_CUSTOMER_INPUT_INVALID)).details = {
                                        originalError: e
                                    } : (t = new i(u.UNIONPAY_ENROLLMENT_NETWORK_ERROR)).details = {
                                        originalError: e
                            ...
                            if (a) return t = {
                                ...
                                var t, n = e.details && e.details.httpStatus;
                                return r.sendEvent(o, "unionpay.nonce-failed"), 403 === n ? t = e : n < 500 ? (t = new i(u.UNIONPAY_FAILED_TOKENIZATION)).details = {
                                    originalError: e
                                } : (t = new i(u.UNIONPAY_TOKENIZATION_NETWORK_ERROR)).details = {
                                    originalError: e
                                }, Promise.reject(t)
                            });
                        ...
                        t.exports = {
                            create: c(function(e) {
                                ...
                                return i.verify({
                                    ...
                                    }), e.createPromise = n, i = new u(e), r.sendEvent(n, "venmo.initialized"), n.then(function() {
                                        return i
                                    }))
                                })
                            }),
