            ...
            (a = s || (s = {})).CERTIFIED = "New Audio Device Detected - Certified", a.NOT_CERTIFIED = "New Audio Device Detected - Not Certified", i = class extends o.Component {
                ...
                render() {
                    ...
                    return (0, d.jsxs)(c.ModalRoot, {
                        transitionState: t,
                        "aria-label": n,
                        children: [(0, d.jsx)(c.ModalHeader, {
                            separator: !1,
                ...
                constructor(e) {
                    super(e), this.confirm = () => {
                        ...
                        null != n && (l.setDevice(e.displayName, n, "New Audio Device Detected Modal"), t())
                    }, this.cancel = () => {
                        let {
                            device: e,
                            onClose: t
                        ...
                        l.neverShowModal(), t(), E.default.track(D.AnalyticEvents.MODAL_DISMISSED, {
                            type: null != e ? "New Audio Device Detected - Certified" : "New Audio Device Detected - Not Certified",
