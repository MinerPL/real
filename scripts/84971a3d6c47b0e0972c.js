(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["40912"], {
        227332: function(t, n, r) {
            ...
            }), r("854508"), r("311790"), r("477657"), r("811875"), r("90301"), r("652153"), r("28797"), r("817884"), r("597349"), r("667536"), r("690341"), r("453061"), r("477315"), r("527135"), r("659510"), r("990131"), r("370692"), r("667500"), r("424973"), r("843762"), r("70102"), r("781738");
            var e, u = (e = "undefined" != typeof document && document.currentScript ? document.currentScript.src : void 0, function(t) {
                var n, u, i, a, o, c, f, s, l, m, h, g, y, _, p, d, v, w, F, E = void 0 !== (t = t || {}) ? t : {};
                ...
                var S = [],
                    ...
                    A = "";
                A = self.location.href, e && (A = e), A = 0 !== A.indexOf("blob:") ? A.substr(0, A.lastIndexOf("/") + 1) : "";
                o = function(t) {
                ...
                E.wasmBinary && (c = E.wasmBinary), E.noExitRuntime && E.noExitRuntime, "object" != typeof WebAssembly && q("no native wasm support detected");
                var I = !1;
                ...
                function H(t, n, r) {
                    ...
                    if (u - n > 16 && t.subarray && Y) return Y.decode(t.subarray(n, u));
                    for (var i = ""; n < u;) {
                        var a = t[n++];
                        if (!(128 & a)) {
                        ...
                        var c = 63 & t[n++];
                        if ((a = (240 & a) == 224 ? (15 & a) << 12 | o << 6 | c : (7 & a) << 18 | o << 12 | c << 6 | 63 & t[n++]) < 65536) i += String.fromCharCode(a);
                        else {
                            var f = a - 65536;
                ...
                function W(t) {
                    l = t, E.HEAP8 = m = new Int8Array(t), E.HEAP16 = new Int16Array(t), E.HEAP32 = _ = new Int32Array(t), E.HEAPU8 = h = new Uint8Array(t), E.HEAPU16 = new Uint16Array(t), E.HEAPU32 = new Uint32Array(t), E.HEAPF32 = new Float32Array(t), E.HEAPF64 = new Float64Array(t)
                }
                E.INITIAL_MEMORY;
                var N = [],
                    j = [],
                ...
                function q(t) {
                    E.onAbort && E.onAbort(t), D(t += ""), I = !0, t = "abort(" + t + "). Build with -s ASSERTIONS=1 for more info.";
                ...
                function $(t) {
                    this.excPtr = t, this.ptr = t - Q.SIZE, this.set_type = function(t) {
                        ...
                        var t = _[this.ptr + Q.REFCOUNT_OFFSET >> 2];
                        return _[this.ptr + Q.REFCOUNT_OFFSET >> 2] = t - 1, 1 === t
                    }
                }
                var tt = 0,
                    tn = {
                        ...
                        printChar: function(t, n) {
                            var r = tn.buffers[t];
                            0 === n || 10 === n ? ((1 === t ? R : D)(H(r, 0)), r.length = 0) : r.push(n)
                        },
                        varargs: void 0,
                        get: function() {
                ...
                function tc(t, n) {
                    for (var r = new Date(t.getTime()); n > 0;) {
                        var e = tu(r.getFullYear()),
                            u = r.getMonth(),
                            i = (e ? ta : to)[u];
                        if (n > i - r.getDate()) n -= i - r.getDate() + 1, r.setDate(1), u < 11 ? r.setMonth(u + 1) : (r.setMonth(0), r.setFullYear(r.getFullYear() + 1));
                        else {
                ...
                var tf = {
                    ...
                    q: function(t) {
                        ...
                        for (var r = 1; r <= 4; r *= 2) {
                            var e, u, i = n * (1 + .2 / r);
                            if (i = Math.min(i, t + 100663296), function(t) {
                                    try {
                                        return s.grow(t - l.byteLength + 65535 >>> 16), W(s.buffer), 1
                                    } catch (t) {}
                                }(Math.min(67108864, (u = 65536, (e = Math.max(16777216, t, i)) % u > 0 && (e += u - e % u), e)))) return !0
                        }
                        return !1
                    },
                    s: function(t, n) {
                        var r = 0;
                        return te().forEach(function(e, u) {
                            var i = n + r;
                            _[t + 4 * u >> 2] = i, ! function(t, n, r) {
                    ...
                    l: function(t, n, r, e) {
                        for (var u = 0, i = 0; i < r; i++) {
                            for (var a = _[n + 8 * i >> 2], o = _[n + (8 * i + 4) >> 2], c = 0; c < o; c++) tn.printChar(t, h[a + c]);
                            u += o
                        }
                        return _[e >> 2] = u, 0
                    },
                        ...
                        return function(t, n, r, e) {
                            ...
                            function v(t) {
                                var n = tc(new Date(t.tm_year + 1900, 0, 1), t.tm_yday),
                                    ...
                                    u = d(r),
                                    i = d(e);
                                return 0 >= p(u, n) ? 0 >= p(i, n) ? n.getFullYear() + 1 : n.getFullYear() : n.getFullYear() - 1
                            }
                            var w = {
                                "%a": function(t) {
                                ...
                                "%j": function(t) {
                                    return y(t.tm_mday + ti(tu(t.tm_year + 1900) ? ta : to, t.tm_mon - 1), 3)
                                },
                                "%m": function(t) {
                                ...
                                "%U": function(t) {
                                    ...
                                    if (0 > p(r, e)) {
                                        var u = ti(tu(e.getFullYear()) ? ta : to, e.getMonth() - 1) - 31;
                                        return y(Math.ceil((31 - r.getDate() + u + e.getDate()) / 7), 2)
                                    }
                                ...
                                "%V": function(t) {
                                    ...
                                    return 0 > p(a, u) ? "53" : 0 >= p(i, a) ? "01" : y(Math.ceil((n = u.getFullYear() < t.tm_year + 1900 ? t.tm_yday + 32 - u.getDate() : t.tm_yday + 1 - u.getDate()) / 7), 2)
                                },
                                "%w": function(t) {
                                    return t.tm_wday
                                },
                                "%W": function(t) {
                                    var n = new Date(t.tm_year, 0, 1),
                                        r = 1 === n.getDay() ? n : tc(n, 0 === n.getDay() ? 1 : 7 - n.getDay() + 1),
                                        e = new Date(t.tm_year + 1900, t.tm_mon, t.tm_mday);
                                    if (0 > p(r, e)) {
                                        var u = ti(tu(e.getFullYear()) ? ta : to, e.getMonth() - 1) - 31;
                                        return y(Math.ceil((31 - r.getDate() + u + e.getDate()) / 7), 2)
                            ...
                            for (var s in w) c.indexOf(s) >= 0 && (c = c.replace(RegExp(s, "g"), w[s](o)));
                ...
                ! function() {
                    ...
                    }(c || "function" != typeof WebAssembly.instantiateStreaming || J(V) || "function" != typeof fetch ? u(e) : fetch(V, {
                        credentials: "same-origin"
                    }).then(function(t) {
                        return WebAssembly.instantiateStreaming(t, n).then(e, function(t) {
                            return D("wasm streaming compile failed: " + t), D("falling back to ArrayBuffer instantiation"), u(e)
                        })
                    })).catch(i)
                }();
                ...
                function tS(t) {
                    ...
                    function n() {
                        if (!F) F = !0, E.calledRun = !0, !I && (K(j), K(G), u(E), E.onRuntimeInitialized && E.onRuntimeInitialized(), ! function() {
                            if (E.postRun)
                ...
                if (E.cwrap = function(t, n, r, e) {
                        ...
                        return "string" !== n && u && !e ? U(t) : function() {
                            return function(t, n, r, e, u) {
                                ...
                                if (e)
                                    for (var s = 0; s < e.length; s++) {
                                        var l = a[r[s]];
                                        l ? (0 === f && (f = tw()), c[s] = l(e[s])) : c[s] = e[s]
                                    }
                                var g = o.apply(null, c);
                                return i = g, g = "string" === n ? k(i) : "boolean" === n ? !!i : i, 0 !== f && tF(f), g
                            }(t, n, r, arguments, 0)
                        }
                    }, Z = function t() {
                        !F && tS(), !F && (Z = t)
        ...
        53489: function(t, n, r) {
            ...
            t.exports = function(t, n) {
                if (!delete t[n]) throw u("Cannot delete property " + e(n) + " of " + e(t))
            }
        },
