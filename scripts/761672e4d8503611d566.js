    ...
    ["87493"], {
        ...
        991630: function(t, e, n) {
            ...
            function E(t) {
                let {
                    ...
                    onMouseLeave: p,
                    ...N
                } = t, [A, C] = i.useState(!1), m = i.useCallback(() => {
                    C(!0), null == T || T()
                }, [T]), h = i.useCallback(() => {
                    C(!1), null == _ || _()
                }, [_]), O = i.useCallback(() => {
        ...
        752598: function(t, e, n) {
            ...
            let p = async t => {
                ...
                await c.default.unarchiveThreadIfNecessary(I), (0, E.addQueued)(p, {
                    messageId: n,
                    data: {
                ...
                }), null != S && (0, E.queueInteractionComponentState)(n, p, S, l);
                let C = {
            ...
            var i = n("77078"),
                ...
                j = (0, l.default)((0, u.default)(function(t) {
                    let {
                        ...
                        onSelect: V,
                        onHeightUpdate: Y
                    } = t, K = (0, U.default)(e.id, n, u.id), W = (0, M.default)(e, n, k), Q = (0, L.default)(e.id, k), X = (0, P.default)(e.id), q = (0, g.default)(e, k), z = (0, m.default)({
                        user: e,
                        guildId: n,
                        context: k
                    }), J = (0, C.default)(e), Z = (0, F.default)(e.id), $ = (0, b.default)(e.id), tt = (0, _.default)({
                        guildId: n,
                        userId: e.id,
                        analyticsLocation: {
                        ...
                        context: k
                    }), te = (0, y.default)(e, n), tn = (0, s.default)(null, e), tr = (0, A.default)(e), ti = (0, D.default)(e), ta = (0, h.default)(e, n, u.id), tu = (0, v.default)(e.id, n), tl = (0, R.default)(e, n), to = (0, T.default)({
                        id: e.id,
                        label: x.default.Messages.COPY_ID_USER
                    }), ts = (0, G.default)(e.id, u.id), tc = (0, E.default)(e.id), td = (0, d.default)(u.id), tE = (0, p.default)(e), tf = (0, N.default)(e, n, u.id), tI = (0, O.default)({
                        commandType: o.ApplicationCommandType.USER,
                        commandTargetId: e.id,
                        channel: u,
                        guildId: n,
                        onShow: Y
                    }), tT = (0, f.default)(e.id), t_ = (0, S.default)(e, n, k), tS = e.isNonUserBot(), tp = e.isClyde(), tN = (0, I.useIsDMsToClydeEnabled)();
                    return (0, r.jsxs)(i.Menu, {
                        ...
                        children: [!tS && (0, r.jsxs)(r.Fragment, {
                            children: [(0, r.jsxs)(i.MenuGroup, {
                                ...
                                children: [B && K, c && W, Q, q, B && z, B && J, X]
            ...
            var r = n("37983"),
                ...
                N = t => {
                    let {
                        ...
                        guildId: N,
                        onShow: A
                    } = t, C = i.useRef(!1), m = i.useRef(0), h = (0, l.useStateFromStores)([T.default], () => T.default.getGuild(null != N ? N : a.guild_id)), {
                        hasMoreAfter: O,
                        scrollDown: D,
                    ...
                    }, [G, g, y]), R = i.useMemo(() => (0, d.canUseContextMenuCommands)(a, M.length, s.getCommandTypeCount(a, e, null == h ? void 0 : h.applicationCommandCounts)), [a, e, M.length, null == h ? void 0 : h.applicationCommandCounts]);
                    i.useEffect(() => {
                        if (R !== C.current) {
                            if (R) null == A || A();
                            C.current = R
                    ...
                    let b = i.useCallback(t => {
                            O && t + 500 > 34 * M.length - 40 && D(), m.current = t
                        }, [O, D, M]),
                        U = i.useCallback(t => {
        ...
        459870: function(t, e, n) {
            ...
            function m(t, e) {
                let n = (0, i.useStateFromStores)([d.default], () => d.default.getChannels(e)[d.GUILD_VOCAL_CHANNELS_KEY], [e]),
                    m = (0, i.useStateFromStores)([S.default, c.default], () => {
                        let n = S.default.getUserVoiceChannelId(e, t.id);
                        return c.default.getChannel(n)
                    }, [e, t.id]),
                    h = (0, i.useStateFromStores)([E.default], () => E.default.isGuestOrLurker(e, t.id), [e, t.id]);
                if (h || null == m) return null;
                let O = t.id === s.default.getId();
                if (!O && !I.default.can(A.Permissions.MOVE_MEMBERS, m)) return null;
                let D = n.filter(e => {
                    let {
                        channel: n
                    } = e;
                    return n.id !== m.id && (O ? I.default.can(A.Permissions.CONNECT, n) && !(0, p.isChannelFull)(n, S.default, f.default) : I.default.can(A.Permissions.MOVE_MEMBERS, n) && (I.default.can(A.Permissions.CONNECT, n) || N.default.can({
                        permission: A.Permissions.CONNECT,
                        user: t,
                        context: n
                    })) && !(0, p.isChannelFull)(n, S.default, f.default))
                });
                return 0 === D.length ? null : (0, r.jsx)(a.MenuItem, {
                    id: "voice-move",
