(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["86514"], {
                        ...
                        children: (0, n.jsxs)("div", {
                            ...
                            children: [(0, n.jsxs)("div", {
                                ...
                                children: [(0, n.jsxs)(i.Heading, {
                                    ...
                                    color: "always-white",
                                    children: [x && !L ? (0, n.jsx)(c.default, {
                                        className: S.premiumIcon
                                    }) : null, L ? (0, n.jsxs)(i.Text, {
                                        color: "always-white",
                                        variant: "eyebrow",
        ...
        636909: function(e, t, l) {
            ...
            function Y(e) {
                let {
                    ...
                    sourceChanged: a,
                    onChangeSource: s
                } = e, r = (0, i.useStateFromStores)([N.default, x.default], () => (0, D.isWindows)() ? (0, b.default)(N.default, x.default) : null), o = (0, i.useStateFromStores)([C.default], () => (null == r ? void 0 : r.id) != null ? C.default.getGame(r.id) : null), d = (0, i.useStateFromStores)([N.default], () => N.default.getRunningGames()), c = (0, i.useStateFromStoresArray)([C.default], () => d.map(e => null != e.id ? C.default.getGame(e.id) : null).filter(j.isNotNullish), [d]), f = null;
            ...
            function X(e) {
                ...
                let {
                    guildId: l
                } = e, s = (0, i.useStateFromStores)([h.default], () => null !== (t = h.default.getMemberCount(l)) && void 0 !== t ? t : 0), o = S.NotifyFriendsOnGoLive.useSetting(), d = a.useCallback((e, t) => {
        ...
        451863: function(e, t, l) {
            ...
            function H(e) {
                ...
                let {
                    ...
                    resolution: Q,
                    fps: q
                } = (0, d.useStateFromStoresObject)([h.default], () => h.default.getState()), $ = (0, d.useStateFromStores)([x.default, g.default], () => g.default.getChannel(x.default.getVoiceChannelId())), ee = (0, d.useStateFromStores)([p.default, R.default], () => (0, L.isWindows)() ? (0, P.default)(p.default, R.default) : null), et = (0, d.useStateFromStores)([A.default], () => {
                ...
                let es = (0, T.useUID)();
                let [er, ei] = r.useState((i = W, H = z, i ? a.GUILD : H ? a.SOURCE : a.CONFIRM)), [eu, eo] = r.useState(null), [ed, ec] = r.useState(!1), [ef, em] = r.useState(null), [eS, eE] = r.useState(null), [eC, eh] = r.useState(null), [eg, e_] = r.useState(X), [eN, eI] = r.useState(Q), [ep, ex] = r.useState(q), [eA, eR] = r.useState(null != K ? K : null), ev = null !== (n = null == $ ? void 0 : $.id) && void 0 !== n ? n : ef;
                r.useEffect(() => {
                ...
                let eO = r.useCallback((e, t, l) => {
                    ...
                    l !== ep && ex(l), t !== eN && eI(t), a !== t || s !== l ? e_(k.ApplicationStreamPresets.PRESET_CUSTOM) : e !== eg && e_(e)
                }, [et, el, ep, eN, eg]);
                async function eL(e) {
                ...
                let eM = r.useCallback(e => {
                        ...
                        children: [(0, s.jsx)(c.Slide, {
                            ...
                            children: (0, s.jsx)("div", {
                                ...
                                children: (0, s.jsx)(b.default, {
                                    ...
                                    sourceChanged: ed,
                                    selectSource: z,
                                    onChangeSelectedFPS: e => eO(eg, eN, e),
                                    onChangeSelectedResolution: e => eO(eg, e, ep),
                                    onChangeSelectedPreset: e => eO(e, eN, ep),
                    ...
                    eG = er !== a.CONFIRM || null == eS && null == ee || null == ev,
        ...
        23922: function(e, t, l) {
            ...
            function L(e) {
                let t = (0, g.isWindows)() ? (0, I.default)(S.default, E.default) : null,
            ...
            function M(e) {
                ...
                }), i = m.default.supports(A.Features.GO_LIVE_HARDWARE), [o, f] = a.useState(null), [S, E] = a.useState(null), [g, N] = a.useState(null), I = null != g && g.length > 0, [O, L] = a.useState(u.DesktopSources.WINDOW), [M, j] = a.useState(!1), D = a.useRef(null), P = a.useRef(new d.Interval);
                a.useEffect(() => {
                    let e = P.current;
                    return T().then(e => {
                        let {
                ...
                return (0, n.jsxs)(a.Fragment, {
                    ...
                    }), O === u.DesktopSources.CAMERA ? (0, n.jsx)("div", {
            ...
            function D(e) {
                let {
                    ...
                    buttons: V.map(e => j({
                        type: e,
                        selected: e.value === a,
                        needsPremium: !(0, N.default)(l, e.value, s, b, F),
                        analyticsLocation: H,
                        onClick: () => r(e.value),
                        onClose: t
                    }))
                    ...
                    buttons: p.ApplicationStreamFPSButtons.map(e => j({
                        type: e,
                        selected: e.value === s,
                        needsPremium: !(0, N.default)(l, a, e.value, b, F),
                        analyticsLocation: H,
                        onClick: () => g(e.value),
                        onClose: t
                    }))
