(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["86995"], {
        ...
        136759: function(e, t, n) {
            ...
            var i = Object.defineProperty,
                ...
                u = (e, t) => {
                    ...
                    if (s)
                        for (var n of s(t)) l.call(t, n) && a(e, n, t[n]);
                    return e
                };
            let o = e => t => {
                    try {
                    ...
                    let E = e(function() {
                        ...
                        _ = () => {
                            ...
                            return o(r.getItem.bind(r))(a.name).then(e => {
                                ...
                                var t;
                                return n(l = a.merge(e, null != (t = i()) ? t : E), !0), S()
                            }).then(() => {
        ...
        430568: function(e, t, n) {
            ...
            function O(e) {
                let t = h.AnimateEmoji.useSetting(),
                    ...
                    s = __OVERLAY__ ? (0, d.useStateFromStores)([f.default], () => f.default.isInstanceFocused()) : (0, _.useIsWindowFocused)();
                return (0, i.jsx)(p, {
                    ...e,
                    ...n,
                    isFocused: s
        ...
        145079: function(e, t, n) {
            ...
            var E = e => {
                let {
                    ...
                    forcePomelo: h,
                    ...f
                } = e, E = (0, l.useStateFromStores)([u.default], () => u.default.hidePersonalInformation), _ = E || t || n.isNonUserBot(), I = n.toString(), T = c.default.getName(n), p = r ? I : null != s ? s : T, O = n.isPomelo() || h;
                if (O || p !== I) {
                    let e = p === I && O && r ? c.default.getUserTag(n, {
                            forcePomelo: h
                        }) : p,
                        t = a && e !== "@".concat(I) ? c.default.getUserTag(n) : void 0;
                    return (0, i.jsx)(m, {
                        primary: e,
                        secondary: t,
                ...
                return (0, i.jsx)(d.default, {
                    ...
                    botType: S(n),
                    botVerified: n.isVerifiedBot(),
                    discriminator: _ || p !== I ? null : null != o ? o : n.discriminator,
                    ...f
                })
            }
        },
        686298: function(e, t, n) {
            ...
            }(i = l || (l = {}))[i.RESOLUTION_480 = 480] = "RESOLUTION_480", i[i.RESOLUTION_720 = 720] = "RESOLUTION_720", i[i.RESOLUTION_1080 = 1080] = "RESOLUTION_1080", i[i.RESOLUTION_1440 = 1440] = "RESOLUTION_1440", i[i.RESOLUTION_SOURCE = 0] = "RESOLUTION_SOURCE", (s = a || (a = {}))[s.FPS_5 = 5] = "FPS_5", s[s.FPS_15 = 15] = "FPS_15", s[s.FPS_30 = 30] = "FPS_30", s[s.FPS_60 = 60] = "FPS_60", (r = u || (u = {}))[r.PRESET_VIDEO = 1] = "PRESET_VIDEO", r[r.PRESET_DOCUMENTS = 2] = "PRESET_DOCUMENTS", r[r.PRESET_CUSTOM = 3] = "PRESET_CUSTOM";
            let S = {
                    [u.PRESET_DOCUMENTS]: [{
            ...
            let _ = [E(l.RESOLUTION_720), E(l.RESOLUTION_1080), E(l.RESOLUTION_1440), E(l.RESOLUTION_SOURCE, () => c.default.Messages.SCREENSHARE_SOURCE)],
                I = [E(l.RESOLUTION_720), E(l.RESOLUTION_1080), E(l.RESOLUTION_1440)],
                T = e => "".concat(e, "p"),
                p = [E(l.RESOLUTION_480, () => T(l.RESOLUTION_480)), E(l.RESOLUTION_720, () => T(l.RESOLUTION_720)), E(l.RESOLUTION_1080, () => T(l.RESOLUTION_1080)), E(l.RESOLUTION_1440, () => T(l.RESOLUTION_1440)), E(l.RESOLUTION_SOURCE, () => c.default.Messages.SCREENSHARE_SOURCE)],
                O = [E(a.FPS_15), E(a.FPS_30), E(a.FPS_60)],
                F = [E(a.FPS_15, () => c.default.Messages.STREAM_FPS_OPTION.format({
                    value: a.FPS_15
                })), E(a.FPS_30, () => c.default.Messages.STREAM_FPS_OPTION.format({
                    value: a.FPS_30
                })), E(a.FPS_60, () => c.default.Messages.STREAM_FPS_OPTION.format({
                    value: a.FPS_60
                }))]
        },
        969715: function(e, t, n) {
            ...
            function S(e) {
                let {
                    ...
                    body: r,
                    ...l
                } = e, [a, d] = s.useState(null), [f, S] = s.useState(!1);
            ...
            function m(e) {
                let {
                    ...
                    options: d,
                    ...S
                } = e, [m, E] = s.useState(null), [_, I] = s.useState(!1);
                return (0, i.jsxs)(u.ConfirmModal, {
                    header: r,
                    ...
                    ...S,
                    children: [null != m && (0, i.jsx)(u.Text, {
        ...
        395118: function(e, t, n) {
            ...
            var i, s, r, l, a = n("627445"),
                u = n.n(a),
                o = n("913144");
            (i = r || (r = {})).GUILD_HOME = "guild_home", i.FORUM_CHANNEL = "forum_channel", (s = l || (l = {}))[s.IMMEDIATE = 0] = "IMMEDIATE", s[s.IMMEDIATE_WITH_COOLDOWN = 1] = "IMMEDIATE_WITH_COOLDOWN", s[s.IMMEDIATE_WITH_DELAY = 2] = "IMMEDIATE_WITH_DELAY";
            class d {
                maybeMarkSeen(e) {
        ...
        98013: function(e, t, n) {
            ...
            function o(e) {
                ...
                return "".concat(a.DownloadLinks.DESKTOP).concat(t ? "/ptb" : "", "?platform=").concat(e).concat(i)
            }
