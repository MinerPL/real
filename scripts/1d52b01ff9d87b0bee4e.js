            ...
            var l = n("77078"),
                ...
                f = (0, u.default)(function(e) {
                    let {
                        ...
                        onMessage: p,
                        onSelect: h
                    } = e, E = t.isNonUserBot(), M = [], C = (0, o.useIsIarUserReportingEnabled)("User Profile Actions Menu");
                    if (!E) switch (n) {
                        case c.RelationshipTypes.BLOCKED:
                            M.push((0, s.jsx)(l.MenuItem, {
                                id: "user-unblock",
                    ...
                    }!E && n !== c.RelationshipTypes.BLOCKED && M.push((0, s.jsx)(l.MenuItem, {
                        id: "user-message",
