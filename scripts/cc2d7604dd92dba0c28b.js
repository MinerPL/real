    ...
    ["97203"], {
        ...
        473070: function(e, t, l) {
            ...
            function x(e) {
                ...
                let [y, O] = n.useState(null === (x = null === (t = S.editMetadata) || void 0 === t ? void 0 : t.voiceAudio) || void 0 === x || x), [k, F] = n.useState(null === (N = null === (l = S.editMetadata) || void 0 === l ? void 0 : l.applicationAudio) || void 0 === N || N), [G, B] = n.useState({
            ...
            function C(e) {
                ...
                (0, c.default)(() => {
                    ...
                    let a = (0, s.round)(l.currentTime, 3),
                        n = (0, s.round)(N.start, 3),
                        i = (0, s.round)(N.end, 3);
                    if (S && (a >= i || a < n)) {
                        null === (t = I.current) || void 0 === t || t.seek(N.start), D(N.start);
                        return
                    }
                    w !== a && D(a)
                });
                ...
                let Z = n.useRef(null),
                    ...
                    X = n.useCallback((e, t) => {
                        ...
                        let r = (0, s.clamp)(e, k.left, k.right),
                            ...
                            o = (0, s.clamp)(u, 0, A),
                            d = M;
                        if (null == d && t && (d = o <= N.start ? "start" : o >= N.end ? "end" : "playhead", null === (l = I.current) || void 0 === l || l.pause(), j(d), O(S)), "start" === d) {
