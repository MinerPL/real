(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["80453"], {
                    ...
                    switch (t.type) {
                        ...
                        case "oscillating-random":
                            ...
                            var f = E(t.minStart),
                                ...
                                x = E(t.minDirection),
                                T = E(t.maxDirection);
                            return new y(new S(w(n.x, r.x), w(f.x, h.x), w(d.x, p.x), w(v.x, g.x), A(x.x, T.x), M(t.easingFunctions)[0]), new S(w(n.y, r.y), w(f.y, h.y), w(d.y, p.y), w(v.y, g.y), A(x.y, T.y), M(t.easingFunctions)[0]))
                    }
                }(p(p({}, t), {
                    valueType: "Vector2"
                }))
            ...
            var R = r.forwardRef(function(t, e) {
                var o = t.className,
                    ...
                    b = r.useCallback(function() {
                        ...
                        if (null != t) {
                            ...
                            if (null != e) {
                                e.clearRect(0, 0, t.width, t.height), null == v || v(e), G.current.forEach(function(n, r) {
                                    var i = n.confetti,
                                        o = n.spriteCanvas;
                                    i.update(a), i.draw(o, e), i.shouldDestroy(t, a) && G.current.delete(r)
                                }), null == y || y(e), G.current.size > 0 ? I.current = window.requestAnimationFrame(b) : (e.clearRect(0, 0, t.width, t.height), I.current = null);
                                var n = Date.now();
                                0 !== L.current && (N.current = 1e3 / (n - L.current)), L.current = n
                            }
                        }
                    }, [a, y, v]);
                r.useEffect(function() {
                    null != I.current && (window.cancelAnimationFrame(I.current), I.current = window.requestAnimationFrame(b))
                }, [b]);
                var P = r.useCallback(function(t, e) {
                    ...
                    B = r.useCallback(function(t, e, n, r, o) {
                        var a, u, c, f, h, d, v, y, E, R, G, I, L, N, b, B = (a = null !== (b = t.id) && void 0 !== b ? b : (0, i.v4)(), u = t, c = n, f = r, h = o, y = T((v = (d = u, p(p({
                            id: a
                        }, s), d))).size), R = (E = function(t, e) {
                            if (null != t) {
                        ...
                        }(null != f ? f : R, h, c), new l({
                            id: a,
                            position: T(v.position),
                            velocity: T(v.velocity),
                            rotation: (L = v.rotation, function(t) {
                                switch (t.type) {
                                    case "static":
                                        var e = x(t.value);
                                    ...
                                    case "oscillating-random":
                                        ...
                                        var f = x(t.minStart),
                                            ...
                                            E = x(t.minDirection),
                                            T = x(t.maxDirection);
                                        return new g(new S(w(n.x, r.x), w(f.x, h.x), w(d.x, p.x), w(v.x, y.x), A(E.x, T.x), M(t.easingFunctions)[0]), new S(w(n.y, r.y), w(f.y, h.y), w(d.y, p.y), w(v.y, y.y), A(E.y, T.y), M(t.easingFunctions)[0]), new S(w(n.z, r.z), w(f.z, h.z), w(d.z, p.z), w(v.z, y.z), A(E.z, T.z), M(t.easingFunctions)[0]))
                                }
                            }(p(p({}, L), {
                                valueType: "Vector3"
                            }))),
                            ...
                            opacity: (N = v.opacity, function(t) {
                                switch (t.type) {
                                    ...
                                    case "oscillating-random":
                                        return new S(w(t.minValue, t.maxValue), w(t.minStart, t.maxStart), w(t.minFinal, t.maxFinal), w(t.minDuration, t.maxDuration), A(t.minDirection, t.maxDirection), M(t.easingFunctions)[0])
                                }
                            }(p(p({}, N), {
                                valueType: "number"
                            }))),
                            spriteX: I * c.spriteWidth + 2 * I,
                            spriteY: G * c.spriteHeight + 2 * G,
                ...
                return r.useEffect(function() {
                    ...
                    return t("click", K, c), t("mousedown", V, f), t("mousemove", H, h), t("mouseup", _, d),
                        function() {
                ...
                }, [K, V, H, _, c, f, h, d]), r.useEffect(function() {
                    var t = R.current,
        ...
        505143: function(t, e, n) {
            ...
            let M = f(g(function(t) {
                    return !0
                })),
                A = t => Object.assign(f(t), {
                    startsWith: e => A(v(t, g(t => S(t) && t.startsWith(e)))),
                    endsWith: e => A(v(t, g(t => S(t) && t.endsWith(e)))),
                    minLength: e => {
                        var n;
                        return A(v(t, (n = e, g(t => S(t) && t.length >= n))))
                    },
                    maxLength: e => {
                        var n;
                        return A(v(t, (n = e, g(t => S(t) && t.length <= n))))
                    },
                    includes: e => A(v(t, g(t => S(t) && t.includes(e)))),
                    regex: e => A(v(t, g(t => S(t) && !!t.match(e))))
                }),
                E = A(g(S)),
                ...
                G = t => g(e => C(e) && e <= t),
                I = t => g(e => C(e) && e >= t),
                L = () => g(t => C(t) && Number.isInteger(t)),
                N = () => g(t => C(t) && Number.isFinite(t)),
                b = () => g(t => C(t) && t > 0),
                P = () => g(t => C(t) && t < 0),
                B = t => Object.assign(f(t), {
                    between: (e, n) => B(v(t, x(e, n))),
                    lt: e => B(v(t, T(e))),
                    gt: e => B(v(t, R(e))),
                    lte: e => B(v(t, G(e))),
                    gte: e => B(v(t, I(e))),
