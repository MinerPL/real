    ...
    ["71780"], {
        ...
        462998: function(e, t, l) {
            ...
            function y(e) {
                ...
                } = e, F = (0, s.useStateFromStores)([S.default], () => S.default.getChannel(t)), H = (0, s.useStateFromStores)([_.default], () => _.default.getGuild(null == F ? void 0 : F.getGuildId())), U = (0, s.useStateFromStores)([A.default], () => A.default.getCurrentUser()), k = (0, s.useStateFromStores)([I.default], () => I.default.didAgree(null == F ? void 0 : F.guild_id)), P = (null == U ? void 0 : U.nsfwAllowed) === !0, G = (0, j.default)(F), W = (0, s.useStateFromStores)([x.default], () => (null == H ? void 0 : H.id) != null && x.default.isLurking(H.id), [H]), z = (0, s.useStateFromStores)([v.default], () => v.default.can(L.Permissions.SEND_MESSAGES, F)), Y = (0, f.useHasPendingMemberAction)(null == H ? void 0 : H.id, null == F ? void 0 : F.id), V = (0, m.default)(t), Z = (0, s.useStateFromStores)([h.default], () => {
                    var e;
                    return null === (e = h.default.getResourceForChannel(null == H ? void 0 : H.id, t)) || void 0 === e ? void 0 : e.title
                }), X = a.useRef(!1);
                if (a.useEffect(() => {
                        null != F && !X.current && (X.current = !0, (0, o.trackWithMetadata)(L.AnalyticEvents.CHANNEL_OPENED, {
                            channel_id: F.id,
                            guild_id: F.guild_id,
                    ...
                    }, [F, B, z, Y]), null == F || null == H) return null;
                let q = [];
                return (!W && q.push((0, n.jsx)(C.default, {
                    channel: F
                }, "notifications")), q.push((0, n.jsx)(R.default.Icon, {
                    icon: O.default,
                    tooltip: M.default.Messages.CLOSE,
                    onClick: () => p.default.closeChannelSidebar(y)
                }, "close")), !F.isNSFW() || P && k) ? (0, n.jsxs)(n.Fragment, {
                    children: [(0, n.jsx)(d.default, {
                        ...
                        children: (0, N.renderTitle)({
                            ...
                            handleClick: () => {
                                ...
                                if (w) {
                                    (0, g.transitionTo)(L.Routes.CHANNEL(F.guild_id, F.id)), (0, c.selectHomeResourceChannel)(F.guild_id, null);
                                    return
                                }(0, g.transitionToGuild)(F.guild_id, F.id, e.jumpTargetId)
                            }
                        })
                    }), (0, n.jsx)("div", {
                        className: D.chat,
