    ...
    ["31669"], {
        ...
        817477: function(e, t, n) {
            ...
            function S(e) {
                ...
                } = e, A = (0, s.useStateFromStores)([d.default], () => d.default.getWindow(T.PopoutWindowKeys.CHANNEL_CALL_POPOUT)), C = (0, i.useMemoOne)(() => (0, r.v4)(), [t]), O = u.useRef(null), v = (0, E.default)(O, _, null == A ? window : A), M = {
                    ...S,
                    frame_id: C,
                ...
                return L === T.ThemeTypes.LIGHT ? D.colorScheme = "light" : D.colorScheme = "dark", u.useEffect(() => (m.ComponentDispatch.dispatch(T.ComponentActions.IFRAME_MOUNT, {
                    ...
                    onLoad: function(e) {
                        var n;
                        null == o || o(e.target), O.current = e.target, v(!0), null === (n = e.target.contentWindow) || void 0 === n || n.postMessage([c.default.HELLO, M], null != t ? t : "")
                    },
                    sandbox: (0, p.default)({
                        allowPopups: h
                    }),
        ...
        732523: function(e, t, n) {
            ...
            function M(e, t) {
                ...
                let {
                    ...
                    R(null), D(null), O(y.current) && D(function(e, t) {
            ...
            function R(e) {
                ...
                } = v(t), i = E.default.getChannel(e.channelId);
        ...
        168984: function(e, t, n) {
            ...
            function N(e) {
                ...
                let {
                    ...
                    let e = Math.min((v - h - 2 * S) * 16 / 9, _);
                    return Math.max(T, Math.min(O - 2 * S, e))
                }, [O, v]);
