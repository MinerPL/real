    ...
    ["7236"], {
        ...
        846883: function(e, t, n) {
            ...
            function k(e, t) {
                ...
                } = (0, r.default)(), w = (0, i.useStateFromStores)([h.default], () => h.default.getCurrentUser()), X = (0, i.useStateFromStores)([G.default], () => G.default.getSelfEmbeddedActivities()), B = (0, i.useStateFromStoresArray)([m.default], () => m.default.getActivities().filter(e => null != e.application_id && !(null == X ? void 0 : X.has(e.application_id)))), z = (0, i.useStateFromStoresArray)([y.default], () => null != t ? y.default.getActivities(t.id, null == e ? void 0 : e.getGuildId()) : [], [t, e]), K = (0, i.useStateFromStoresArray)([G.default], () => {
                ...
                }, [t, e]), W = (0, V.default)(), Q = (0, i.useStateFromStores)([v.default], () => null == e || e.isPrivate() || v.default.can(P.Permissions.SEND_MESSAGES, e), [e]), q = (0, i.useStateFromStoresArray)([O.default], () => [...z.map(e => null != e.application_id && O.default.getState(e.application_id, P.ActivityActionTypes.JOIN) === P.ActivityActionStates.LOADING), ...K.map(e => O.default.getState(e.application_id, P.ActivityActionTypes.JOIN) === P.ActivityActionStates.LOADING)], [z, K]), Z = (0, o.default)([...z.filter(e => (null == e ? void 0 : e.application_id) != null).map(e => e.application_id), ...K.map(e => e.application_id)]), $ = null == e ? void 0 : e.id, ee = (0, i.useStateFromStoresArray)([S.default, N.default, T.default, g.default, M.default, C.default, v.default], () => [...z.map(e => (0, R.default)({
                    user: null != t ? t : w,
                    activity: e,
                ...
                return null == X || X.forEach(n => {
                    let i = (null == t ? void 0 : t.id) != null && n.connections.has(null == t ? void 0 : t.id),
                        u = v.default.can(P.Permissions.CREATE_INSTANT_INVITE, e);
                    ...
                    if (n.type === P.ActivityTypes.PLAYING && (0, F.default)(n, P.ActivityFlags.JOIN) && null != n.session_id && null != n.application_id) {
                        ...
                        ed.push((0, a.jsx)(l.MenuItem, {
                            ...
                            action: () => (0, p.default)(u, H.SpotifyActionTypes.USER_ACTIVITY_PLAY),
                            ...
                            action: () => (0, E.default)(u, H.SpotifyActionTypes.USER_ACTIVITY_SYNC),
                            label: J.default.Messages.USER_ACTIVITY_LISTEN_ALONG,
                            subtext: A ? (0, I.default)(u, H.SpotifyActionTypes.USER_ACTIVITY_SYNC, null != e ? L.default.getNickname(e.guild_id, e.id, t) : void 0) : void 0,
                            disabled: A
