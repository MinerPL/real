        ...
        743925: function(e, t, i) {
            ...
            function f(e) {
                ...
                let i = (0, a.useStateFromStores)([r.default], r.default.getCurrentUser),
                    ...
                    y = l.useMemo(() => null != v && h.length > 0 && h[0].id === v && null != h[0].embeddedActivityConfig ? [{
        ...
        607573: function(e, t, i) {
            ...
            function A(e) {
                let {
                    ...
                    application: T,
                    activity: I
                } = t, M = I.client_platform_config[(0, v.default)((0, o.getOS)())], N = null != M.label_until && Date.now() < Date.parse(M.label_until), O = (0, h.default)({
                    applicationId: T.id,
                    size: _,
                    names: S
                }), P = null != I.activity_preview_video_asset_id ? (0, p.default)(T.id, I.activity_preview_video_asset_id) : null, C = (0, m.default)(), U = (0, b.default)(), x = (0, f.default)(i), L = x.find(e => {
                    let {
                        embeddedActivity: t
                    } = e;
