    ...
    ["14589"], {
            ...
            var i = function() {
                ...
                return i.prototype = {
                    ...
                    quantize: function(u, a) {
                        ...
                        var l, s, c, d, E, _, f, I, h, T, N, A, S, p, O, v, C = (l = u, E = Array(32768), l.forEach(function(n) {
                        ...
                        var D = (_ = u, f = C, N = 1e6, A = 0, S = 1e6, p = 0, O = 1e6, v = 0, _.forEach(function(e) {
        ...
        235004: function(t, e, n) {
            ...
            class M extends a.default.Store {
                ...
                hasFetchedAllSounds() {
                    return p === i.FETCHED && S === i.FETCHED
                }
            }
            M.displayName = "SoundboardStore";
            var R = new M(l.default, {
                LOGOUT: function() {
                    T.clear(), N.clear(), v.clear(), C = !1, p = i.NOT_FETCHED, S = i.NOT_FETCHED
                },
                ...
                GUILD_SOUNDBOARD_SOUND_PLAY_START: function(t) {
                    ...
                    N.set(i, u), v.set(o, a), o !== (null === (e = d.default.getCurrentUser()) || void 0 === e ? void 0 : e.id) && (C = !0)
                },
                ...
                SOUNDBOARD_FETCH_DEFAULT_SOUNDS_SUCCESS: function(t) {
                    ...
                    T.set(f.DEFAULT_SOUND_GUILD_ID, e), S = i.FETCHED
                },
