(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["39355"], {
                ...
                return (0, l.jsxs)("svg", {
                    ...
                    children: [(0, l.jsx)("g", {
                        ...
                        children: (0, l.jsx)("path", {
                            fill: "string" == typeof s ? s : s.css,
                            fillRule: "evenodd",
                            d: "M1.232 21.132a1 1 0 0 1 0-1.415l7.475-7.474a.5.5 0 0 1 .707 0l2.122 2.121a.5.5 0 0 1 0 .707L4.06 22.546a1 1 0 0 1-1.415 0l-1.414-1.414ZM7.757 7.757l3.071 3.072 2.122 2.12 3.293 3.294a2 2 0 0 0 2.828 0l3.536-3.536a2 2 0 0 0 0-2.828l-2.94-2.94.657-.656a1 1 0 0 0 0-1.415L18.91 3.454a1 1 0 0 0-1.414 0l-.657.657-2.718-2.718a2 2 0 0 0-2.828 0L7.757 4.93a2 2 0 0 0 0 2.828Z",
                            clipRule: "evenodd",
                            className: o
                        })
                    }), (0, l.jsx)("defs", {
        ...
        167109: function(e, t, n) {
            ...
            function N(e, t, n) {
                let i = (0, M.useEditStateStore)(e => e.setListing),
                    r = l.useCallback(l => {
                        i(e, e => {
                            var i;
            ...
            function U(e, t) {
                let n = (0, C.default)(t, e),
                    i = l.useMemo(() => null == n ? M.AllChannelAccessOptions.SOME_CHANNELS_ACCESS : (0, m.isAllChannelsRole)(n) ? M.AllChannelAccessOptions.ALL_CHANNELS_ACCESS : M.AllChannelAccessOptions.SOME_CHANNELS_ACCESS, [n]);
            ...
            async function J(e) {
                ...
                let i = l.role_id,
                    o = l.id,
                    u = M.useEditStateStore.getState().listings[n];
            ...
            async function X(e) {
                ...
                } = e, s = M.useEditStateStore.getState().listings[n];
                ...
                let _ = E === M.AllChannelAccessOptions.ALL_CHANNELS_ACCESS,
                    h = l;
                if (null == h) {
                ...
                let [e, t] = l.useState(!1), [n, i] = l.useState(), o = l.useCallback(async e => {
                    ...
                    try {
                        ...
                        function(e) {
                            ...
                            let u = M.useEditStateStore.getState().listings[l];
                            r(null != u, "edit state does not exist");
                            let {
                                name: a,
                                description: d,
                            ...
                            if (a !== o.name && (L.name = a), d !== o.description && (L.description = d), E !== (null === (t = o.subscription_plans[0]) || void 0 === t ? void 0 : t.price) && (L.priceTier = E), null != h && (L.image = h), null != m && (L.can_access_all_channels = m === M.AllChannelAccessOptions.ALL_CHANNELS_ACCESS), null != c || null != f) {
                            ...
                            d = e.id, f = l, E = d, M.useEditStateStore.setState(e => ({
                                listings: {
                                    ...e.listings,
                                    [E]: e.listings[f],
                                    [f]: void 0
            ...
            function $(e, t) {
                let n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {
                    ...
                    s = (0, M.useEditStateStore)(e => e.setEditStateIdsForGroup),
                    u = (0, M.useEditStateStore)(e => e.setListing),
                    a = l.useMemo(() => [...i.map(e => {
                        let {
                            id: t
                        } = e;
        ...
        246506: function(e, t, n) {
            ...
            function m(e) {
                ...
                let {
                    ...
                    className: C
                } = e, A = (0, o.useStateFromStores)([f.default], () => f.default.getCurrentUser()), v = E.default.useName(n, null, A), M = (0, u.getRoleIconProps)(r), g = i.useMemo(() => (0, a.createMessageRecord)({
                    ...(0, d.default)({
                        channelId: "0",
                        content: L,
                        tts: void 0,
