        ...
        369404: function(e, t, n) {
            ...
            function p(e) {
                let {
                    ...
                    withinStartWindow: B
                } = (0, v.getEventTimeData)(m), F = (0, u.useStateFromStores)([_.default], () => (null == p ? !void 0 : !p.isGuildVocal()) || _.default.can(D.Permissions.CONNECT, p), [p]), Y = (0, s.useShowMemberVerificationGate)(y);

                function j(e) {
                    e.stopPropagation(), R ? N.default.deleteRsvpForGuildEvent(O, y) : N.default.createRsvpForGuildEvent(O, y)
                }
                async function k(e) {
                ...
                function Z(e) {
                    ...
                    (0, l.closeAllModals)(), (0, c.transitionToGuild)(y, null == t ? void 0 : t.id)
                }
                return {
                    onDeleteClick: b ? function(e) {
                        e.stopPropagation(), b && !P && (0, l.openModal)(e => (0, i.jsx)(l.ConfirmModal, {
                            ...e,
                    ...
                    onEndClick: b && V === h.GuildScheduledEventEntityTypes.EXTERNAL && P ? function(e) {
                        if (e.stopPropagation(), !b) return;
                        let t = () => {
                            N.default.endEvent(O, y), (0, l.closeAllModals)()
                        };
