        ...
        752598: function(t, e, n) {
            ...
            let C = (t, e) => {
                ...
                let l = t.state === _.MessageStates.SEND_FAILED && (null == (n = t.id) || "" === n || Number.isNaN(n) ? Date.now() : a.default.extractTimestamp(n) + 3e3) < Date.now(),
                    ...
                    d = t.isCommandType();
                if (o && i === f.InteractionState.QUEUED || d && t.state === _.MessageStates.SENDING && null != e) return u.SENDING;
                if (o && i === f.InteractionState.CREATED || t.hasFlag(_.MessageFlags.LOADING) && !r) return u.CREATED;
