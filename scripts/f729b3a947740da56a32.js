    ...
    ["92214"], {
        ...
        918771: function(e, t, n) {
            ...
            var i = n("37983"),
                ...
                g = function(e) {
                    ...
                    if (r.useEffect(() => {
                            0 !== b.length && L.default.track(D.AnalyticEvents.PASSPORT_ENTRY_VIEWED, {
                                role_ids: b.map(e => {
                                    let {
                                        role_id: t
                                    } = e;
                ...
                (0, l.openModalLazy)(async () => {
                    ...
                    return n => {
                        ...
                        return (0, i.jsx)(e, {
                            ...
                            onComplete: () => {
                                h = !0, null == T || T(), !C && ((0, u.setIsPersistentHelperHidden)(!0), (0, u.setCanPlayWowMoment)(!0))
                            },
                            onSubscriptionConfirmation: S,
                            analyticsLocations: N,
                            analyticsObject: A,
                    ...
                    onCloseCallback: () => {
                        !h && E.default.track(s.AnalyticEvents.PAYMENT_FLOW_CANCELED, {
                            ...
                            application_id: m,
                            location_stack: N
                        }), (0, o.clearError)(), (0, a.clearPurchaseTokenAuthState)(), null == I || I(h), h && (!C && _.ComponentDispatch.dispatch(s.ComponentActions.PREMIUM_SUBSCRIPTION_CREATED), null == S || S())
                    },
        ...
        235004: function(e, t, n) {
            ...
            class P extends a.default.Store {
                ...
                hasFetchedAllSounds() {
                    return C === r.FETCHED && f === r.FETCHED
                }
            }
            P.displayName = "SoundboardStore";
            var M = new P(u.default, {
                LOGOUT: function() {
                    N.clear(), A.clear(), p.clear(), R = !1, C = r.NOT_FETCHED, f = r.NOT_FETCHED
                },
                ...
                OVERLAY_INITIALIZE: function(e) {
                    ...
                    N = new Map(Object.entries(t.soundboardSounds)), L = new Set(t.favoritedSoundIds), O = new Set(t.localSoundboardMutes)
                },
        ...
        364685: function(e, t, n) {
            ...
            var B = new y(a.default, {
                BACKGROUND_SYNC: () => {
                    L = null, C = new Map, D = new Map, O = 0
                },
                CONNECTION_OPEN: e => {
                    let {
                        guilds: t
                    } = e;
                    L = null, C = new Map, D = new Map, t.forEach(b), O = t.every(e => null != e.stickers) ? 1 : 0
                },
                ...
                LOGOUT: () => {
                    O = 0, p = [], C.clear(), f.clear(), L = null, D.clear(), D = new Map(D), U = !1, R = null
                },
