                    ...
                    switch (t.type) {
                        ...
                        case "oscillating-random":
                            ...
                            var f = z(t.minStart),
                                ...
                                O = z(t.minDirection),
                                A = z(t.maxDirection);
                            return new y(new b(x(n.x, r.x), x(f.x, h.x), x(d.x, p.x), x(v.x, g.x), j(O.x, A.x), C(t.easingFunctions)[0]), new b(x(n.y, r.y), x(f.y, h.y), x(d.y, p.y), x(v.y, g.y), j(O.y, A.y), C(t.easingFunctions)[0]))
                    }
                }(p(p({}, t), {
                    valueType: "Vector2"
                }))
            ...
            var S = r.forwardRef(function(t, e) {
                    ...
                    _ = r.useCallback(function() {
                        ...
                        if (null != t) {
                            ...
                            if (null != e) {
                                ...
                                }), null == y || y(e), k.current.size > 0 ? E.current = window.requestAnimationFrame(_) : (e.clearRect(0, 0, t.width, t.height), E.current = null);
                                var n = Date.now();
                                0 !== P.current && (R.current = 1e3 / (n - P.current)), P.current = n
                            }
                        }
                    }, [a, y, v]);
                r.useEffect(function() {
                    null != E.current && (window.cancelAnimationFrame(E.current), E.current = window.requestAnimationFrame(_))
                }, [_]);
                var V = r.useCallback(function(t, e) {
                    ...
                    F = r.useCallback(function(t, e, n, r, o) {
                        var a, u, c, f, h, d, v, y, z, S, k, E, P, R, _, F = (a = null !== (_ = t.id) && void 0 !== _ ? _ : (0, i.v4)(), u = t, c = n, f = r, h = o, y = A((v = (d = u, p(p({
                            id: a
                        }, s), d))).size), S = (z = function(t, e) {
                            if (null != t) {
                                ...
                                switch (t.type) {
                                    ...
                                    case "oscillating-random":
                                        ...
                                        var f = O(t.minStart),
                                            ...
                                            z = O(t.minDirection),
                                            A = O(t.maxDirection);
                                        return new g(new b(x(n.x, r.x), x(f.x, h.x), x(d.x, p.x), x(v.x, y.x), j(z.x, A.x), C(t.easingFunctions)[0]), new b(x(n.y, r.y), x(f.y, h.y), x(d.y, p.y), x(v.y, y.y), j(z.y, A.y), C(t.easingFunctions)[0]), new b(x(n.z, r.z), x(f.z, h.z), x(d.z, p.z), x(v.z, y.z), j(z.z, A.z), C(t.easingFunctions)[0]))
                                }
                            }(p(p({}, P), {
                                valueType: "Vector3"
                            }))),
                ...
                return r.useEffect(function() {
                    ...
                    return t("click", N, c), t("mousedown", T, f), t("mousemove", H, h), t("mouseup", B, d),
                        function() {
                ...
                }, [N, T, H, B, c, f, h, d]), r.useEffect(function() {
                    var t = S.current,
