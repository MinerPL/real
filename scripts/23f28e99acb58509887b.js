        ...
        622210: function(e, t, s) {
            ...
            function x(e) {
                let {
                    ...
                    hasFooter: I = !0,
                    isCommunity: h = !1
                } = e, [g, N] = a.useState(C.default.getGuildNameSuggestion()), [p, M] = a.useState(null), [S, A] = a.useState(!1), [j, D] = a.useState(null), U = (0, c.useUID)(), B = a.useRef(null);
                a.useEffect(() => {
                    var e;
                    L && (null === (e = B.current) || void 0 === e || e.focus())
                }, [L]);
                let H = a.useCallback(async e => {
                    ...
                    O = (0, l.jsxs)(l.Fragment, {
                        children: [(0, l.jsx)(r.Button, {
                            ...
                            disabled: 0 === g.length,
                            submitting: S,
                            children: null != x ? f.default.Messages.NEXT : f.default.Messages.CREATE
                        }), (0, l.jsx)(r.Button, {
                    ...
                    G = (0, l.jsxs)(l.Fragment, {
                        children: [(0, l.jsxs)(r.ModalHeader, {
                            ...
                            children: [(0, l.jsx)(r.Heading, {
                                ...
                                children: f.default.Messages.NUF_CREATE_SERVER_CUSTOMIZE_HEADER
                            }), (0, l.jsx)(r.Text, {
                                className: T.subtitle,
                                color: "header-secondary",
                                variant: "text-md/normal",
                                children: f.default.Messages.NUF_CREATE_SERVER_CUSTOMIZE_SUBHEADER
                            ...
                            children: [(0, l.jsx)("div", {
                                ...
                                children: [(0, l.jsxs)(r.FormItem, {
                                    ...
                                    children: [(0, l.jsx)(r.FormTitle, {
                                        tag: "label",
                                        htmlFor: U,
                                        children: f.default.Messages.FORM_LABEL_SERVER_NAME
                                    }), (0, l.jsx)(r.TextInput, {
                                        type: "text",
                                        value: g,
                                        maxLength: 100,
                                    ...
                                    children: f.default.Messages.CREATE_SERVER_GUIDELINES.format({
        ...
        694410: function(e, t, s) {
            ...
            var l = s("773670"),
                ...
                c = (e, t) => {
                    ...
                    }, [e]), E = l.useCallback(async () => {
                        c(!0), await d.fetchGuildEntriesForIds(t, m.map(e => e.id)), c(!1)
                    }, [t, m]);
                    l.useEffect(() => {
                        E()
                    }, []);
                    let f = l.useMemo(() => m.filter(e => !(null == C ? void 0 : C.has(e.id))), [m, C]),
        ...
        426253: function(e, t, s) {
            ...
            function h(e) {
                let {
                    ...
                    guild: s
                } = e, l = (0, o.useStateFromStores)([E.default], () => E.default.getDirectoryEntry(t, s.id));
                return (0, i.jsxs)("div", {
            ...
            function g(e) {
                let t, {
                    ...
                    [L, g] = n.useState(a.AVAILABLE);
                return t = f ? (0, i.jsx)("div", {
                    className: x.emptyContainer,
                    children: (0, i.jsx)(u.Spinner, {})
                }) : L === a.AVAILABLE ? 0 === m.length ? (0, i.jsxs)("div", {
                    className: x.emptyContainer,
        ...
        467085: function(e, t, s) {
            ...
            function I(e) {
                let {
                    directoryChannelId: t,
                    transitionState: s,
                    initialSlide: I = x.CreateOrAddGuildSlideTypes.CHOOSE_GUILD,
                    onClose: h,
                    directoryGuildName: g,
                    directoryGuildId: N,
                    currentCategoryId: p
                } = e, [M, S] = a.useState(I), [A, j] = a.useState(null), [D, U] = a.useState(null), [B, H] = a.useState(null), [O, G] = a.useState(null), [R, y] = a.useState(null), [v, b] = a.useState(""), [k, F] = a.useState(null != p ? p : x.DirectoryEntryCategories.UNCATEGORIZED), [Z, V] = a.useState(!1), {
                    availableGuilds: w,
                    addedGuilds: P,
                    loading: z
                } = (0, C.default)(N, t);
                ...
                let Y = async () => {
                    ...
                    if (!Z) {
                        ...
                        let t = await r.default.createGuildFromTemplate(B, O, D);
                        y(e = new o.default(t))
                    }
                            ...
                            children: (0, l.jsxs)(n.Slides, {
                                ...
                                children: [(0, l.jsx)(n.Slide, {
                                    ...
                                    children: (0, l.jsx)(T.default, {
                                        directoryGuildName: g,
                                        onChooseTemplate: e => {
                                            V(!1), S(x.CreateOrAddGuildSlideTypes.CUSTOMIZE_NEW_GUILD), U(e)
                                        },
                                        onClose: h,
        ...
        640952: function(e, t, s) {
            ...
            function c(e) {
                let {
                    ...
                    onClose: f,
                    onBack: T
                } = e, [x, _] = a.useState(!1), [L, I] = a.useState(null), h = async () => {
                    _(!0);
                    try {
                        await E()
                    } catch (e) {
                    ...
                    children: [(0, l.jsxs)(i.ModalHeader, {
                        ...
                        children: [(0, l.jsx)(i.FormItem, {
                            ...
                            children: (0, l.jsx)(i.TextArea, {
                                ...
                                onChange: c,
                                error: null == L ? void 0 : L.getAnyErrorMessage()
                            })
                        }), (0, l.jsx)(i.FormItem, {
