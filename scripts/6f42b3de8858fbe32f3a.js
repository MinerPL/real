(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["9311"], {
        ...
        743506: function(e, t, _) {
            ...
            function R(e) {
                let {
                    ...
                    onClose: S,
                    canBulkBan: d = !1
                } = e, [m, p] = n.useState(N), [U, P] = n.useState(""), [g, D] = n.useState(i.INITIAL), [G, f] = n.useState(!1), h = (0, o.useTrackModerationAction)(t, {
                    location: R,
                    targetUserId: null == E ? void 0 : E.id,
                    targets: L
                }), v = n.useCallback(() => {
                    if (null != M) {
                        let e = null != L && (null == L ? void 0 : L.size) > 0 && d;
                        if (!e || G) return;
                        if ("" === U.trim() && !G) {
                            f(!0);
                            return
                        ...
                        if (null == E) return;
                        I.default.banUser(t, null == E ? void 0 : E.id, m, U)
                    }
                    h(o.ModerationActionType.BAN), S()
                }, [M, h, S, L, d, G, U, t, m, E]), B = n.useCallback(e => {
                    p(e)
                }, []), H = n.useCallback(e => {
                    let {
                        value: t
                    ...
                    return null == E ? "" : A.default.Messages.BAN_CONFIRM_TITLE.format({
                        username: "@".concat(T.default.getName(t, null, E))
                    })
                })();
        ...
        130037: function(e, t, _) {
            ...
            function A(e) {
                let t = l.useCallback(t => {
                    ! function(e) {
                        ...
                        u(T.AnalyticEvents.MOD_DASH_SEARCH_MEMBERS, t)
                    }(e)
                }, [e]);
                return t
            }
            ...
            function c(e) {
                let t = l.useCallback(t => {
                    ! function(e, t) {
                        ...
                        u(T.AnalyticEvents.MOD_DASH_FILTER_ROLES, _)
                    }(e, t)
                }, [e]);
                return t
            ...
            function O(e) {
                let t = l.useCallback(t => {
                    ! function(e, t) {
                        ...
                        u(T.AnalyticEvents.MOD_DASH_FILTER_SAFETY_FLAGS, _)
                    }(e, t)
                }, [e]);
                return t
            }
            ...
            function N(e, t) {
                let {
                    ...
                    u(T.AnalyticEvents.MODERATION_ACTION, a)
                }, [e, _, E, i]);
                return a
        ...
        387111: function(e, t, _) {
            ...
            function r(e, t, _) {
                var E;
                return null == _ ? I.default.Messages.UNKNOWN_USER : null !== (E = o(e, t, _)) && void 0 !== E ? E : l.default.getName(_)
            }
            var s = {
                getNickname: o,
                getName: r,
                useName: function(e, t, _) {
                    return (0, E.useStateFromStores)([a.default, i.default, n.default], () => r(e, t, _))
                }
            }
        },
