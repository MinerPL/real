(this.webpackChunkdiscord_app = this.webpackChunkdiscord_app || []).push([
    ["51719"], {
        ...
        244480: function(e, t, a) {
            ...
            function T(e, t) {
                let a = e.getGuildId();
                return n(null != a, "This channel cannot be guildless."), t && (0, r.trackWithMetadata)(E.AnalyticEvents.REQUEST_TO_SPEAK_INITIATED, {
                    ...(0, g.getStageChannelMetadata)(e)
                }), i.default.patch({
                    url: E.Endpoints.UPDATE_VOICE_STATE(a),
                    body: {
            ...
            function S(e, t) {
                ...
                return n(null != a, "This channel cannot be guildless."), i.default.patch({
                    url: E.Endpoints.UPDATE_VOICE_STATE(a, t),
                    body: {
                        suppress: !1,
            ...
            function v(e, t) {
                ...
                return n(null != a, "This channel cannot be guildless."), N(t, e.id, !0), i.default.patch({
                    url: E.Endpoints.UPDATE_VOICE_STATE(a, e.id),
                    body: {
                        suppress: !0,
                        channel_id: t.id,
                        self_video: !1,
            ...
            async function O(e, t, a, l) {
                ...
                let s = await (0, m.startStageInstance)(e.id, t, a, l);
                return p(e, !1, !0), s
            }
            async function x(e, t, a) {
                if ("" === t) return;
                let l = await (0, m.updateStageInstance)(e.id, t, a);
                return l
            }
            async function P(e) {
