    ...
    ["89906"], {
        238455: function(e, t, n) {
            ...
            e.exports = function(e, t) {
                var n = r(e),
                    ...
                    S = T.length;
                for (var I in e)(t || s.call(e, I)) && !(_ && ("length" == I || E && ("offset" == I || "parent" == I) || c && ("buffer" == I || "byteLength" == I || "byteOffset" == I) || o(I, S))) && T.push(I);
                return T
            }
        },
        ...
        152584: function(e, t, n) {
            ...
            function f(e, t) {
                ...
                return (0, d.default)(t => i.default.post({
                    ...
                    E.default.logoutInternal(), (0, o.transitionTo)(c.Routes.DEFAULT_LOGGED_OUT)
                })
            }
            async function A(e) {
            ...
            function p(e) {
                ...
                return a.default.dispatch({
                    ...
                    let u = l.default.get(c.DEVICE_TOKEN),
        ...
        686298: function(e, t, n) {
            ...
            let f = [I(a.RESOLUTION_720), I(a.RESOLUTION_1080), I(a.RESOLUTION_1440), I(a.RESOLUTION_SOURCE, () => E.default.Messages.SCREENSHARE_SOURCE)],
                ...
                p = e => "".concat(e, "p"),
                O = [I(a.RESOLUTION_480, () => p(a.RESOLUTION_480)), I(a.RESOLUTION_720, () => p(a.RESOLUTION_720)), I(a.RESOLUTION_1080, () => p(a.RESOLUTION_1080)), I(a.RESOLUTION_1440, () => p(a.RESOLUTION_1440)), I(a.RESOLUTION_SOURCE, () => E.default.Messages.SCREENSHARE_SOURCE)],
            ...
            let u = (0, l.createExperiment)({
                ...
                E = function() {
                    ...
                    let {
                        ...
                        user: l,
                        config: a
                    }), c = o && E && null != t && (null == t ? void 0 : null === (e = t.inventorySettings) || void 0 === e ? void 0 : e.isEmojiPackCollectible) !== !1;
                    return {
                        viewAndUseEnabled: o,
                        collectEnabled: c,
                        showTryPacksModalAndV2Copy: d
        ...
        865372: function(e, t, n) {
            ...
            class f extends r.default.PersistedStore {
                initialize(e) {
                    this.waitFor(s.default), null != e && (c = e), this.syncWith([s.default], S), this.syncWith([u.default], I)
                }
                getState() {
                    return c
                }
        ...
        364685: function(e, t, n) {
            ...
            var F = new G(o.default, {
                BACKGROUND_SYNC: () => {
                    R = null, N = new Map, g = new Map, p = 0
                },
                CONNECTION_OPEN: e => {
                    let {
                        guilds: t
                    } = e;
                    R = null, N = new Map, g = new Map, t.forEach(b), p = t.every(e => null != e.stickers) ? 1 : 0
                },
                GUILD_CREATE: function(e) {
                    let {
                        guild: t
                    } = e;
                    !c.default.isLurking(t.id) && (b(t), 1 === p && null == t.stickers && null != t.stickerUpdates && (p = 0))
                },
                ...
                LOGOUT: () => {
                    p = 0, C = [], N.clear(), O.clear(), R = null, g.clear(), g = new Map(g), U = !1, m = null
                },
                ...
                GUILD_STICKERS_UPDATE: e => {
                    ...
                    }, r = null !== (t = g.get(n)) && void 0 !== t ? t : [], a = r.filter(e => null == i.find(t => t.id === e.id));
                    a.forEach(e => {
            ...
            var l = n("77078"),
                ...
                U = (0, o.default)((0, a.default)(function(e) {
                    let {
                        ...
                        onSelect: o
                    } = e, s = (0, O.default)(t.id), C = (0, A.default)(t.id), U = (0, I.default)(t), g = (0, T.default)({
                        user: t
                    }), L = (0, _.default)(t), h = (0, R.default)(t.id), M = (0, N.default)(t.id), P = (0, p.default)(t.id, a), D = (0, f.default)(t), v = (0, u.default)(null, t), y = (0, c.default)(t), b = (0, S.default)(t), G = (0, d.default)({
                        id: t.id,
                        label: m.default.Messages.COPY_ID_USER
                    }), F = (0, E.default)(t), w = t.isNonUserBot();
        ...
        692986: function(e, t, n) {
            ...
            function p(e) {
                let t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : I.MediaEngineContextTypes.DEFAULT,
                    ...
                    p = (0, l.useStateFromStores)([u.default], () => u.default.isLocalSoundboardMuted(e)),
                    {
                        muted: O,
                        deafened: N = !1,
                    ...
                    U = n ? null : (0, i.jsx)(r.MenuCheckboxItem, {
        ...
        816106: function(e, t, n) {
            ...
            function _(e) {
                ...
                return T ? null : (0, i.jsx)(r.MenuControlItem, {
                    id: "user-volume",
                    label: S ? c.default.Messages.STREAM_VOLUME : c.default.Messages.USER_VOLUME,
                    control: (t, l) => (0, i.jsx)(r.MenuSliderControl, {
                        ...
                        "aria-label": S ? c.default.Messages.STREAM_VOLUME : c.default.Messages.USER_VOLUME
                    })
                })
            }
        },
        ...
        26092: function(e, t, n) {
            ...
            function U(e) {
                ...
                if (null == d) return g();
                E = null !== (t = e.section) && void 0 !== t ? t : E, C = null !== (n = e.section) && void 0 !== n ? n : E, null != e.subsection && null != E && (c[E] = e.subsection), null != e.scrollPosition && null != E && (_[E] = e.scrollPosition), A = !!e.openWithoutBackstack, s = u.FormStates.OPEN, T = {}, I = {
                    ...S = {
            ...
            function g() {
                s = u.FormStates.CLOSED, f = !1, S = null, C = null, I = null, d = null, E = null, c = {}, _ = {}, O = null, N = null, R = [], m = null
            }
            ...
            class h extends r.default.Store {
                ...
                hasChanges() {
                    return null != I && null != S && (!!this.isOpen() || p === u.DrawerTabTypes.USER_SETTINGS) && !l.isEqual(I, S)
                }
                isOpen() {
                    return f
                }
            ...
            var M = new h(a.default, {
                ...
                USER_SETTINGS_MODAL_SET_SECTION: function(e) {
                    var t;
                    d = E, E = e.section, N = null, R = null !== (t = e.analyticsLocations) && void 0 !== t ? t : [], null != e.subsection && (c[E] = e.subsection)
                },
                ...
                DRAWER_SELECT_TAB: function(e) {
                    return p = e.tab, null == E && p === u.DrawerTabTypes.USER_SETTINGS && U({
                        type: "USER_SETTINGS_MODAL_INIT",
                        section: null,
                        subsection: null,
                        scrollPosition: null,
