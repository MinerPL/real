    ...
    ["23175"], {
        ...
        169626: function(e, t, n) {
            ...
            function S(e) {
                let {
                    ...
                    onSlideChange: A,
                    hasJoinButton: g
                } = e, [C, N] = i.useState(n), R = (0, u.default)(C), [M, v] = i.useState(null), [L, O] = i.useState(null), [y, D] = i.useState(null), [U, w] = i.useState(!1);
                i.useEffect(() => {
                    N(n)
                }, [N, n]), i.useEffect(() => {
                    C !== R && A(C)
                ...
                let F = i.useCallback(e => {
                        N(h.CreateGuildSlideTypes.CREATION_INTENT), O(e), d.default.track(T.AnalyticEvents.GUILD_TEMPLATE_SELECTED, {
                            template_name: e.id,
                    ...
                    P = i.useCallback(() => N(h.CreateGuildSlideTypes.JOIN_GUILD), [N]),
                    x = i.useCallback(() => {
                            ...
                            children: (0, r.jsxs)(o.Slides, {
                                ...
                                children: [(0, r.jsx)(o.Slide, {
                                    ...
                                    children: (0, r.jsx)(_.default, {
                                        ...
                                        onClose: S,
                                        onBack: x,
                                        isSlideReady: M === h.CreateGuildSlideTypes.CUSTOMIZE_GUILD,
                                        isCommunity: U
                                    })
                                }), (0, r.jsx)(o.Slide, {
                                    ...
                                    children: (0, r.jsx)(E.default, {
                                        ...
                                        isSlideReady: M === h.CreateGuildSlideTypes.CHANNEL_PROMPT
                                    })
                                }), (0, r.jsx)(o.Slide, {
                                    ...
                                    children: (0, r.jsx)(p.default, {
                                        onBack: x,
                                        onClose: S,
                                        isSlideReady: M === h.CreateGuildSlideTypes.JOIN_GUILD
                                    })
                                })]
                            })
                        })
        ...
        110337: function(e, t, n) {
            ...
            let C = (r = window.GLOBAL_ENV.INVITE_HOST, i = "", null == r && (r = location.host, i = p.Routes.INVITE("")), "".concat(location.protocol, "//").concat(r).concat(i, "/")),
                N = [A, "".concat(C).concat(A), "".concat(C).concat("cool-people")],
                R = e => {
                    let {
                        onClick: t
                    } = e;
                    return (0, l.jsxs)(u.Clickable, {
                        ...
                        onClick: () => {
                            t(), (0, E.transitionTo)(p.Routes.GUILD_DISCOVERY)
                        },
            ...
            function M(e) {
                let {
                    ...
                    onClose: n,
                    isSlideReady: r
                } = e, [i, s] = a.useState(""), [E, _] = a.useState(!1), [p, m] = a.useState(null), S = a.useRef(null);
                a.useEffect(() => {
                    var e;
        ...
        42963: function(e, t, n) {
            ...
            function f(e, t) {
                let {
                    [e]: n, ...r
                } = E.getState().flows, i = null != n ? n : c(e);
                if ((null == i ? void 0 : i.currentStep) == null || i.currentStep !== t) E.setState({
                    flows: {
                        ...r,
                        [e]: {
                            type: e,
            ...
            function _(e, t) {
                ...
                if (e === s.FlowType.ANY) {
                    var i;
                    r = null !== (i = E.getState().activeFlow()) && void 0 !== i ? i : s.FlowType.UNKNOWN
                }
                let {
                    [r]: l, ...a
                } = E.getState().flows, o = null != l ? l : c(r);
