    ...
    ["74945"], {
        545876: function(e, t, l) {
            ...
            class I extends a.Component {
                ...
                formatInterval(e) {
                    if (e === f.SubscriptionIntervalTypes.YEAR) return L.default.Messages.PREMIUM_SUBSCRIPTION_INTERVAL_YEAR;
                    if (e === f.SubscriptionIntervalTypes.MONTH) return L.default.Messages.PREMIUM_SUBSCRIPTION_INTERVAL_MONTH;
                ...
                render() {
                    ...
                    return (c(!C || null != v, "subscriptionPlan cannot be null if shouldShowUpdatedPaymentModal is true"), n || null != e && !a || E) ? (0, s.jsxs)("div", {
                        className: o,
                        children: [E && (0, s.jsx)(d.FormTitle, {
                            className: m.formTitle,
                            children: L.default.Messages.BILLING_ONLINE_PURCHASE_WAIVER
                        }), null != e && (n || !a) ? (0, s.jsx)(d.Checkbox, {
                        ...
                        }) : null, null == I ? null : (0, s.jsx)("div", {
                            className: r(m.finePrint, M),
                            children: I
                        }), E ? (0, s.jsxs)("div", {
                            className: o,
                            children: [(0, s.jsx)(d.Checkbox, {
                                type: d.Checkbox.Types.INVERTED,
                                value: R,
                            ...
                            children: ["*", L.default.Messages.BILLING_HOW_PRICING_WORKS.format({
                                documentationLink: h.default.getArticleURL(A.HelpdeskArticles.LOCALIZED_PRICING)
                            })]
                        }), C && null != v && (0, s.jsx)(d.Text, {
                            variant: "text-xs/medium",
                            color: "interactive-normal",
                            children: L.default.Messages.BILLING_TRIAL_LEGAL_COPY_V2.format({
                                buttonText: (0, p.getBillingReviewSubheader)(null, v),
                                interval: this.formatInterval(null == v ? void 0 : v.interval),
                                cancelSubscriptionArticle: h.default.getArticleURL(A.HelpdeskArticles.PREMIUM_DETAILS_CANCEL_SUB),
                                paidServiceTermsArticle: h.default.getArticleURL(A.HelpdeskArticles.PAID_TERMS)
                            })
                        }), _ && null != v && (0, s.jsx)(d.Text, {
                            variant: "text-xs/medium",
                            color: "interactive-normal",
