    ...
    ["2872"], {
            ...
            class s extends r.default.PersistedStore {
                ...
                hasHotspot(e) {
                    let t = arguments.length > 1 && void 0 !== arguments[1] && arguments[1],
                        n = !t && a[e];
                    return !(o.CONFERENCE_MODE_ENABLED || i.ProcessArgs.isDisallowPopupsSet()) && (n || !l.has(e))
                }
                hasHiddenHotspot(e) {
                    return l.has(e)
                }
        ...
        75015: function(e, t, n) {
            ...
            let a = 568,
                ...
                O = a / C,
                M = a / L,
                T = l.BACKGROUND_REPLACEMENT_SIZE.width / l.BACKGROUND_REPLACEMENT_SIZE.height,
                v = a / T;
        ...
        716849: function(e, t, n) {
            ...
            function I(e) {
                let {
                    ...
                    autoTrackExposure: !1
                }), r = d.default.shouldFetchPremiumLikelihood(), u = a.default.getCurrentUser();
                R(u, r, t, n)
            }
            ...
            function A(e) {
                let {
                    ...
                    autoTrackExposure: !1
                }), i = (0, u.default)([d.default], () => d.default.shouldFetchPremiumLikelihood()), o = (0, u.default)([a.default], () => a.default.getCurrentUser());
                r.useEffect(() => {
                    R(o, i, t, n)
                }, [o, i, t, n])
            }
            ...
            function R(e, t, n, r) {
                null != e && !(0, c.isPremium)(e) && n && (t && h(), r && (!s.default.isLoadedForSKU(E.PremiumSubscriptionSKUs.TIER_0) && !s.default.isFetchingForSKU(E.PremiumSubscriptionSKUs.TIER_0) && (0, l.fetchSubscriptionPlansForSKU)(E.PremiumSubscriptionSKUs.TIER_0), !s.default.isLoadedForSKU(E.PremiumSubscriptionSKUs.TIER_2) && !s.default.isFetchingForSKU(E.PremiumSubscriptionSKUs.TIER_2) && (0, l.fetchSubscriptionPlansForSKU)(E.PremiumSubscriptionSKUs.TIER_2)))
            }
        },
        ...
        381736: function(e, t, n) {
            ...
            function v(e) {
                let {
                    ...
                    onEnable: T,
                    onClose: v
                } = e, m = I.default.getCameraComponent(), H = (0, C.useUID)(), N = (0, h.default)(), g = d.AlwaysPreviewVideo.useSetting(), [D, P] = u.useState((0, E.getLastUsedVideoBackgroundOption)(A.default.getCurrentUser())), U = (0, a.useAnalyticsContext)(), {
                    AnalyticsLocationProvider: x
                } = (0, c.default)(s.default.CAMERA_PREVIEW), y = u.useRef(null);
                u.useEffect(() => {
                    L.default.track(p.AnalyticEvents.OPEN_MODAL, {
                        ...
                        children: (0, r.jsxs)(i.ModalRoot, {
                            ...
                            children: [(0, r.jsxs)(i.ModalContent, {
                                ...
                                children: [(() => {
                                    ...
                                    value: g,
                                    onChange: () => {
                                        d.AlwaysPreviewVideo.updateSetting(!g), L.default.track(p.AnalyticEvents.UPDATE_USER_SETTINGS_LOCAL, {
        ...
        58608: function(e, t, n) {
            ...
            let s = e => {
                let {
                    ...
                    mediaLayoutType: d,
                    ...E
                } = e, f = (0, o.useStateFromStores)([l.default], () => l.default.useReducedMotion), _ = u.useRef(null);
