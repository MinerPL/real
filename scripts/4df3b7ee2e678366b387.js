    ...
    ["49060"], {
        ...
        752598: function(t, e, n) {
            ...
            let N = async t => {
                ...
                await c.default.unarchiveThreadIfNecessary(I), (0, E.addQueued)(N, {
                    messageId: n,
                    data: {
        ...
        85166: function(t, e, n) {
            ...
            function I(t, e, n) {
                ...
                let T = u.default.getChannel(n),
                    ...
                    N = (null === (I = s.default.getCurrentUser()) || void 0 === I ? void 0 : I.id) === t.id,
                    p = (0, i.useStateFromStores)([o.default], () => null != n && o.default.canWithPartialContext(E.Permissions.MUTE_MEMBERS, {
                        channelId: n
                    }), [n]);
                return null != T && null != _ && (p || N) && S.speaker ? (0, r.jsx)(a.MenuItem, {
                    id: "audience",
                    ...
                    action: () => {
                        N ? (0, c.moveSelfToAudience)(T) : (0, c.moveUserToAudience)(t, T)
                    }
                }) : null
            }
        },
            ...
            var i = n("77078"),
                ...
                j = (0, l.default)((0, u.default)(function(t) {
                    let {
                        ...
                        onSelect: V,
                        onHeightUpdate: Y
                    } = t, W = (0, b.default)(e.id, n, u.id), K = (0, y.default)(e, n, k), Q = (0, R.default)(e.id, k), X = (0, P.default)(e.id), Z = (0, g.default)(e, k), z = (0, h.default)({
                        user: e,
                        guildId: n,
                        context: k
                        ...
                        context: k
                    }), te = (0, M.default)(e, n), tn = (0, s.default)(null, e), tr = (0, A.default)(e), ti = (0, D.default)(e), ta = (0, m.default)(e, n, u.id), tu = (0, U.default)(e.id, n), tl = (0, L.default)(e, n), to = (0, T.default)({
                        id: e.id,
                        label: x.default.Messages.COPY_ID_USER
                    }), ts = (0, G.default)(e.id, u.id), tc = (0, E.default)(e.id), td = (0, d.default)(u.id), tE = (0, N.default)(e), tf = (0, p.default)(e, n, u.id), tI = (0, O.default)({
                        commandType: o.ApplicationCommandType.USER,
                        commandTargetId: e.id,
                        channel: u,
                        guildId: n,
                        onShow: Y
                    }), tT = (0, f.default)(e.id), t_ = (0, S.default)(e, n, k), tS = e.isNonUserBot(), tN = e.isClyde(), tp = (0, I.useIsDMsToClydeEnabled)();
            ...
            var r = n("920040"),
                ...
                p = t => {
                    let {
                        ...
                        guildId: p,
                        onShow: A
                    } = t, C = i.useRef(!1), h = i.useRef(0), m = (0, l.useStateFromStores)([T.default], () => T.default.getGuild(null != p ? p : a.guild_id)), {
                        hasMoreAfter: O,
                        scrollDown: D,
                    ...
                    }, [G, g, M]), L = i.useMemo(() => (0, d.canUseContextMenuCommands)(a, y.length, s.getCommandTypeCount(a, e, null == m ? void 0 : m.applicationCommandCounts)), [a, e, y.length, null == m ? void 0 : m.applicationCommandCounts]);
                    i.useEffect(() => {
                        if (L !== C.current) {
                            if (L) null == A || A();
                            C.current = L
                    ...
                    let v = i.useCallback(t => {
                            O && t + 500 > 34 * y.length - 40 && D(), h.current = t
                        }, [O, D, y]),
                        b = i.useCallback(t => {
        ...
        459870: function(t, e, n) {
            ...
            function h(t, e) {
                let n = (0, i.useStateFromStores)([d.default], () => d.default.getChannels(e)[d.GUILD_VOCAL_CHANNELS_KEY], [e]),
                    h = (0, i.useStateFromStores)([S.default, c.default], () => {
                ...
                let D = n.filter(e => {
                    ...
                    return n.id !== h.id && (O ? I.default.can(A.Permissions.CONNECT, n) && !(0, N.isChannelFull)(n, S.default, f.default) : I.default.can(A.Permissions.MOVE_MEMBERS, n) && (I.default.can(A.Permissions.CONNECT, n) || p.default.can({
                        permission: A.Permissions.CONNECT,
                        user: t,
                        context: n
                    })) && !(0, N.isChannelFull)(n, S.default, f.default))
                });
