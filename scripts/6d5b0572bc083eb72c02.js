        ...
        291850: function(e, t, s) {
                ...
                return (0, n.jsxs)(v.default, {
                    ...
                    children: [(0, n.jsx)("img", {
                        ...
                        children: [(0, n.jsx)(v.Button, {
                            submitting: i || r === H.LoginStates.LOGGING_IN_MFA_WEBAUTHN,
                            onClick: () => {
                                u(!0);
                                ...
                                l.get(JSON.parse(e)).then(e => {
                                    u(!1), _.default.loginMFA({
                                        ...
                                        isWebAuthn: !0
                                    }), G.ComponentDispatch.dispatch(H.ComponentActions.WAVE_EMPHASIZE)
                                }).catch(e => {
                            ...
                            disabled: r === H.LoginStates.LOGGING_IN_MFA_WEBAUTHN,
                            onClick: () => {
                                E.default.dispatch({
                                    type: "LOGIN_MFA_WEBAUTHN_TO_TOTP"
                                })
            ...
            class Y extends a.PureComponent {
                ...
                componentDidMount() {
                    ...
                    e && !t ? (0, f.handoffBegin)() : t && this.loginOrSSO(t, a, !0), B.default.track(H.AnalyticEvents.LOGIN_VIEWED, {
                ...
                transitionSSO(e) {
                    ...
                    else if (null == a.service) t(H.Routes.APP);
                    else {
                        let e = window.location.protocol + window.GLOBAL_ENV.API_ENDPOINT + H.Endpoints.SSO,
                            t = {
                                ...a,
                ...
                renderDisabledAccount() {
                    let {
                        authBoxClassName: e
                    } = this.props, t = this.props.loginStatus === H.LoginStates.ACCOUNT_DISABLED, s = t ? W.default.Messages.ACCOUNT_DISABLED_TITLE : W.default.Messages.ACCOUNT_SCHEDULED_FOR_DELETION_TITLE, a = t ? W.default.Messages.ACCOUNT_DISABLED_DESCRIPTION : W.default.Messages.ACCOUNT_SCHEDULED_FOR_DELETION_DESCRIPTION;
                    return (0, n.jsx)(v.default, {
                        tag: "form",
                            ...
                            children: [this.canShowChooseAccount && this.state.dismissedChooseAccount && (0, n.jsx)(v.Button, {
                                ...
                                children: (0, n.jsxs)(v.Block, {
                                    ...
                                    children: [(0, n.jsx)(O.default, {
                                        ...
                                        type: "submit",
                                        submitting: r === H.LoginStates.LOGGING_IN,
                    ...
                    return (0, n.jsxs)(v.default, {
                        ...
                        children: [(0, n.jsx)("img", {
                            ...
                            children: [(0, n.jsx)(v.Input, {
                                ...
                                type: "submit",
                                submitting: e === H.LoginStates.LOGGING_IN_MFA,
                                children: W.default.Messages._LOGIN
                            }), t ? (0, n.jsx)(v.Button, {
                                onClick: this.handleToggleSMSLogin,
                                submitting: e === H.LoginStates.LOGGING_IN_MFA_SMS,
                                className: K.marginTop8,
                                look: v.Button.Looks.LINK,
                                color: v.Button.Colors.LINK,
                ...
                renderMFASMS() {
                    ...
                    let {
                        ...
                        maskedPhone: t,
                        authBoxClassName: a
                    } = this.props, l = e === H.LoginStates.LOGGING_IN_MFA_SMS || "" === t;
                    return (0, n.jsxs)(v.default, {
                ...
                render() {
                    ...
                    switch (a) {
                        case H.LoginStates.LOGGING_IN_MFA_SMS:
                        case H.LoginStates.MFA_SMS_STEP:
                            return this.renderMFASMS();
                        case H.LoginStates.LOGGING_IN_MFA:
                        case H.LoginStates.MFA_STEP:
                            return this.renderMFA();
                        case H.LoginStates.MFA_WEBAUTHN_STEP:
                        case H.LoginStates.LOGGING_IN_MFA_WEBAUTHN:
                            return this.renderMFAWebAuthn();
                        case H.LoginStates.ACCOUNT_SCHEDULED_FOR_DELETION:
                        case H.LoginStates.ACCOUNT_DISABLED:
                            return this.renderDisabledAccount();
                        case H.LoginStates.PHONE_IP_AUTHORIZATION:
                            return this.renderIPAuthorization();
                        case H.LoginStates.PASSWORD_RECOVERY_PHONE_VERIFICATION:
                            return this.renderPasswordRecovery();
                        case H.LoginStates.LOGGING_IN:
                        case H.LoginStates.NONE:
                        default:
                            if (null != t && t.state === H.InviteStates.RESOLVING) return this.renderResolving();
                            if (null != s) {
                ...
                constructor(e) {
                    ...
                    super(e), this.handleAuthToken = async e => {
                        await _.default.loginToken(e, !1), B.default.track(H.AnalyticEvents.LOGIN_SUCCESSFUL, {
                            source: H.LoginSuccessfulSources.QR_CODE,
                            login_source: this.loginSource,
                        ...
                        return G.ComponentDispatch.dispatch(H.ComponentActions.WAVE_EMPHASIZE), _.default.loginMFAv2({
                            code: s,
                            ticket: n,
                            mfaType: t,
                            source: this.loginSource,
                        ...
                        null != e && e.preventDefault(), _.default.requestSMSToken(t), G.ComponentDispatch.dispatch(H.ComponentActions.WAVE_EMPHASIZE)
                    }, this.handleForgotPassword = async e => {
                        null != e && e.preventDefault(), null != this.loginRef && this.loginRef.focus();
                        let t = this.getFullLogin();
                        try {
                            G.ComponentDispatch.dispatch(H.ComponentActions.WAVE_EMPHASIZE), await _.default.forgotPassword(t), (0, c.openModal)(e => (0, n.jsx)(c.ConfirmModal, {
                        ...
                        "" !== t && (u.email = t), null != s ? (u.mode = "register", e = H.Routes.INVITE(s.code)) : null != n ? (u.mode = "register", e = H.Routes.GIFT_CODE(n.code)) : null != a ? e = H.Routes.GUILD_TEMPLATE(a.code) : null != o ? (e = H.Routes.REGISTER, u.redirect_to = o) : e = H.Routes.REGISTER, _.default.loginReset(), r(e, {
