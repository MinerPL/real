    ...
    ["60915"], {
        ...
        743925: function(e, t, i) {
            ...
            function f(e) {
                ...
                let i = (0, a.useStateFromStores)([r.default], r.default.getCurrentUser),
                    ...
                    p = (0, a.useStateFromStores)([o.default], () => o.default.testModeEmbeddedApplicationId),
                    v = f.map(e => e.application_id),
                    m = null != p ? [p, ...v] : v,
                    b = (0, n.default)(m),
                    h = l.useMemo(() => b.filter(d.isNotNullish), [b]),
                    y = l.useMemo(() => null != p && h.length > 0 && h[0].id === p && null != h[0].embeddedActivityConfig ? [{
        ...
        91761: function(e, t, i) {
            ...
            function u(e) {
                let {
                    ...
                    autoTrackExposure: !0
                }), v = null != p ? p : r.ActivityShelfSortHeuristic.None, m = (0, r.default)(f, v), b = (0, o.useDeveloperActivityShelfItems)();
                return [...b, ...m].map(e => {
                    let [t, i] = e;
        ...
        607573: function(e, t, i) {
            ...
            function A(e) {
                let {
                    ...
                    application: T,
                    activity: I
                } = t, M = I.client_platform_config[(0, p.default)((0, o.getOS)())], N = null != M.label_until && Date.now() < Date.parse(M.label_until), O = (0, h.default)({
                    applicationId: T.id,
                    size: _,
                    names: S
                }), P = null != I.activity_preview_video_asset_id ? (0, v.default)(T.id, I.activity_preview_video_asset_id) : null, C = (0, m.default)(), U = (0, b.default)(), x = (0, f.default)(i), L = x.find(e => {
                    let {
                        embeddedActivity: t
                    } = e;
                ...
                let F = t.activity.client_platform_config[(0, p.default)((0, o.getOS)())].release_phase,
        ...
        687292: function(e, t, i) {
            ...
            function c(e) {
                ...
                if (!s) return b;
                let h = d.default.Messages.EMBEDDED_ACTIVITIES_FREE_PREVIEW_TOOLTIP.format({
                    activity: t
                });
